/*   
	CLX-128Q: 192-bit state, 128-bit key, 96-bit IV 
	The optimized implementation on 32-bit processor.   
	The state consists of six 32-bit registers       
...
#define X  1       // The state size is 160 + 32*x bits 
#define KEYSIZE 4  // The key size is 32*4 bits 
...
// The following code is identical for: 
