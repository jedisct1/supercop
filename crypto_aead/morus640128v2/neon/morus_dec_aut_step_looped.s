...
# qhasm: cipher_blk aligned= mem128[input_1]
# asm 1: vld1.8 {>cipher_blk=reg128#10%bot->cipher_blk=reg128#10%top},[<input_1=int32#2,: 128]
# asm 2: vld1.8 {>cipher_blk=d18->cipher_blk=d19},[<input_1=r1,: 128]
...
# qhasm: msg_blk = cipher_blk ^ temp
# asm 1: veor >msg_blk=reg128#10,<cipher_blk=reg128#10,<temp=reg128#11
# asm 2: veor >msg_blk=q9,<cipher_blk=q9,<temp=q10
veor q9,q9,q10

# qhasm: mem128[input_0] aligned= msg_blk
# asm 1: vst1.8 {<msg_blk=reg128#10%bot-<msg_blk=reg128#10%top},[<input_0=int32#1,: 128]
# asm 2: vst1.8 {<msg_blk=d18-<msg_blk=d19},[<input_0=r0,: 128]
