...
# qhasm: caller_q4 ^= msg_blk1
# asm 1: veor >caller_q4=reg128#15,<caller_q4=reg128#15,<msg_blk1=reg128#5
# asm 2: veor >caller_q4=q14,<caller_q4=q14,<msg_blk1=q4
veor q14,q14,q4

# qhasm: mem128[input_1] aligned= caller_q4
# asm 1: vst1.8 {<caller_q4=reg128#15%bot-<caller_q4=reg128#15%top},[<input_1=int32#2,: 128]
# asm 2: vst1.8 {<caller_q4=d28-<caller_q4=d29},[<input_1=r1,: 128]
...
# qhasm: caller_q4 ^= msg_blk2
# asm 1: veor >caller_q4=reg128#15,<caller_q4=reg128#15,<msg_blk2=reg128#6
# asm 2: veor >caller_q4=q14,<caller_q4=q14,<msg_blk2=q5
veor q14,q14,q5
