...
# qhasm: enter morus_enc_aut_step_ad
.align 4
.global _morus_enc_aut_step_ad
.global morus_enc_aut_step_ad
.type _morus_enc_aut_step_ad STT_FUNC
.type morus_enc_aut_step_ad STT_FUNC
_morus_enc_aut_step_ad:
morus_enc_aut_step_ad:
sub sp,sp,#64
...
# asm 1: vld1.8 {>s2_blk1=reg128#9%bot->s2_blk1=reg128#9%top},[<input_1=int32#2,: 128]
# asm 2: vld1.8 {>s2_blk1=d16->s2_blk1=d17},[<input_1=r1,: 128]
...
# asm 1: vld1.8 {>s2_blk2=reg128#10%bot->s2_blk2=reg128#10%top},[<input_1=int32#2,: 128]
# asm 2: vld1.8 {>s2_blk2=d18->s2_blk2=d19},[<input_1=r1,: 128]
...
# asm 1: vld1.8 {>s3_blk1=reg128#11%bot->s3_blk1=reg128#11%top},[<input_1=int32#2,: 128]
# asm 2: vld1.8 {>s3_blk1=d20->s3_blk1=d21},[<input_1=r1,: 128]
...
# asm 1: vld1.8 {>s3_blk2=reg128#12%bot->s3_blk2=reg128#12%top},[<input_1=int32#2,: 128]
# asm 2: vld1.8 {>s3_blk2=d22->s3_blk2=d23},[<input_1=r1,: 128]
...
# asm 1: vld1.8 {>s4_blk1=reg128#13%bot->s4_blk1=reg128#13%top},[<input_1=int32#2,: 128]
# asm 2: vld1.8 {>s4_blk1=d24->s4_blk1=d25},[<input_1=r1,: 128]
...
# asm 1: vld1.8 {>s4_blk2=reg128#14%bot->s4_blk2=reg128#14%top},[<input_1=int32#2,: 128]
# asm 2: vld1.8 {>s4_blk2=d26->s4_blk2=d27},[<input_1=r1,: 128]
vld1.8 {d26-d27},[r1,: 128]

# qhasm: assign r4 r5 to loop_counter_right loop_counter_left = mem64[input_2 + 0]
# asm 1: ldrd >loop_counter_right=int32#5,[<input_2=int32#3,#0]
# asm 2: ldrd >loop_counter_right=r4,[<input_2=r2,#0]
ldrd r4,[r2,#0]
...
# asm 1: vld1.8 {>msg_blk1=reg128#5%bot->msg_blk1=reg128#5%top},[<input_0=int32#1,: 128]
# asm 2: vld1.8 {>msg_blk1=d8->msg_blk1=d9},[<input_0=r0,: 128]
vld1.8 {d8-d9},[r0,: 128]
...
# asm 1: vld1.8 {>msg_blk2=reg128#6%bot->msg_blk2=reg128#6%top},[<input_0=int32#1,: 128]
# asm 2: vld1.8 {>msg_blk2=d10->msg_blk2=d11},[<input_0=r0,: 128]
vld1.8 {d10-d11},[r0,: 128]
...
# asm 1: vst1.8 {<s2_blk1=reg128#9%bot-<s2_blk1=reg128#9%top},[<input_1=int32#1,: 128]
# asm 2: vst1.8 {<s2_blk1=d16-<s2_blk1=d17},[<input_1=r0,: 128]
...
# asm 1: vst1.8 {<s2_blk2=reg128#10%bot-<s2_blk2=reg128#10%top},[<input_1=int32#1,: 128]
# asm 2: vst1.8 {<s2_blk2=d18-<s2_blk2=d19},[<input_1=r0,: 128]
...
# asm 1: vst1.8 {<s3_blk1=reg128#11%bot-<s3_blk1=reg128#11%top},[<input_1=int32#1,: 128]
# asm 2: vst1.8 {<s3_blk1=d20-<s3_blk1=d21},[<input_1=r0,: 128]
...
# asm 1: vst1.8 {<s3_blk2=reg128#12%bot-<s3_blk2=reg128#12%top},[<input_1=int32#1,: 128]
# asm 2: vst1.8 {<s3_blk2=d22-<s3_blk2=d23},[<input_1=r0,: 128]
...
# asm 1: vst1.8 {<s4_blk1=reg128#13%bot-<s4_blk1=reg128#13%top},[<input_1=int32#1,: 128]
# asm 2: vst1.8 {<s4_blk1=d24-<s4_blk1=d25},[<input_1=r0,: 128]
...
# asm 1: vst1.8 {<s4_blk2=reg128#14%bot-<s4_blk2=reg128#14%top},[<input_1=int32#1,: 128]
# asm 2: vst1.8 {<s4_blk2=d26-<s4_blk2=d27},[<input_1=r0,: 128]
