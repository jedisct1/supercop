	...
	.text
	.p2align	5
	.globl	_CRYPTO_NAMESPACE(_aegis128l_decrypt)
	.globl	CRYPTO_NAMESPACE(_aegis128l_decrypt)
	.globl	_CRYPTO_NAMESPACE(_aegis128l_encrypt)
	.globl	CRYPTO_NAMESPACE(_aegis128l_encrypt)
_CRYPTO_NAMESPACE(_aegis128l_decrypt):
CRYPTO_NAMESPACE(_aegis128l_decrypt):
	movq	%rsp, %r11
	leaq	-96(%rsp), %rsp
	andq	$-16, %rsp
	movq	(%rdi), %rax
...
L_aegis128l_decrypt$2:
	...
	movq	%rsi, %rsp
	ret
_CRYPTO_NAMESPACE(_aegis128l_encrypt):
CRYPTO_NAMESPACE(_aegis128l_encrypt):
	movq	%rsp, %r11
	leaq	-64(%rsp), %rsp
	andq	$-16, %rsp
	movq	(%rdi), %rax
