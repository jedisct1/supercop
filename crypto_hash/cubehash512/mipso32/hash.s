...
# qhasm: enter crypto_hash_cubehash512_mips32
.text
.align 2
.set noat
.globl crypto_hash_cubehash512_mips32
.ent crypto_hash_cubehash512_mips32
crypto_hash_cubehash512_mips32:
addiu $sp,$sp,-192
...
# asm 1: li >x08=int32#1,0x9dc00000
# asm 2: li >x08=$4,0x9dc00000
li $4,0x9dc00000

# qhasm:   x08 |= 0x6f0a
# asm 1: ori <x08=int32#1,<x08=int32#1,0x6f0a
# asm 2: ori <x08=$4,<x08=$4,0x6f0a
ori $4,$4,0x6f0a

# qhasm:   x09 = 0x4d190000
# asm 1: li >x09=int32#5,0x4d190000
# asm 2: li >x09=$8,0x4d190000
li $8,0x4d190000

# qhasm:   x09 |= 0x7eb5
# asm 1: ori <x09=int32#5,<x09=int32#5,0x7eb5
# asm 2: ori <x09=$8,<x09=$8,0x7eb5
ori $8,$8,0x7eb5

# qhasm:   x0a = 0xb6e10000
# asm 1: li >x0a=int32#6,0xb6e10000
# asm 2: li >x0a=$9,0xb6e10000
li $9,0xb6e10000

# qhasm:   x0a |= 0x7224
# asm 1: ori <x0a=int32#6,<x0a=int32#6,0x7224
# asm 2: ori <x0a=$9,<x0a=$9,0x7224
ori $9,$9,0x7224

# qhasm:   x0b = 0x912e0000
# asm 1: li >x0b=int32#7,0x912e0000
# asm 2: li >x0b=$10,0x912e0000
li $10,0x912e0000

# qhasm:   x0b |= 0x1aca
# asm 1: ori <x0b=int32#7,<x0b=int32#7,0x1aca
# asm 2: ori <x0b=$10,<x0b=$10,0x1aca
ori $10,$10,0x1aca

# qhasm:   x0c = 0x52700000
# asm 1: li >x0c=int32#8,0x52700000
# asm 2: li >x0c=$11,0x52700000
li $11,0x52700000

# qhasm:   x0c |= 0xf5e1
# asm 1: ori <x0c=int32#8,<x0c=int32#8,0xf5e1
# asm 2: ori <x0c=$11,<x0c=$11,0xf5e1
ori $11,$11,0xf5e1

# qhasm:   x0d = 0xd9ef0000
# asm 1: li >x0d=int32#9,0xd9ef0000
# asm 2: li >x0d=$2,0xd9ef0000
li $2,0xd9ef0000

# qhasm:   x0d |= 0xd0ec
# asm 1: ori <x0d=int32#9,<x0d=int32#9,0xd0ec
# asm 2: ori <x0d=$2,<x0d=$2,0xd0ec
ori $2,$2,0xd0ec

# qhasm:   x0e = 0xf0fc0000
# asm 1: li >x0e=int32#10,0xf0fc0000
# asm 2: li >x0e=$3,0xf0fc0000
li $3,0xf0fc0000

# qhasm:   x0e |= 0xf7c8
# asm 1: ori <x0e=int32#10,<x0e=int32#10,0xf7c8
# asm 2: ori <x0e=$3,<x0e=$3,0xf7c8
ori $3,$3,0xf7c8

# qhasm:   x0f = 0x20d40000
# asm 1: li >x0f=int32#11,0x20d40000
# asm 2: li >x0f=$12,0x20d40000
li $12,0x20d40000

# qhasm:   x0f |= 0x074f
# asm 1: ori <x0f=int32#11,<x0f=int32#11,0x074f
...
# asm 1: li >x10=int32#7,0x15540000
# asm 2: li >x10=$10,0x15540000
li $10,0x15540000

# qhasm:   x10 |= 0x7fee
# asm 1: ori <x10=int32#7,<x10=int32#7,0x7fee
# asm 2: ori <x10=$10,<x10=$10,0x7fee
ori $10,$10,0x7fee

# qhasm:   x11 = 0xf4830000
# asm 1: li >x11=int32#8,0xf4830000
# asm 2: li >x11=$11,0xf4830000
li $11,0xf4830000

# qhasm:   x11 |= 0x9313
# asm 1: ori <x11=int32#8,<x11=int32#8,0x9313
# asm 2: ori <x11=$11,<x11=$11,0x9313
ori $11,$11,0x9313

# qhasm:   x12 = 0x017c0000
# asm 1: li >x12=int32#10,0x017c0000
# asm 2: li >x12=$3,0x017c0000
li $3,0x017c0000

# qhasm:   x12 |= 0x189c
# asm 1: ori <x12=int32#10,<x12=int32#10,0x189c
# asm 2: ori <x12=$3,<x12=$3,0x189c
ori $3,$3,0x189c

# qhasm:   x13 = 0xaf1c0000
# asm 1: li >x13=int32#12,0xaf1c0000
# asm 2: li >x13=$13,0xaf1c0000
li $13,0xaf1c0000

# qhasm:   x13 |= 0x332a
# asm 1: ori <x13=int32#12,<x13=int32#12,0x332a
# asm 2: ori <x13=$13,<x13=$13,0x332a
ori $13,$13,0x332a

# qhasm:   x14 = 0xde4d0000
# asm 1: li >x14=int32#13,0xde4d0000
# asm 2: li >x14=$14,0xde4d0000
li $14,0xde4d0000

# qhasm:   x14 |= 0x7c8c
# asm 1: ori <x14=int32#13,<x14=int32#13,0x7c8c
# asm 2: ori <x14=$14,<x14=$14,0x7c8c
ori $14,$14,0x7c8c

# qhasm:   x15 = 0x84990000
# asm 1: li >x15=int32#14,0x84990000
# asm 2: li >x15=$15,0x84990000
li $15,0x84990000

# qhasm:   x15 |= 0x7eec
# asm 1: ori <x15=int32#14,<x15=int32#14,0x7eec
# asm 2: ori <x15=$15,<x15=$15,0x7eec
ori $15,$15,0x7eec

# qhasm:   x16 = 0x5bd80000
# asm 1: li >x16=int32#15,0x5bd80000
# asm 2: li >x16=$16,0x5bd80000
li $16,0x5bd80000

# qhasm:   x16 |= 0x7a43
# asm 1: ori <x16=int32#15,<x16=int32#15,0x7a43
# asm 2: ori <x16=$16,<x16=$16,0x7a43
ori $16,$16,0x7a43

# qhasm:   x17 = 0xb6d30000
# asm 1: li >x17=int32#16,0xb6d30000
# asm 2: li >x17=$17,0xb6d30000
li $17,0xb6d30000

# qhasm:   x17 |= 0xd055
# asm 1: ori <x17=int32#16,<x17=int32#16,0xd055
# asm 2: ori <x17=$17,<x17=$17,0xd055
ori $17,$17,0xd055
...
# asm 1: li >x18=int32#13,0x3ae20000
# asm 2: li >x18=$14,0x3ae20000
li $14,0x3ae20000

# qhasm:   x18 |= 0x47b0
# asm 1: ori <x18=int32#13,<x18=int32#13,0x47b0
# asm 2: ori <x18=$14,<x18=$14,0x47b0
ori $14,$14,0x47b0

# qhasm:   x19 = 0x2b8c0000
# asm 1: li >x19=int32#14,0x2b8c0000
# asm 2: li >x19=$15,0x2b8c0000
li $15,0x2b8c0000

# qhasm:   x19 |= 0xb0a6
# asm 1: ori <x19=int32#14,<x19=int32#14,0xb0a6
# asm 2: ori <x19=$15,<x19=$15,0xb0a6
ori $15,$15,0xb0a6

# qhasm:   x1a = 0xd9d60000
# asm 1: li >x1a=int32#15,0xd9d60000
# asm 2: li >x1a=$16,0xd9d60000
li $16,0xd9d60000

# qhasm:   x1a |= 0xca35
# asm 1: ori <x1a=int32#15,<x1a=int32#15,0xca35
# asm 2: ori <x1a=$16,<x1a=$16,0xca35
ori $16,$16,0xca35

# qhasm:   x1b = 0x4bf10000
# asm 1: li >x1b=int32#16,0x4bf10000
# asm 2: li >x1b=$17,0x4bf10000
li $17,0x4bf10000

# qhasm:   x1b |= 0x2b94
# asm 1: ori <x1b=int32#16,<x1b=int32#16,0x2b94
# asm 2: ori <x1b=$17,<x1b=$17,0x2b94
ori $17,$17,0x2b94

# qhasm:   x1c = 0x97f30000
# asm 1: li >x1c=int32#17,0x97f30000
# asm 2: li >x1c=$18,0x97f30000
li $18,0x97f30000

# qhasm:   x1c |= 0x3a51
# asm 1: ori <x1c=int32#17,<x1c=int32#17,0x3a51
# asm 2: ori <x1c=$18,<x1c=$18,0x3a51
ori $18,$18,0x3a51

# qhasm:   x1d = 0x62fb0000
# asm 1: li >x1d=int32#18,0x62fb0000
# asm 2: li >x1d=$19,0x62fb0000
li $19,0x62fb0000

# qhasm:   x1d |= 0x84ad
# asm 1: ori <x1d=int32#18,<x1d=int32#18,0x84ad
# asm 2: ori <x1d=$19,<x1d=$19,0x84ad
ori $19,$19,0x84ad

# qhasm:   x1e = 0x7e700000
# asm 1: li >x1e=int32#19,0x7e700000
# asm 2: li >x1e=$20,0x7e700000
li $20,0x7e700000

# qhasm:   x1e |= 0xe613
# asm 1: ori <x1e=int32#19,<x1e=int32#19,0xe613
# asm 2: ori <x1e=$20,<x1e=$20,0xe613
ori $20,$20,0xe613

# qhasm:   x1f = 0x520c0000
# asm 1: li >x1f=int32#20,0x520c0000
# asm 2: li >x1f=$21,0x520c0000
li $21,0x520c0000

# qhasm:   x1f |= 0x709b
# asm 1: ori <x1f=int32#20,<x1f=int32#20,0x709b
# asm 2: ori <x1f=$21,<x1f=$21,0x709b
ori $21,$21,0x709b
...
# asm 1: li >x00=int32#17,0x781f0000
# asm 2: li >x00=$18,0x781f0000
li $18,0x781f0000

# qhasm:   x00 |= 0x814f
# asm 1: ori <x00=int32#17,<x00=int32#17,0x814f
# asm 2: ori <x00=$18,<x00=$18,0x814f
ori $18,$18,0x814f

# qhasm:   x01 = 0x18f40000
# asm 1: li >x01=int32#18,0x18f40000
# asm 2: li >x01=$19,0x18f40000
li $19,0x18f40000

# qhasm:   x01 |= 0x5926
# asm 1: ori <x01=int32#18,<x01=int32#18,0x5926
# asm 2: ori <x01=$19,<x01=$19,0x5926
ori $19,$19,0x5926

# qhasm:   x02 = 0x992b0000
# asm 1: li >x02=int32#19,0x992b0000
# asm 2: li >x02=$20,0x992b0000
li $20,0x992b0000

# qhasm:   x02 |= 0x7520
# asm 1: ori <x02=int32#19,<x02=int32#19,0x7520
# asm 2: ori <x02=$20,<x02=$20,0x7520
ori $20,$20,0x7520

# qhasm:   x03 = 0xc8230000
# asm 1: li >x03=int32#20,0xc8230000
# asm 2: li >x03=$21,0xc8230000
li $21,0xc8230000

# qhasm:   x03 |= 0x7df7
# asm 1: ori <x03=int32#20,<x03=int32#20,0x7df7
# asm 2: ori <x03=$21,<x03=$21,0x7df7
ori $21,$21,0x7df7

# qhasm:   x04 = 0xe4e30000
# asm 1: li >x04=int32#21,0xe4e30000
# asm 2: li >x04=$22,0xe4e30000
li $22,0xe4e30000

# qhasm:   x04 |= 0xba88
# asm 1: ori <x04=int32#21,<x04=int32#21,0xba88
# asm 2: ori <x04=$22,<x04=$22,0xba88
ori $22,$22,0xba88

# qhasm:   x05 = 0x7b000000
# asm 1: li >x05=int32#22,0x7b000000
# asm 2: li >x05=$23,0x7b000000
li $23,0x7b000000

# qhasm:   x05 |= 0x75ff
# asm 1: ori <x05=int32#22,<x05=int32#22,0x75ff
# asm 2: ori <x05=$23,<x05=$23,0x75ff
ori $23,$23,0x75ff

# qhasm:   x06 = 0x51910000
# asm 1: li >x06=int32#23,0x51910000
# asm 2: li >x06=$24,0x51910000
li $24,0x51910000

# qhasm:   x06 |= 0x6982
# asm 1: ori <x06=int32#23,<x06=int32#23,0x6982
# asm 2: ori <x06=$24,<x06=$24,0x6982
ori $24,$24,0x6982

# qhasm:   x07 = 0x947c0000
# asm 1: li >x07=int32#24,0x947c0000
# asm 2: li >x07=$25,0x947c0000
li $25,0x947c0000

# qhasm:   x07 |= 0x6147
# asm 1: ori <x07=int32#24,<x07=int32#24,0x6147
# asm 2: ori <x07=$25,<x07=$25,0x6147
ori $25,$25,0x6147
