/* This program gives the 64-bit bitslice reference implementation of JH using ANSI C 
   ...
   1) 52.8 cycles/byte  compiler: icc 11.1   compilation option: icc -O2
   2) 83.4 cycles/byte  compiler: gcc 4.3.2  compilation option: gcc -O3

   Microprocessor: Intel CORE 2 processor (Core 2 Quad Q6600 2.4GHz) 
   Operating System: 64-bit Windows Vista Business
   Speed for long message:
   3) 59.8 cycles/byte  compiler: icc 11.1   compilation option: icl /fast
   4) 76.8 cycles/byte  compiler: Microsoft Visual C++ 2008  compilation option: release
...
void LastHalfRound(hashState* state, uint64 roundnumber);  /*the last half round of E8 */
...
void LastHalfRound(hashState* state, uint64 roundnumber) {                        
      uint64 i,temp0;
