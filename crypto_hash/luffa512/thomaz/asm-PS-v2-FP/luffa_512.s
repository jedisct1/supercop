...
.macro mSTEP rch0, rch1, rch2, rch3, rch4, rch5, rch6, rch7, rch8, rch9, raux0, raux1, numCST
	...
	mSubCrumb \rch8, \raux0, \raux1, tableSubCrumb, tableSubCrumb+16	
	mSubCrumb \rch9, \raux0, \raux1, tableSubCrumb+32, tableSubCrumb+48
	
	mMixWord \rch0, \rch1, \raux0
	xorps \rch0, CONSTS+\numCST
	mMixWord \rch2, \rch3, \raux0
	xorps \rch2, CONSTS+16+\numCST
	xorps \rch1, CONSTS+80+\numCST	
	xorps \rch3, CONSTS+96+\numCST
	mMixWord \rch4, \rch5, \raux0
	xorps \rch4, CONSTS+32+\numCST
	xorps \rch5, CONSTS+112+\numCST
	mMixWord \rch6, \rch7, \raux0
	xorps \rch6, CONSTS+48+\numCST
	xorps \rch7, CONSTS+128+\numCST
	mMixWord \rch8, \rch9, \raux0
	xorps \rch8, CONSTS+64+\numCST
	xorps \rch9, CONSTS+144+\numCST
.endm
...
fRound:
	...
	mSTEP %xmm0, %xmm1, %xmm2, %xmm3, %xmm4, %xmm5, %xmm6, %xmm7, %xmm8, %xmm9, %xmm10, %xmm11, 0
	mSTEP %xmm0, %xmm1, %xmm2, %xmm3, %xmm4, %xmm5, %xmm6, %xmm7, %xmm8, %xmm9, %xmm10, %xmm11, 160
	mSTEP %xmm0, %xmm1, %xmm2, %xmm3, %xmm4, %xmm5, %xmm6, %xmm7, %xmm8, %xmm9, %xmm10, %xmm11, 320
	mSTEP %xmm0, %xmm1, %xmm2, %xmm3, %xmm4, %xmm5, %xmm6, %xmm7, %xmm8, %xmm9, %xmm10, %xmm11, 480
	mSTEP %xmm0, %xmm1, %xmm2, %xmm3, %xmm4, %xmm5, %xmm6, %xmm7, %xmm8, %xmm9, %xmm10, %xmm11, 640
	mSTEP %xmm0, %xmm1, %xmm2, %xmm3, %xmm4, %xmm5, %xmm6, %xmm7, %xmm8, %xmm9, %xmm10, %xmm11, 800
	mSTEP %xmm0, %xmm1, %xmm2, %xmm3, %xmm4, %xmm5, %xmm6, %xmm7, %xmm8, %xmm9, %xmm10, %xmm11, 960
	mSTEP %xmm0, %xmm1, %xmm2, %xmm3, %xmm4, %xmm5, %xmm6, %xmm7, %xmm8, %xmm9, %xmm10, %xmm11, 1120
