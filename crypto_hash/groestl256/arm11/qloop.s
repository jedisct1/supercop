...
# qhasm: t = 0xff
# asm 1: ldr >t=int32#5,=0xff
# asm 2: ldr >t=r4,=0xff
ldr r4,=0xff

# qhasm: input_1 += (t << 5)
# asm 1: add >input_1=int32#2,<input_1=int32#2,<t=int32#5,LSL #5
# asm 2: add >input_1=r1,<input_1=r1,<t=r4,LSL #5
add r1,r1,r4,LSL #5
...
# asm 1: sub >b0=int32#5,<input_1=int32#2,<b0=int32#5,LSL #5
# asm 2: sub >b0=r4,<input_1=r1,<b0=r4,LSL #5
sub r4,r1,r4,LSL #5

# qhasm:   b4 = input_1 - (b4 << 5)
# asm 1: sub >b4=int32#6,<input_1=int32#2,<b4=int32#6,LSL #5
# asm 2: sub >b4=r5,<input_1=r1,<b4=r5,LSL #5
sub r5,r1,r5,LSL #5
...
# asm 1: sub >b1=int32#5,<input_1=int32#2,<b1=int32#11,LSL #5
# asm 2: sub >b1=r4,<input_1=r1,<b1=r10,LSL #5
sub r4,r1,r10,LSL #5

# qhasm:   b5 = input_1 - (b5 << 5)
# asm 1: sub >b5=int32#11,<input_1=int32#2,<b5=int32#12,LSL #5
# asm 2: sub >b5=r10,<input_1=r1,<b5=r11,LSL #5
sub r10,r1,r11,LSL #5
...
# asm 1: ldrb >b7=int32#5,[<input_0=int32#1,#55]
# asm 2: ldrb >b7=r4,[<input_0=r0,#55]
ldrb r4,[r0,#55]

# qhasm:   b2 = input_1 - (b2 << 5)
# asm 1: sub >b2=int32#6,<input_1=int32#2,<b2=int32#11,LSL #5
# asm 2: sub >b2=r5,<input_1=r1,<b2=r10,LSL #5
sub r5,r1,r10,LSL #5

# qhasm:   b6 = input_1 - (b6 << 5)
# asm 1: sub >b6=int32#7,<input_1=int32#2,<b6=int32#12,LSL #5
# asm 2: sub >b6=r6,<input_1=r1,<b6=r11,LSL #5
sub r6,r1,r11,LSL #5

# qhasm: b7 ^= 0x60
# asm 1: eor >b7=int32#5,<b7=int32#5,#0x60
# asm 2: eor >b7=r4,<b7=r4,#0x60
eor r4,r4,#0x60

# qhasm: b7 ^= c
# asm 1: eor >b7=int32#11,<b7=int32#5,<c=int32#3
# asm 2: eor >b7=r10,<b7=r4,<c=r2
eor r10,r4,r2

# qhasm:   assign r4 r5 to t20 t21 = mem64[b2 + 16]
# asm 1: ldrd >t20=int32#5,[<b2=int32#6,#16]
# asm 2: ldrd >t20=r4,[<b2=r5,#16]
ldrd r4,[r5,#16]
...
# asm 1: sub >b3=int32#12,<input_1=int32#2,<b3=int32#13,LSL #5
# asm 2: sub >b3=r11,<input_1=r1,<b3=r12,LSL #5
sub r11,r1,r12,LSL #5

# qhasm:   b7 = input_1 - (b7 << 5)
# asm 1: sub >b7=int32#11,<input_1=int32#2,<b7=int32#11,LSL #5
# asm 2: sub >b7=r10,<input_1=r1,<b7=r10,LSL #5
sub r10,r1,r10,LSL #5
...
# asm 1: ldrd >t30=int32#5,[<b3=int32#12,#24]
# asm 2: ldrd >t30=r4,[<b3=r11,#24]
ldrd r4,[r11,#24]
...
# asm 1: ldrd >t70=int32#7,[<b7=int32#11,#24]
# asm 2: ldrd >t70=r6,[<b7=r10,#24]
ldrd r6,[r10,#24]
...
# asm 1: ldrb >b7=int32#5,[<input_0=int32#1,#63]
# asm 2: ldrb >b7=r4,[<input_0=r0,#63]
ldrb r4,[r0,#63]
...
# qhasm: b7 ^= 0x70
# asm 1: eor >b7=int32#5,<b7=int32#5,#0x70
# asm 2: eor >b7=r4,<b7=r4,#0x70
eor r4,r4,#0x70
...
# asm 1: ldrb >b7=int32#5,[<input_0=int32#1,#7]
# asm 2: ldrb >b7=r4,[<input_0=r0,#7]
ldrb r4,[r0,#7]
...
# asm 1: ldrb >b7=int32#5,[<input_0=int32#1,#15]
# asm 2: ldrb >b7=r4,[<input_0=r0,#15]
ldrb r4,[r0,#15]
...
# qhasm: b7 ^= 0x10
# asm 1: eor >b7=int32#5,<b7=int32#5,#0x10
# asm 2: eor >b7=r4,<b7=r4,#0x10
eor r4,r4,#0x10
...
# asm 1: ldrb >b7=int32#5,[<input_0=int32#1,#23]
# asm 2: ldrb >b7=r4,[<input_0=r0,#23]
ldrb r4,[r0,#23]
...
# qhasm: b7 ^= 0x20
# asm 1: eor >b7=int32#5,<b7=int32#5,#0x20
# asm 2: eor >b7=r4,<b7=r4,#0x20
eor r4,r4,#0x20
...
# asm 1: ldrb >b7=int32#5,[<input_0=int32#1,#31]
# asm 2: ldrb >b7=r4,[<input_0=r0,#31]
ldrb r4,[r0,#31]
...
# qhasm: b7 ^= 0x30
# asm 1: eor >b7=int32#5,<b7=int32#5,#0x30
# asm 2: eor >b7=r4,<b7=r4,#0x30
eor r4,r4,#0x30
...
# asm 1: ldrb >b7=int32#5,[<input_0=int32#1,#39]
# asm 2: ldrb >b7=r4,[<input_0=r0,#39]
ldrb r4,[r0,#39]
...
# qhasm: b7 ^= 0x40
# asm 1: eor >b7=int32#5,<b7=int32#5,#0x40
# asm 2: eor >b7=r4,<b7=r4,#0x40
eor r4,r4,#0x40
...
# asm 1: ldrb >b7=int32#5,[<input_0=int32#1,#47]
# asm 2: ldrb >b7=r4,[<input_0=r0,#47]
ldrb r4,[r0,#47]
...
# qhasm: b7 ^= 0x50
# asm 1: eor >b7=int32#5,<b7=int32#5,#0x50
# asm 2: eor >b7=r4,<b7=r4,#0x50
eor r4,r4,#0x50
...
# qhasm:   b7 = mem8[yp +55]
# asm 1: ldrb >b7=int32#5,[<yp=int32#4,#55]
# asm 2: ldrb >b7=r4,[<yp=r3,#55]
ldrb r4,[r3,#55]
...
# qhasm:   b7 = mem8[yp +63]
# asm 1: ldrb >b7=int32#5,[<yp=int32#4,#63]
# asm 2: ldrb >b7=r4,[<yp=r3,#63]
ldrb r4,[r3,#63]
...
# qhasm:   b7 = mem8[yp +7]
# asm 1: ldrb >b7=int32#5,[<yp=int32#4,#7]
# asm 2: ldrb >b7=r4,[<yp=r3,#7]
ldrb r4,[r3,#7]
...
# qhasm:   b7 = mem8[yp +15]
# asm 1: ldrb >b7=int32#5,[<yp=int32#4,#15]
# asm 2: ldrb >b7=r4,[<yp=r3,#15]
ldrb r4,[r3,#15]
...
# qhasm:   b7 = mem8[yp +23]
# asm 1: ldrb >b7=int32#5,[<yp=int32#4,#23]
# asm 2: ldrb >b7=r4,[<yp=r3,#23]
ldrb r4,[r3,#23]
...
# qhasm:   b7 = mem8[yp +31]
# asm 1: ldrb >b7=int32#5,[<yp=int32#4,#31]
# asm 2: ldrb >b7=r4,[<yp=r3,#31]
ldrb r4,[r3,#31]
...
# qhasm:   b7 = mem8[yp +39]
# asm 1: ldrb >b7=int32#5,[<yp=int32#4,#39]
# asm 2: ldrb >b7=r4,[<yp=r3,#39]
ldrb r4,[r3,#39]
...
# qhasm:   b7 = mem8[yp +47]
# asm 1: ldrb >b7=int32#5,[<yp=int32#4,#47]
# asm 2: ldrb >b7=r4,[<yp=r3,#47]
ldrb r4,[r3,#47]
