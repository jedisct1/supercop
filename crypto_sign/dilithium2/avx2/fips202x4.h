...
#define FIPS202X4_NAMESPACE(s) DILITHIUM_NAMESPACE(s)

typedef struct {
  __m256i s[25];
} keccakx4_state;

#define shake128x4_absorb FIPS202X4_NAMESPACE(shake128x4_absorb)
...
#define shake256x4_absorb FIPS202X4_NAMESPACE(shake256x4_absorb)
