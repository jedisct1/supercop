...
void quadratic(unsigned char z[37], unsigned char x[37], unsigned char A[37][37][37], unsigned char B[37][37], unsigned char C[37],unsigned char M[128*128]);
...
void priv_pub(unsigned char QUAD[37][37][37], unsigned char LIN[37][37], unsigned char CONS[37], 
...
void Flash_encrypt(unsigned char out[37], unsigned char in[37], Flash_Complete_Key PK);
