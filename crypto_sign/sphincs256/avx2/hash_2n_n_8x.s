...
# qhasm: enter hash_2n_n_8x
.p2align 5
.global _hash_2n_n_8x
.global hash_2n_n_8x
_hash_2n_n_8x:
hash_2n_n_8x:
mov %rsp,%r11
...
# asm 1: mov  <input_3=int64#4,>offset=int64#7
# asm 2: mov  <input_3=%rcx,>offset=%rax
mov  %rcx,%rax

# qhasm: x1  = mem256[input_1 +   0 + offset]
# asm 1: vmovupd   0(<input_1=int64#2,<offset=int64#7),>x1=reg256#4
# asm 2: vmovupd   0(<input_1=%rsi,<offset=%rax),>x1=%ymm3
vmovupd   0(%rsi,%rax),%ymm3

# qhasm: offset += input_3
# asm 1: add  <input_3=int64#4,<offset=int64#7
# asm 2: add  <input_3=%rcx,<offset=%rax
add  %rcx,%rax

# qhasm: x2  = mem256[input_1 +   0 + offset]
# asm 1: vmovupd   0(<input_1=int64#2,<offset=int64#7),>x2=reg256#5
# asm 2: vmovupd   0(<input_1=%rsi,<offset=%rax),>x2=%ymm4
vmovupd   0(%rsi,%rax),%ymm4
...
# asm 1: vmovupd   0(<input_1=int64#2,<offset=int64#7),>x3=reg256#6
# asm 2: vmovupd   0(<input_1=%rsi,<offset=%rax),>x3=%ymm5
vmovupd   0(%rsi,%rax),%ymm5
...
# asm 1: vmovupd   0(<input_1=int64#2,<offset=int64#7),>x4=reg256#7
# asm 2: vmovupd   0(<input_1=%rsi,<offset=%rax),>x4=%ymm6
vmovupd   0(%rsi,%rax),%ymm6
...
# asm 1: vmovupd   0(<input_1=int64#2,<offset=int64#7),>x5=reg256#8
# asm 2: vmovupd   0(<input_1=%rsi,<offset=%rax),>x5=%ymm7
vmovupd   0(%rsi,%rax),%ymm7
...
# asm 1: vmovupd   0(<input_1=int64#2,<offset=int64#7),>x6=reg256#9
# asm 2: vmovupd   0(<input_1=%rsi,<offset=%rax),>x6=%ymm8
vmovupd   0(%rsi,%rax),%ymm8
...
# asm 1: vmovupd   0(<input_1=int64#2,<offset=int64#7),>x7=reg256#10
# asm 2: vmovupd   0(<input_1=%rsi,<offset=%rax),>x7=%ymm9
vmovupd   0(%rsi,%rax),%ymm9
...
# qhasm: x1  = mem256[input_1 +   0 + offset]
# asm 1: vmovupd   0(<input_1=int64#2,<offset=int64#5),>x1=reg256#4
# asm 2: vmovupd   0(<input_1=%rsi,<offset=%r8),>x1=%ymm3
vmovupd   0(%rsi,%r8),%ymm3
...
# qhasm: x2  = mem256[input_1 +   0 + offset]
# asm 1: vmovupd   0(<input_1=int64#2,<offset=int64#5),>x2=reg256#5
# asm 2: vmovupd   0(<input_1=%rsi,<offset=%r8),>x2=%ymm4
...
# qhasm: x3  = mem256[input_1 +   0 + offset]
# asm 1: vmovupd   0(<input_1=int64#2,<offset=int64#5),>x3=reg256#7
# asm 2: vmovupd   0(<input_1=%rsi,<offset=%r8),>x3=%ymm6
...
# qhasm: x4  = mem256[input_1 +   0 + offset]
# asm 1: vmovupd   0(<input_1=int64#2,<offset=int64#5),>x4=reg256#8
# asm 2: vmovupd   0(<input_1=%rsi,<offset=%r8),>x4=%ymm7
...
# qhasm: x5  = mem256[input_1 +   0 + offset]
# asm 1: vmovupd   0(<input_1=int64#2,<offset=int64#5),>x5=reg256#9
# asm 2: vmovupd   0(<input_1=%rsi,<offset=%r8),>x5=%ymm8
...
# qhasm: x6  = mem256[input_1 +   0 + offset]
# asm 1: vmovupd   0(<input_1=int64#2,<offset=int64#5),>x6=reg256#10
# asm 2: vmovupd   0(<input_1=%rsi,<offset=%r8),>x6=%ymm9
...
# qhasm: x7  = mem256[input_1 +   0 + offset]
# asm 1: vmovupd   0(<input_1=int64#2,<offset=int64#5),>x7=reg256#15
# asm 2: vmovupd   0(<input_1=%rsi,<offset=%r8),>x7=%ymm14
vmovupd   0(%rsi,%r8),%ymm14

# qhasm: t0 = unpack  low dwords of x0 and x4 
# asm 1: vpunpckldq <x4=reg256#8,<x0=reg256#3,>t0=reg256#16
# asm 2: vpunpckldq <x4=%ymm7,<x0=%ymm2,>t0=%ymm15
vpunpckldq %ymm7,%ymm2,%ymm15

# qhasm: t1 = unpack high dwords of x0 and x4 
# asm 1: vpunpckhdq <x4=reg256#8,<x0=reg256#3,>t1=reg256#3
# asm 2: vpunpckhdq <x4=%ymm7,<x0=%ymm2,>t1=%ymm2
vpunpckhdq %ymm7,%ymm2,%ymm2

# qhasm: x0[0,1,2,3] = t0[0,1],t1[0,1]
# asm 1: vperm2f128 $0x20,<t1=reg256#3,<t0=reg256#16,>x0=reg256#8
# asm 2: vperm2f128 $0x20,<t1=%ymm2,<t0=%ymm15,>x0=%ymm7
vperm2f128 $0x20,%ymm2,%ymm15,%ymm7

# qhasm: x4[0,1,2,3] = t0[2,3],t1[2,3]
# asm 1: vperm2f128 $0x31,<t1=reg256#3,<t0=reg256#16,>x4=reg256#3
# asm 2: vperm2f128 $0x31,<t1=%ymm2,<t0=%ymm15,>x4=%ymm2
vperm2f128 $0x31,%ymm2,%ymm15,%ymm2

# qhasm: t0 = unpack  low dwords of x1 and x5
# asm 1: vpunpckldq <x5=reg256#9,<x1=reg256#4,>t0=reg256#16
# asm 2: vpunpckldq <x5=%ymm8,<x1=%ymm3,>t0=%ymm15
vpunpckldq %ymm8,%ymm3,%ymm15

# qhasm: t1 = unpack high dwords of x1 and x5
# asm 1: vpunpckhdq <x5=reg256#9,<x1=reg256#4,>t1=reg256#4
# asm 2: vpunpckhdq <x5=%ymm8,<x1=%ymm3,>t1=%ymm3
vpunpckhdq %ymm8,%ymm3,%ymm3

# qhasm: x1[0,1,2,3] = t0[0,1],t1[0,1]
# asm 1: vperm2f128 $0x20,<t1=reg256#4,<t0=reg256#16,>x1=reg256#9
# asm 2: vperm2f128 $0x20,<t1=%ymm3,<t0=%ymm15,>x1=%ymm8
vperm2f128 $0x20,%ymm3,%ymm15,%ymm8

# qhasm: x5[0,1,2,3] = t0[2,3],t1[2,3]
# asm 1: vperm2f128 $0x31,<t1=reg256#4,<t0=reg256#16,>x5=reg256#4
# asm 2: vperm2f128 $0x31,<t1=%ymm3,<t0=%ymm15,>x5=%ymm3
vperm2f128 $0x31,%ymm3,%ymm15,%ymm3

# qhasm: t0 = unpack  low dwords of x2 and x6
# asm 1: vpunpckldq <x6=reg256#10,<x2=reg256#5,>t0=reg256#16
# asm 2: vpunpckldq <x6=%ymm9,<x2=%ymm4,>t0=%ymm15
vpunpckldq %ymm9,%ymm4,%ymm15

# qhasm: t1 = unpack high dwords of x2 and x6
# asm 1: vpunpckhdq <x6=reg256#10,<x2=reg256#5,>t1=reg256#5
# asm 2: vpunpckhdq <x6=%ymm9,<x2=%ymm4,>t1=%ymm4
vpunpckhdq %ymm9,%ymm4,%ymm4

# qhasm: x2[0,1,2,3] = t0[0,1],t1[0,1]
# asm 1: vperm2f128 $0x20,<t1=reg256#5,<t0=reg256#16,>x2=reg256#10
# asm 2: vperm2f128 $0x20,<t1=%ymm4,<t0=%ymm15,>x2=%ymm9
vperm2f128 $0x20,%ymm4,%ymm15,%ymm9

# qhasm: x6[0,1,2,3] = t0[2,3],t1[2,3]
# asm 1: vperm2f128 $0x31,<t1=reg256#5,<t0=reg256#16,>x6=reg256#5
# asm 2: vperm2f128 $0x31,<t1=%ymm4,<t0=%ymm15,>x6=%ymm4
vperm2f128 $0x31,%ymm4,%ymm15,%ymm4

# qhasm: t0 = unpack  low dwords of x3 and x7
# asm 1: vpunpckldq <x7=reg256#15,<x3=reg256#7,>t0=reg256#16
# asm 2: vpunpckldq <x7=%ymm14,<x3=%ymm6,>t0=%ymm15
vpunpckldq %ymm14,%ymm6,%ymm15

# qhasm: t1 = unpack high dwords of x3 and x7
# asm 1: vpunpckhdq <x7=reg256#15,<x3=reg256#7,>t1=reg256#7
# asm 2: vpunpckhdq <x7=%ymm14,<x3=%ymm6,>t1=%ymm6
vpunpckhdq %ymm14,%ymm6,%ymm6

# qhasm: x3[0,1,2,3] = t0[0,1],t1[0,1]
# asm 1: vperm2f128 $0x20,<t1=reg256#7,<t0=reg256#16,>x3=reg256#15
# asm 2: vperm2f128 $0x20,<t1=%ymm6,<t0=%ymm15,>x3=%ymm14
vperm2f128 $0x20,%ymm6,%ymm15,%ymm14

# qhasm: x7[0,1,2,3] = t0[2,3],t1[2,3]
# asm 1: vperm2f128 $0x31,<t1=reg256#7,<t0=reg256#16,>x7=reg256#7
# asm 2: vperm2f128 $0x31,<t1=%ymm6,<t0=%ymm15,>x7=%ymm6
vperm2f128 $0x31,%ymm6,%ymm15,%ymm6

# qhasm: t0 = unpack  low dwords of x0 and x2
# asm 1: vpunpckldq <x2=reg256#10,<x0=reg256#8,>t0=reg256#16
# asm 2: vpunpckldq <x2=%ymm9,<x0=%ymm7,>t0=%ymm15
vpunpckldq %ymm9,%ymm7,%ymm15
...
# qhasm: x0[0,1,2,3] = t0[0,1],t1[0,1]
# asm 1: vperm2f128 $0x20,<t1=reg256#8,<t0=reg256#16,>x0=reg256#10
# asm 2: vperm2f128 $0x20,<t1=%ymm7,<t0=%ymm15,>x0=%ymm9
vperm2f128 $0x20,%ymm7,%ymm15,%ymm9

# qhasm: x2[0,1,2,3] = t0[2,3],t1[2,3]
# asm 1: vperm2f128 $0x31,<t1=reg256#8,<t0=reg256#16,>x2=reg256#8
# asm 2: vperm2f128 $0x31,<t1=%ymm7,<t0=%ymm15,>x2=%ymm7
vperm2f128 $0x31,%ymm7,%ymm15,%ymm7

# qhasm: t0 = unpack  low dwords of x1 and x3
# asm 1: vpunpckldq <x3=reg256#15,<x1=reg256#9,>t0=reg256#16
# asm 2: vpunpckldq <x3=%ymm14,<x1=%ymm8,>t0=%ymm15
vpunpckldq %ymm14,%ymm8,%ymm15

# qhasm: t1 = unpack high dwords of x1 and x3
# asm 1: vpunpckhdq <x3=reg256#15,<x1=reg256#9,>t1=reg256#9
# asm 2: vpunpckhdq <x3=%ymm14,<x1=%ymm8,>t1=%ymm8
vpunpckhdq %ymm14,%ymm8,%ymm8

# qhasm: x1[0,1,2,3] = t0[0,1],t1[0,1]
# asm 1: vperm2f128 $0x20,<t1=reg256#9,<t0=reg256#16,>x1=reg256#15
# asm 2: vperm2f128 $0x20,<t1=%ymm8,<t0=%ymm15,>x1=%ymm14
vperm2f128 $0x20,%ymm8,%ymm15,%ymm14

# qhasm: x3[0,1,2,3] = t0[2,3],t1[2,3]
# asm 1: vperm2f128 $0x31,<t1=reg256#9,<t0=reg256#16,>x3=reg256#9
# asm 2: vperm2f128 $0x31,<t1=%ymm8,<t0=%ymm15,>x3=%ymm8
vperm2f128 $0x31,%ymm8,%ymm15,%ymm8

# qhasm: t0 = unpack  low dwords of x4 and x6
# asm 1: vpunpckldq <x6=reg256#5,<x4=reg256#3,>t0=reg256#16
# asm 2: vpunpckldq <x6=%ymm4,<x4=%ymm2,>t0=%ymm15
vpunpckldq %ymm4,%ymm2,%ymm15
...
# qhasm: x4[0,1,2,3] = t0[0,1],t1[0,1]
# asm 1: vperm2f128 $0x20,<t1=reg256#3,<t0=reg256#16,>x4=reg256#5
# asm 2: vperm2f128 $0x20,<t1=%ymm2,<t0=%ymm15,>x4=%ymm4
vperm2f128 $0x20,%ymm2,%ymm15,%ymm4

# qhasm: x6[0,1,2,3] = t0[2,3],t1[2,3]
# asm 1: vperm2f128 $0x31,<t1=reg256#3,<t0=reg256#16,>x6=reg256#3
# asm 2: vperm2f128 $0x31,<t1=%ymm2,<t0=%ymm15,>x6=%ymm2
vperm2f128 $0x31,%ymm2,%ymm15,%ymm2

# qhasm: t0 = unpack  low dwords of x5 and x7
# asm 1: vpunpckldq <x7=reg256#7,<x5=reg256#4,>t0=reg256#16
# asm 2: vpunpckldq <x7=%ymm6,<x5=%ymm3,>t0=%ymm15
vpunpckldq %ymm6,%ymm3,%ymm15

# qhasm: t1 = unpack high dwords of x5 and x7
# asm 1: vpunpckhdq <x7=reg256#7,<x5=reg256#4,>t1=reg256#4
# asm 2: vpunpckhdq <x7=%ymm6,<x5=%ymm3,>t1=%ymm3
vpunpckhdq %ymm6,%ymm3,%ymm3

# qhasm: x5[0,1,2,3] = t0[0,1],t1[0,1]
# asm 1: vperm2f128 $0x20,<t1=reg256#4,<t0=reg256#16,>x5=reg256#7
# asm 2: vperm2f128 $0x20,<t1=%ymm3,<t0=%ymm15,>x5=%ymm6
vperm2f128 $0x20,%ymm3,%ymm15,%ymm6

# qhasm: x7[0,1,2,3] = t0[2,3],t1[2,3]
# asm 1: vperm2f128 $0x31,<t1=reg256#4,<t0=reg256#16,>x7=reg256#4
# asm 2: vperm2f128 $0x31,<t1=%ymm3,<t0=%ymm15,>x7=%ymm3
vperm2f128 $0x31,%ymm3,%ymm15,%ymm3

# qhasm: t0 = unpack  low dwords of x0 and x1
# asm 1: vpunpckldq <x1=reg256#15,<x0=reg256#10,>t0=reg256#16
# asm 2: vpunpckldq <x1=%ymm14,<x0=%ymm9,>t0=%ymm15
vpunpckldq %ymm14,%ymm9,%ymm15

# qhasm: t1 = unpack high dwords of x0 and x1
# asm 1: vpunpckhdq <x1=reg256#15,<x0=reg256#10,>t1=reg256#10
# asm 2: vpunpckhdq <x1=%ymm14,<x0=%ymm9,>t1=%ymm9
vpunpckhdq %ymm14,%ymm9,%ymm9
...
# qhasm: t0 = unpack  low dwords of x2 and x3
# asm 1: vpunpckldq <x3=reg256#9,<x2=reg256#8,>t0=reg256#16
# asm 2: vpunpckldq <x3=%ymm8,<x2=%ymm7,>t0=%ymm15
vpunpckldq %ymm8,%ymm7,%ymm15

# qhasm: t1 = unpack high dwords of x2 and x3
# asm 1: vpunpckhdq <x3=reg256#9,<x2=reg256#8,>t1=reg256#8
# asm 2: vpunpckhdq <x3=%ymm8,<x2=%ymm7,>t1=%ymm7
...
# qhasm: t0 = unpack  low dwords of x4 and x5
# asm 1: vpunpckldq <x5=reg256#7,<x4=reg256#5,>t0=reg256#16
# asm 2: vpunpckldq <x5=%ymm6,<x4=%ymm4,>t0=%ymm15
vpunpckldq %ymm6,%ymm4,%ymm15

# qhasm: t1 = unpack high dwords of x4 and x5
# asm 1: vpunpckhdq <x5=reg256#7,<x4=reg256#5,>t1=reg256#5
# asm 2: vpunpckhdq <x5=%ymm6,<x4=%ymm4,>t1=%ymm4
...
# qhasm: t0 = unpack  low dwords of x6 and x7
# asm 1: vpunpckldq <x7=reg256#4,<x6=reg256#3,>t0=reg256#16
# asm 2: vpunpckldq <x7=%ymm3,<x6=%ymm2,>t0=%ymm15
