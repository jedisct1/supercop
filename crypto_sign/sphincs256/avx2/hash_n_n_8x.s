...
# qhasm: x13 ^= x2
# asm 1: vxorpd <x2=reg256#8,<x13=reg256#12,>x13=reg256#12
# asm 2: vxorpd <x2=%ymm7,<x13=%ymm11,>x13=%ymm11
vxorpd %ymm7,%ymm11,%ymm11

# qhasm: x14 ^= x3
# asm 1: vxorpd <x3=reg256#7,<x14=reg256#14,>x14=reg256#13
# asm 2: vxorpd <x3=%ymm6,<x14=%ymm13,>x14=%ymm12
vxorpd %ymm6,%ymm13,%ymm12
...
# qhasm: 8x x8 += x13
# asm 1: vpaddd <x13=reg256#12,<x8=reg256#6,>x8=reg256#6
# asm 2: vpaddd <x13=%ymm11,<x8=%ymm5,>x8=%ymm5
vpaddd %ymm11,%ymm5,%ymm5
...
# qhasm: 8x t1 = x4 << 12
# asm 1: vpslld $12,<x4=reg256#4,>t1=reg256#14
# asm 2: vpslld $12,<x4=%ymm3,>t1=%ymm13
vpslld $12,%ymm3,%ymm13
...
# qhasm: x4 ^= t1
# asm 1: vxorpd <t1=reg256#14,<x4=reg256#4,>x4=reg256#4
# asm 2: vxorpd <t1=%ymm13,<x4=%ymm3,>x4=%ymm3
...
# qhasm: x14 ^= x3
# asm 1: vxorpd <x3=reg256#7,<x14=reg256#2,>x14=reg256#2
# asm 2: vxorpd <x3=%ymm6,<x14=%ymm1,>x14=%ymm1
...
# qhasm: 8x x8 += x13
# asm 1: vpaddd <x13=reg256#12,<x8=reg256#6,>x8=reg256#2
# asm 2: vpaddd <x13=%ymm11,<x8=%ymm5,>x8=%ymm1
vpaddd %ymm11,%ymm5,%ymm1
...
# qhasm: x4 ^= x9
# asm 1: vxorpd <x9=reg256#1,<x4=reg256#4,>x4=reg256#1
# asm 2: vxorpd <x9=%ymm0,<x4=%ymm3,>x4=%ymm0
...
# qhasm: 8x t1 = x4 << 7
# asm 1: vpslld $7,<x4=reg256#1,>t1=reg256#4
# asm 2: vpslld $7,<x4=%ymm0,>t1=%ymm3
vpslld $7,%ymm0,%ymm3
...
# qhasm: x4 ^= t1
# asm 1: vxorpd <t1=reg256#4,<x4=reg256#1,>x4=reg256#1
# asm 2: vxorpd <t1=%ymm3,<x4=%ymm0,>x4=%ymm0
...
# qhasm: t0 = unpack  low dwords of x0 and x4 
# asm 1: vpunpckldq <x4=reg256#1,<x0=reg256#10,>t0=reg256#4
# asm 2: vpunpckldq <x4=%ymm0,<x0=%ymm9,>t0=%ymm3
vpunpckldq %ymm0,%ymm9,%ymm3

# qhasm: t1 = unpack high dwords of x0 and x4 
# asm 1: vpunpckhdq <x4=reg256#1,<x0=reg256#10,>t1=reg256#1
# asm 2: vpunpckhdq <x4=%ymm0,<x0=%ymm9,>t1=%ymm0
vpunpckhdq %ymm0,%ymm9,%ymm0

# qhasm: x0[0,1,2,3] = t0[0,1],t1[0,1]
# asm 1: vperm2f128 $0x20,<t1=reg256#1,<t0=reg256#4,>x0=reg256#6
# asm 2: vperm2f128 $0x20,<t1=%ymm0,<t0=%ymm3,>x0=%ymm5
vperm2f128 $0x20,%ymm0,%ymm3,%ymm5

# qhasm: x4[0,1,2,3] = t0[2,3],t1[2,3]
# asm 1: vperm2f128 $0x31,<t1=reg256#1,<t0=reg256#4,>x4=reg256#1
# asm 2: vperm2f128 $0x31,<t1=%ymm0,<t0=%ymm3,>x4=%ymm0
vperm2f128 $0x31,%ymm0,%ymm3,%ymm0
...
# qhasm: t0 = unpack  low dwords of x2 and x6
# asm 1: vpunpckldq <x6=reg256#3,<x2=reg256#8,>t0=reg256#5
# asm 2: vpunpckldq <x6=%ymm2,<x2=%ymm7,>t0=%ymm4
vpunpckldq %ymm2,%ymm7,%ymm4

# qhasm: t1 = unpack high dwords of x2 and x6
# asm 1: vpunpckhdq <x6=reg256#3,<x2=reg256#8,>t1=reg256#3
# asm 2: vpunpckhdq <x6=%ymm2,<x2=%ymm7,>t1=%ymm2
vpunpckhdq %ymm2,%ymm7,%ymm2

# qhasm: x2[0,1,2,3] = t0[0,1],t1[0,1]
# asm 1: vperm2f128 $0x20,<t1=reg256#3,<t0=reg256#5,>x2=reg256#8
# asm 2: vperm2f128 $0x20,<t1=%ymm2,<t0=%ymm4,>x2=%ymm7
vperm2f128 $0x20,%ymm2,%ymm4,%ymm7

# qhasm: x6[0,1,2,3] = t0[2,3],t1[2,3]
# asm 1: vperm2f128 $0x31,<t1=reg256#3,<t0=reg256#5,>x6=reg256#3
# asm 2: vperm2f128 $0x31,<t1=%ymm2,<t0=%ymm4,>x6=%ymm2
vperm2f128 $0x31,%ymm2,%ymm4,%ymm2

# qhasm: t0 = unpack  low dwords of x3 and x7
# asm 1: vpunpckldq <x7=reg256#2,<x3=reg256#7,>t0=reg256#5
# asm 2: vpunpckldq <x7=%ymm1,<x3=%ymm6,>t0=%ymm4
vpunpckldq %ymm1,%ymm6,%ymm4

# qhasm: t1 = unpack high dwords of x3 and x7
# asm 1: vpunpckhdq <x7=reg256#2,<x3=reg256#7,>t1=reg256#2
# asm 2: vpunpckhdq <x7=%ymm1,<x3=%ymm6,>t1=%ymm1
vpunpckhdq %ymm1,%ymm6,%ymm1

# qhasm: x3[0,1,2,3] = t0[0,1],t1[0,1]
# asm 1: vperm2f128 $0x20,<t1=reg256#2,<t0=reg256#5,>x3=reg256#7
# asm 2: vperm2f128 $0x20,<t1=%ymm1,<t0=%ymm4,>x3=%ymm6
vperm2f128 $0x20,%ymm1,%ymm4,%ymm6

# qhasm: x7[0,1,2,3] = t0[2,3],t1[2,3]
# asm 1: vperm2f128 $0x31,<t1=reg256#2,<t0=reg256#5,>x7=reg256#2
# asm 2: vperm2f128 $0x31,<t1=%ymm1,<t0=%ymm4,>x7=%ymm1
...
# qhasm: t0 = unpack  low dwords of x5 and x7
# asm 1: vpunpckldq <x7=reg256#2,<x5=reg256#4,>t0=reg256#7
# asm 2: vpunpckldq <x7=%ymm1,<x5=%ymm3,>t0=%ymm6
vpunpckldq %ymm1,%ymm3,%ymm6

# qhasm: t1 = unpack high dwords of x5 and x7
# asm 1: vpunpckhdq <x7=reg256#2,<x5=reg256#4,>t1=reg256#2
# asm 2: vpunpckhdq <x7=%ymm1,<x5=%ymm3,>t1=%ymm1
vpunpckhdq %ymm1,%ymm3,%ymm1

# qhasm: x5[0,1,2,3] = t0[0,1],t1[0,1]
# asm 1: vperm2f128 $0x20,<t1=reg256#2,<t0=reg256#7,>x5=reg256#4
# asm 2: vperm2f128 $0x20,<t1=%ymm1,<t0=%ymm6,>x5=%ymm3
vperm2f128 $0x20,%ymm1,%ymm6,%ymm3
...
# qhasm: t0 = unpack  low dwords of x4 and x5
# asm 1: vpunpckldq <x5=reg256#4,<x4=reg256#3,>t0=reg256#8
# asm 2: vpunpckldq <x5=%ymm3,<x4=%ymm2,>t0=%ymm7
...
# qhasm: x4[0,1,2,3] = t0[0,1],t1[0,1]
# asm 1: vperm2f128 $0x20,<t1=reg256#3,<t0=reg256#8,>x4=reg256#4
# asm 2: vperm2f128 $0x20,<t1=%ymm2,<t0=%ymm7,>x4=%ymm3
vperm2f128 $0x20,%ymm2,%ymm7,%ymm3
...
# asm 1: vmovupd   <x5=reg256#3,160(<input_0=int64#1)
# asm 2: vmovupd   <x5=%ymm2,160(<input_0=%rdi)
vmovupd   %ymm2,160(%rdi)

# qhasm: mem256[input_0 + 192] = x6
# asm 1: vmovupd   <x6=reg256#2,192(<input_0=int64#1)
# asm 2: vmovupd   <x6=%ymm1,192(<input_0=%rdi)
