...
# qhasm: enter crypto_sign_ed25519_amd64_64_24k_sc25519_add
.text
.p2align 5
.globl _crypto_sign_ed25519_amd64_64_24k_sc25519_add
.globl crypto_sign_ed25519_amd64_64_24k_sc25519_add
_crypto_sign_ed25519_amd64_64_24k_sc25519_add:
crypto_sign_ed25519_amd64_64_24k_sc25519_add:
mov %rsp,%r11
and $31,%r11
add $32,%r11
sub %r11,%rsp
...
# asm 1: sub  crypto_sign_ed25519_amd64_64_24k_ORDER0,<t0=int64#3
# asm 2: sub  crypto_sign_ed25519_amd64_64_24k_ORDER0,<t0=%rdx
sub  crypto_sign_ed25519_amd64_64_24k_ORDER0(%rip),%rdx

# qhasm: carry? t1 -= *(uint64 *) &crypto_sign_ed25519_amd64_64_24k_ORDER1 - carry
# asm 1: sbb  crypto_sign_ed25519_amd64_64_24k_ORDER1,<t1=int64#7
# asm 2: sbb  crypto_sign_ed25519_amd64_64_24k_ORDER1,<t1=%rax
sbb  crypto_sign_ed25519_amd64_64_24k_ORDER1(%rip),%rax
...
# asm 1: sbb  crypto_sign_ed25519_amd64_64_24k_ORDER3,<t3=int64#12
# asm 2: sbb  crypto_sign_ed25519_amd64_64_24k_ORDER3,<t3=%r14
sbb  crypto_sign_ed25519_amd64_64_24k_ORDER3(%rip),%r14
