...
typedef crypto_int32 fe[10] __attribute__ ((aligned (16)));
typedef crypto_int32 fepad[12] __attribute__ ((aligned (16))); /* fe padded to a multiple of 16 bytes for alignment inside fe arrays*/
...
#define fe_mulmul CRYPTO_NAMESPACE(fe_mulmul)
#define fe_sq CRYPTO_NAMESPACE(fe_sq)
#define fe_sq2 CRYPTO_NAMESPACE(fe_sq2)
#define fe_sqsq CRYPTO_NAMESPACE(fe_sqsq)
#define fe_sq2sq CRYPTO_NAMESPACE(fe_sq2sq)
...
extern void fe_mulmul(fe,const fe,const fe, fe,const fe,const fe);
extern void fe_sq(fe,const fe);
extern void fe_sq2(fe,const fe);
extern void fe_sqsq(fe,const fe,fe,const fe);
extern void fe_sq2sq(fe,const fe,fe,const fe);
