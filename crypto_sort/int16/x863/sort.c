...
#include "int16_minmax_x86.inc"

/* k is a multiple of 4p */
/* p is a multiple of 2q */
/* p is a power of 2 */
static inline void twolevels_down(int16 *x,int16 k,int16 p,int16 q)
{
  int16 i;
  x += k;
  while (p > 0) {
...
static inline void twolevels_up(int16 *x,int16 k,int16 p,int16 q)
{
  int16 i;
  x += k;
  while (p > 0) {
...
/* p is a power of 2 */
static inline void threelevels_down(int16 *x,int16 k,int16 p,int16 q)
{
  int16 i;
  x += k;
  while (p > 0) {
...
static inline void threelevels_up(int16 *x,int16 k,int16 p,int16 q)
{
  int16 i;
  x += k;
  while (p > 0) {
...
static inline void crypto_sort_smallindices(int16 *x,int16 n)
{ int16 t,p,q,i,j,k;
  ...
  if (k+4 <= n) {
    int16_MINMAX(x[k+1],x[k]);
    int16_MINMAX(x[k+2],x[k+3]);
    if (k+6 < n)
      int16_MINMAX(x[k+5],x[k+4]);
    else if (k+6 <= n)
      int16_MINMAX(x[k+4],x[k+5]);
  } else {
    if (k+2 < n)
      int16_MINMAX(x[k+1],x[k]);
    else if (k+2 <= n)
      int16_MINMAX(x[k],x[k+1]);
  }
