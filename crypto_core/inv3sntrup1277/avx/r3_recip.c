...
/*
This code stores 1280-coeff poly as vec256[5].
...
static inline void vec256_divx_4(vec256 *f)
{
  ...
  low0 = (low0 >> 1) | crypto_uint64_shlmod(low1,63);
  low1 = (low1 >> 1) | crypto_uint64_shlmod(low2,63);
  low2 = (low2 >> 1) | crypto_uint64_shlmod(low3,63);
  low3 = low3 >> 1;
...
static inline void vec256_divx_5(vec256 *f)
{
  vec256 f0 = f[0];
  vec256 f1 = f[1];
  vec256 f2 = f[2];
  ...
  unsigned long long low2 = _mm_cvtsi128_si64(_mm256_castsi256_si128(f2));
  unsigned long long low3 = _mm_cvtsi128_si64(_mm256_castsi256_si128(f3));
  unsigned long long low4 = _mm_cvtsi128_si64(_mm256_castsi256_si128(f4));

  low0 = (low0 >> 1) | crypto_uint64_shlmod(low1,63);
  low1 = (low1 >> 1) | crypto_uint64_shlmod(low2,63);
  low2 = (low2 >> 1) | crypto_uint64_shlmod(low3,63);
  low3 = (low3 >> 1) | crypto_uint64_shlmod(low4,63);
  low4 = low4 >> 1;
  ...
  f2 = _mm256_blend_epi32(f2,_mm256_set_epi64x(0,0,0,low2),0x3);
  f3 = _mm256_blend_epi32(f3,_mm256_set_epi64x(0,0,0,low3),0x3);
  f4 = _mm256_blend_epi32(f4,_mm256_set_epi64x(0,0,0,low4),0x3);

  f[0] = _mm256_permute4x64_epi64(f0,0x39);
  f[1] = _mm256_permute4x64_epi64(f1,0x39);
  f[2] = _mm256_permute4x64_epi64(f2,0x39);
  f[3] = _mm256_permute4x64_epi64(f3,0x39);
  f[4] = _mm256_permute4x64_epi64(f4,0x39);
}
...
static inline void vec256_timesx_4(vec256 *f)
{
  ...
  low3 = (low3 << 1) | crypto_int64_negative_01(low2);
  low2 = (low2 << 1) | crypto_int64_negative_01(low1);
  low1 = (low1 << 1) | crypto_int64_negative_01(low0);
  low0 = low0 << 1;
...
static inline void vec256_timesx_5(vec256 *f)
{
  vec256 f0 = _mm256_permute4x64_epi64(f[0],0x93);
  vec256 f1 = _mm256_permute4x64_epi64(f[1],0x93);
  vec256 f2 = _mm256_permute4x64_epi64(f[2],0x93);
  vec256 f3 = _mm256_permute4x64_epi64(f[3],0x93);
  vec256 f4 = _mm256_permute4x64_epi64(f[4],0x93);
  ...
  low4 = (low4 << 1) | crypto_int64_negative_01(low3);
  low3 = (low3 << 1) | crypto_int64_negative_01(low2);
  low2 = (low2 << 1) | crypto_int64_negative_01(low1);
  low1 = (low1 << 1) | crypto_int64_negative_01(low0);
  low0 = low0 << 1;
...
{ 
  ...
  F0[3] = _mm256_set1_epi32(0);
  F0[4] = _mm256_set_epi32(0,0,0,0,-2147483648,0,-2147483648,0);
  F1[0] = _mm256_set1_epi32(0);
  F1[1] = _mm256_set1_epi32(0);
  F1[2] = _mm256_set1_epi32(0);
  F1[3] = _mm256_set1_epi32(0);
  F1[4] = _mm256_set_epi32(0,0,0,0,-2147483648,0,-2147483648,0);
  ...
  V0[4] = _mm256_set1_epi32(0);
  V1[4] = _mm256_set1_epi32(0);
  ...
  R0[4] = _mm256_set1_epi32(0);
  R1[4] = _mm256_set1_epi32(0);
  ...
  for (loop = 256;loop > 0;--loop) {
    ...
    vec256_swap(F0,G0,5,swapvec);
    vec256_swap(F1,G1,5,swapvec);

    c0vec = _mm256_set1_epi32(c0);
    c1vec = _mm256_set1_epi32(c1);

    vec256_eliminate(F0,F1,G0,G1,5,c0vec,c1vec);
    vec256_divx_5(G0);
    vec256_divx_5(G1);
  ...
  for (loop = 505;loop > 0;--loop) {
    ...
    vec256_swap(V0,R0,5,swapvec);
    vec256_swap(V1,R1,5,swapvec);
    vec256_eliminate(V0,V1,R0,R1,5,c0vec,c1vec);
  }
