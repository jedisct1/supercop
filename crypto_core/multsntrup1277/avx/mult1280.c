...
{
  return sub_x16(x,mullo_x16(mulhrs_x16(x,const_x16(4)),const_x16(7879)));
}
...
#define hpad fpad
  ...
  for (i = 0;i < 512;i += 16) {
    ...
    int16x16 f4 = squeeze_10753_x16(load_x16(&fpad[4][i]));
    ...
    int16x16 g4 = squeeze_10753_x16(load_x16(&gpad[4][i]));
    ...
    int16x16 d4 = mulmod_10753_x16(f4,g4);
    int16x16 dsum;
    int16x16 h0,h1,h2,h3,h4;

    dsum = add_x16(add_x16(d0,d1),d2);
    dsum = squeeze_10753_x16(dsum);
    dsum = add_x16(add_x16(d3,d4),dsum);
    dsum = squeeze_10753_x16(dsum);

    /* could save one mult here using sum hi = (sum fi)(sum gi) */

    h0 = add_x16(dsum,mulmod_10753_x16(sub_x16(f4,f1),sub_x16(g1,g4)));
    h1 = add_x16(dsum,mulmod_10753_x16(sub_x16(f1,f0),sub_x16(g0,g1)));
    h2 = add_x16(dsum,mulmod_10753_x16(sub_x16(f2,f0),sub_x16(g0,g2)));
    h3 = add_x16(dsum,mulmod_10753_x16(sub_x16(f3,f0),sub_x16(g0,g3)));
    h4 = add_x16(dsum,mulmod_10753_x16(sub_x16(f4,f0),sub_x16(g0,g4)));
    h0 = add_x16(h0,mulmod_10753_x16(sub_x16(f3,f2),sub_x16(g2,g3)));
    h1 = add_x16(h1,mulmod_10753_x16(sub_x16(f4,f2),sub_x16(g2,g4)));
    h2 = add_x16(h2,mulmod_10753_x16(sub_x16(f4,f3),sub_x16(g3,g4)));
    h3 = add_x16(h3,mulmod_10753_x16(sub_x16(f2,f1),sub_x16(g1,g2)));
    h4 = add_x16(h4,mulmod_10753_x16(sub_x16(f3,f1),sub_x16(g1,g3)));
    ...
    store_x16(&hpad[4][i],squeeze_10753_x16(h4));
  }
  ...
  for (i = 0;i < 2560;i += 16) {
    ...
    t = add_x16(u1,mulmod_7879_x16(t,const_x16(2969)));
    store_x16(&h[i],t);
  }
}
