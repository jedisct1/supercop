...
/* Input x[4]; output z[4] */
extern void bignum_inv_sm2(uint64_t z[4],uint64_t x[4]);
...
/* Input x[6]; output z[6] */
extern void bignum_montinv_p384(uint64_t z[6],uint64_t x[6]);
...
extern void sha3_keccak_f1600_alt2(uint64_t a[25],uint64_t rc[24]);
