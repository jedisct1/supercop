...
# qhasm: twopower = 0x800000 simple
# asm 1: mov >twopower=int32#12,0x800000
# asm 2: mov >twopower=r11,0x800000
mov r11,0x800000

# qhasm: hitmp lotmp = lou1 * twopower
# asm 1: umull >lotmp=int32#14,>hitmp=int32#13,<lou1=int32#4,<twopower=int32#12
# asm 2: umull >lotmp=r14,>hitmp=r12,<lou1=r3,<twopower=r11
umull r14,r12,r3,r11

# qhasm: lotmp hitmp += hiu1 * twopower
# asm 1: umlal <hitmp=int32#13,<lotmp=int32#14,<hiu1=int32#5,<twopower=int32#12
# asm 2: umlal <hitmp=r12,<lotmp=r14,<hiu1=r4,<twopower=r11
umlal r12,r14,r4,r11

# qhasm: lotmp ^= (lou1 unsigned>> 18)
# asm 1: eor >lotmp=int32#12,<lotmp=int32#14,<lou1=int32#4,LSR #18
# asm 2: eor >lotmp=r11,<lotmp=r14,<lou1=r3,LSR #18
eor r11,r14,r3,LSR #18
...
# asm 1: eor >hitmp=int32#13,<hitmp=int32#13,<hiu1=int32#5,LSR #18
# asm 2: eor >hitmp=r12,<hitmp=r12,<hiu1=r4,LSR #18
eor r12,r12,r4,LSR #18

# qhasm: hitmp ^= (lou1 << 14)
# asm 1: eor >hitmp=int32#13,<hitmp=int32#13,<lou1=int32#4,LSL #14
# asm 2: eor >hitmp=r12,<hitmp=r12,<lou1=r3,LSL #14
eor r12,r12,r3,LSL #14

# qhasm: hitmp ^= (hiu1 unsigned>> 14)
# asm 1: eor >hitmp=int32#13,<hitmp=int32#13,<hiu1=int32#5,LSR #14
# asm 2: eor >hitmp=r12,<hitmp=r12,<hiu1=r4,LSR #14
eor r12,r12,r4,LSR #14

# qhasm: hitmp ^= (lou1 << 18)
# asm 1: eor >hitmp=int32#13,<hitmp=int32#13,<lou1=int32#4,LSL #18
# asm 2: eor >hitmp=r12,<hitmp=r12,<lou1=r3,LSL #18
eor r12,r12,r3,LSL #18
...
# qhasm: twopower = 0x2000000 simple
# asm 1: mov >twopower=int32#12,0x2000000
# asm 2: mov >twopower=r11,0x2000000
# copy-collector output starts
vmov d3,r1,r2
vmov r5,r6,d0
vmov r7,r8,d1
...
# qhasm: hitmp lotmp = lou1 * twopower
# asm 1: umull >lotmp=int32#14,>hitmp=int32#13,<lou1=int32#6,<twopower=int32#12
# asm 2: umull >lotmp=r14,>hitmp=r12,<lou1=r5,<twopower=r11
umull r14,r12,r5,r11

# qhasm: lotmp hitmp += hiu1 * twopower
# asm 1: umlal <hitmp=int32#13,<lotmp=int32#14,<hiu1=int32#7,<twopower=int32#12
# asm 2: umlal <hitmp=r12,<lotmp=r14,<hiu1=r6,<twopower=r11
...
# qhasm: hitmp lotmp = lou0 * twopower
# asm 1: umull >lotmp=int32#14,>hitmp=int32#13,<lou0=int32#2,<twopower=int32#12
# asm 2: umull >lotmp=r14,>hitmp=r12,<lou0=r1,<twopower=r11
umull r14,r12,r1,r11

# qhasm: lotmp hitmp += hiu0 * twopower
# asm 1: umlal <hitmp=int32#13,<lotmp=int32#14,<hiu0=int32#3,<twopower=int32#12
# asm 2: umlal <hitmp=r12,<lotmp=r14,<hiu0=r2,<twopower=r11
umlal r12,r14,r2,r11

# qhasm: lotmp ^= (lou0 unsigned>> 18)
# asm 1: eor >lotmp=int32#12,<lotmp=int32#14,<lou0=int32#2,LSR #18
# asm 2: eor >lotmp=r11,<lotmp=r14,<lou0=r1,LSR #18
eor r11,r14,r1,LSR #18
...
# asm 1: eor >hitmp=int32#13,<hitmp=int32#13,<hiu0=int32#3,LSR #18
# asm 2: eor >hitmp=r12,<hitmp=r12,<hiu0=r2,LSR #18
eor r12,r12,r2,LSR #18

# qhasm: hitmp ^= (lou0 << 14)
# asm 1: eor >hitmp=int32#13,<hitmp=int32#13,<lou0=int32#2,LSL #14
# asm 2: eor >hitmp=r12,<hitmp=r12,<lou0=r1,LSL #14
eor r12,r12,r1,LSL #14

# qhasm: hitmp ^= (hiu0 unsigned>> 14)
# asm 1: eor >hitmp=int32#13,<hitmp=int32#13,<hiu0=int32#3,LSR #14
# asm 2: eor >hitmp=r12,<hitmp=r12,<hiu0=r2,LSR #14
eor r12,r12,r2,LSR #14

# qhasm: hitmp ^= (lou0 << 18)
# asm 1: eor >hitmp=int32#13,<hitmp=int32#13,<lou0=int32#2,LSL #18
# asm 2: eor >hitmp=r12,<hitmp=r12,<lou0=r1,LSL #18
eor r12,r12,r1,LSL #18
...
# qhasm: hitmp lotmp = lou0 * twopower
# asm 1: umull >lotmp=int32#14,>hitmp=int32#13,<lou0=int32#6,<twopower=int32#12
# asm 2: umull >lotmp=r14,>hitmp=r12,<lou0=r5,<twopower=r11
umull r14,r12,r5,r11

# qhasm: lotmp hitmp += hiu0 * twopower
# asm 1: umlal <hitmp=int32#13,<lotmp=int32#14,<hiu0=int32#7,<twopower=int32#12
# asm 2: umlal <hitmp=r12,<lotmp=r14,<hiu0=r6,<twopower=r11
umlal r12,r14,r6,r11
...
# qhasm: hitmp lotmp = lou3 * twopower
# asm 1: umull >lotmp=int32#14,>hitmp=int32#13,<lou3=int32#4,<twopower=int32#12
# asm 2: umull >lotmp=r14,>hitmp=r12,<lou3=r3,<twopower=r11
umull r14,r12,r3,r11

# qhasm: lotmp hitmp += hiu3 * twopower
# asm 1: umlal <hitmp=int32#13,<lotmp=int32#14,<hiu3=int32#5,<twopower=int32#12
# asm 2: umlal <hitmp=r12,<lotmp=r14,<hiu3=r4,<twopower=r11
umlal r12,r14,r4,r11

# qhasm: lotmp ^= (lou3 unsigned>> 18)
# asm 1: eor >lotmp=int32#12,<lotmp=int32#14,<lou3=int32#4,LSR #18
# asm 2: eor >lotmp=r11,<lotmp=r14,<lou3=r3,LSR #18
eor r11,r14,r3,LSR #18
...
# asm 1: eor >hitmp=int32#13,<hitmp=int32#13,<hiu3=int32#5,LSR #18
# asm 2: eor >hitmp=r12,<hitmp=r12,<hiu3=r4,LSR #18
eor r12,r12,r4,LSR #18

# qhasm: hitmp ^= (lou3 << 14)
# asm 1: eor >hitmp=int32#13,<hitmp=int32#13,<lou3=int32#4,LSL #14
# asm 2: eor >hitmp=r12,<hitmp=r12,<lou3=r3,LSL #14
eor r12,r12,r3,LSL #14

# qhasm: hitmp ^= (hiu3 unsigned>> 14)
# asm 1: eor >hitmp=int32#13,<hitmp=int32#13,<hiu3=int32#5,LSR #14
# asm 2: eor >hitmp=r12,<hitmp=r12,<hiu3=r4,LSR #14
eor r12,r12,r4,LSR #14

# qhasm: hitmp ^= (lou3 << 18)
# asm 1: eor >hitmp=int32#13,<hitmp=int32#13,<lou3=int32#4,LSL #18
# asm 2: eor >hitmp=r12,<hitmp=r12,<lou3=r3,LSL #18
eor r12,r12,r3,LSL #18
...
# qhasm: hitmp lotmp = lou2 * twopower
# asm 1: umull >lotmp=int32#14,>hitmp=int32#13,<lou2=int32#4,<twopower=int32#12
# asm 2: umull >lotmp=r14,>hitmp=r12,<lou2=r3,<twopower=r11
umull r14,r12,r3,r11

# qhasm: lotmp hitmp += hiu2 * twopower
# asm 1: umlal <hitmp=int32#13,<lotmp=int32#14,<hiu2=int32#5,<twopower=int32#12
# asm 2: umlal <hitmp=r12,<lotmp=r14,<hiu2=r4,<twopower=r11
umlal r12,r14,r4,r11

# qhasm: lotmp ^= (lou2 unsigned>> 18)
# asm 1: eor >lotmp=int32#12,<lotmp=int32#14,<lou2=int32#4,LSR #18
# asm 2: eor >lotmp=r11,<lotmp=r14,<lou2=r3,LSR #18
eor r11,r14,r3,LSR #18
...
# asm 1: eor >hitmp=int32#13,<hitmp=int32#13,<hiu2=int32#5,LSR #18
# asm 2: eor >hitmp=r12,<hitmp=r12,<hiu2=r4,LSR #18
eor r12,r12,r4,LSR #18

# qhasm: hitmp ^= (lou2 << 14)
# asm 1: eor >hitmp=int32#13,<hitmp=int32#13,<lou2=int32#4,LSL #14
# asm 2: eor >hitmp=r12,<hitmp=r12,<lou2=r3,LSL #14
eor r12,r12,r3,LSL #14

# qhasm: hitmp ^= (hiu2 unsigned>> 14)
# asm 1: eor >hitmp=int32#13,<hitmp=int32#13,<hiu2=int32#5,LSR #14
# asm 2: eor >hitmp=r12,<hitmp=r12,<hiu2=r4,LSR #14
eor r12,r12,r4,LSR #14

# qhasm: hitmp ^= (lou2 << 18)
# asm 1: eor >hitmp=int32#13,<hitmp=int32#13,<lou2=int32#4,LSL #18
# asm 2: eor >hitmp=r12,<hitmp=r12,<lou2=r3,LSL #18
eor r12,r12,r3,LSL #18
...
# qhasm: twopower = 0x2000000 simple
# asm 1: mov >twopower=int32#10,0x2000000
# asm 2: mov >twopower=r9,0x2000000
# copy-collector output starts
vmov d4,r3,r4
vmov r3,r4,d1
vmov r5,r6,d2
...
# qhasm: hitmp lotmp = lou0 * twopower
# asm 1: umull >lotmp=int32#12,>hitmp=int32#11,<lou0=int32#4,<twopower=int32#10
# asm 2: umull >lotmp=r11,>hitmp=r10,<lou0=r3,<twopower=r9
umull r11,r10,r3,r9

# qhasm: lotmp hitmp += hiu0 * twopower
# asm 1: umlal <hitmp=int32#11,<lotmp=int32#12,<hiu0=int32#5,<twopower=int32#10
# asm 2: umlal <hitmp=r10,<lotmp=r11,<hiu0=r4,<twopower=r9
umlal r10,r11,r4,r9
...
# qhasm: twopower = 0x2000 simple
# asm 1: mov >twopower=int32#10,0x2000
# asm 2: mov >twopower=r9,0x2000
# copy-collector output starts
vmov r1,r2,d8
vmov r3,r4,d9
ldr r5,[sp,#124]
...
# qhasm: hitmp lotmp = hiu2 * twopower
# asm 1: umull >lotmp=int32#12,>hitmp=int32#11,<hiu2=int32#7,<twopower=int32#10
# asm 2: umull >lotmp=r11,>hitmp=r10,<hiu2=r6,<twopower=r9
umull r11,r10,r6,r9

# qhasm: lotmp hitmp += lou2 * twopower
# asm 1: umlal <hitmp=int32#11,<lotmp=int32#12,<lou2=int32#6,<twopower=int32#10
# asm 2: umlal <hitmp=r10,<lotmp=r11,<lou2=r5,<twopower=r9
umlal r10,r11,r5,r9

# qhasm: lotmp ^= (lou2 unsigned>> 6)
# asm 1: eor >lotmp=int32#10,<lotmp=int32#12,<lou2=int32#6,LSR #6
# asm 2: eor >lotmp=r9,<lotmp=r11,<lou2=r5,LSR #6
eor r9,r11,r5,LSR #6
...
# asm 1: eor >hitmp=int32#11,<hitmp=int32#11,<hiu2=int32#7,LSR #6
# asm 2: eor >hitmp=r10,<hitmp=r10,<hiu2=r6,LSR #6
eor r10,r10,r6,LSR #6

# qhasm: hitmp ^= (lou2 unsigned>> 29)
# asm 1: eor >hitmp=int32#11,<hitmp=int32#11,<lou2=int32#6,LSR #29
# asm 2: eor >hitmp=r10,<hitmp=r10,<lou2=r5,LSR #29
eor r10,r10,r5,LSR #29

# qhasm: hitmp ^= (hiu2 << 3)
# asm 1: eor >hitmp=int32#11,<hitmp=int32#11,<hiu2=int32#7,LSL #3
# asm 2: eor >hitmp=r10,<hitmp=r10,<hiu2=r6,LSL #3
eor r10,r10,r6,LSL #3
...
# qhasm: twopower = 0x1000000 simple
# asm 1: mov >twopower=int32#10,0x1000000
# asm 2: mov >twopower=r9,0x1000000
mov r9,0x1000000

# qhasm: hitmp lotmp = hiu1 * twopower
# asm 1: umull >lotmp=int32#12,>hitmp=int32#11,<hiu1=int32#5,<twopower=int32#10
# asm 2: umull >lotmp=r11,>hitmp=r10,<hiu1=r4,<twopower=r9
umull r11,r10,r4,r9

# qhasm: lotmp hitmp += lou1 * twopower
# asm 1: umlal <hitmp=int32#11,<lotmp=int32#12,<lou1=int32#4,<twopower=int32#10
# asm 2: umlal <hitmp=r10,<lotmp=r11,<lou1=r3,<twopower=r9
umlal r10,r11,r3,r9

# qhasm: carry? lotmp ^= (lou1 unsigned>> 1)
# asm 1: eors >lotmp=int32#10,<lotmp=int32#12,<lou1=int32#4,LSR #1
# asm 2: eors >lotmp=r9,<lotmp=r11,<lou1=r3,LSR #1
eors r9,r11,r3,LSR #1

# qhasm: hitmp ^= (carry,hiu1 unsigned>> 1)
# asm 1: eors >hitmp=int32#11,<hitmp=int32#11,<hiu1=int32#5,RRX
# asm 2: eors >hitmp=r10,<hitmp=r10,<hiu1=r4,RRX
eors r10,r10,r4,RRX
...
# qhasm: hitmp lotmp = hiu3 * twopower
# asm 1: umull >lotmp=int32#12,>hitmp=int32#11,<hiu3=int32#9,<twopower=int32#10
# asm 2: umull >lotmp=r11,>hitmp=r10,<hiu3=r8,<twopower=r9
umull r11,r10,r8,r9

# qhasm: lotmp hitmp += lou3 * twopower
# asm 1: umlal <hitmp=int32#11,<lotmp=int32#12,<lou3=int32#8,<twopower=int32#10
# asm 2: umlal <hitmp=r10,<lotmp=r11,<lou3=r7,<twopower=r9
umlal r10,r11,r7,r9

# qhasm: lotmp ^= (lou3 unsigned>> 6)
# asm 1: eor >lotmp=int32#10,<lotmp=int32#12,<lou3=int32#8,LSR #6
# asm 2: eor >lotmp=r9,<lotmp=r11,<lou3=r7,LSR #6
eor r9,r11,r7,LSR #6
...
# asm 1: eor >hitmp=int32#11,<hitmp=int32#11,<hiu3=int32#9,LSR #6
# asm 2: eor >hitmp=r10,<hitmp=r10,<hiu3=r8,LSR #6
eor r10,r10,r8,LSR #6

# qhasm: hitmp ^= (lou3 unsigned>> 29)
# asm 1: eor >hitmp=int32#11,<hitmp=int32#11,<lou3=int32#8,LSR #29
# asm 2: eor >hitmp=r10,<hitmp=r10,<lou3=r7,LSR #29
eor r10,r10,r7,LSR #29

# qhasm: hitmp ^= (hiu3 << 3)
# asm 1: eor >hitmp=int32#11,<hitmp=int32#11,<hiu3=int32#9,LSL #3
# asm 2: eor >hitmp=r10,<hitmp=r10,<hiu3=r8,LSL #3
eor r10,r10,r8,LSL #3
...
# qhasm: twopower = 0x1000000 simple
# asm 1: mov >twopower=int32#12,0x1000000
# asm 2: mov >twopower=r11,0x1000000
# copy-collector output starts
vmov r9,r10,d10
# copy-collector output ends
mov r11,0x1000000

# qhasm: hitmp lotmp = hiu4 * twopower
# asm 1: umull >lotmp=int32#14,>hitmp=int32#13,<hiu4=int32#11,<twopower=int32#12
# asm 2: umull >lotmp=r14,>hitmp=r12,<hiu4=r10,<twopower=r11
umull r14,r12,r10,r11

# qhasm: lotmp hitmp += lou4 * twopower
# asm 1: umlal <hitmp=int32#13,<lotmp=int32#14,<lou4=int32#10,<twopower=int32#12
# asm 2: umlal <hitmp=r12,<lotmp=r14,<lou4=r9,<twopower=r11
umlal r12,r14,r9,r11

# qhasm: carry? lotmp ^= (lou4 unsigned>> 1)
# asm 1: eors >lotmp=int32#12,<lotmp=int32#14,<lou4=int32#10,LSR #1
# asm 2: eors >lotmp=r11,<lotmp=r14,<lou4=r9,LSR #1
eors r11,r14,r9,LSR #1

# qhasm: hitmp ^= (carry,hiu4 unsigned>> 1)
# asm 1: eors >hitmp=int32#13,<hitmp=int32#13,<hiu4=int32#11,RRX
# asm 2: eors >hitmp=r12,<hitmp=r12,<hiu4=r10,RRX
eors r12,r12,r10,RRX
...
# qhasm: twopower = 0x2000 simple
# asm 1: mov >twopower=int32#12,0x2000
# asm 2: mov >twopower=r11,0x2000
# copy-collector output starts
vmov d10,r11,r12
strd r3,r4,[sp,#84]
# copy-collector output ends
...
# qhasm: hitmp lotmp = hiu0 * twopower
# asm 1: umull >lotmp=int32#14,>hitmp=int32#13,<hiu0=int32#3,<twopower=int32#12
# asm 2: umull >lotmp=r14,>hitmp=r12,<hiu0=r2,<twopower=r11
umull r14,r12,r2,r11

# qhasm: lotmp hitmp += lou0 * twopower
# asm 1: umlal <hitmp=int32#13,<lotmp=int32#14,<lou0=int32#2,<twopower=int32#12
# asm 2: umlal <hitmp=r12,<lotmp=r14,<lou0=r1,<twopower=r11
umlal r12,r14,r1,r11

# qhasm: lotmp ^= (lou0 unsigned>> 6)
# asm 1: eor >lotmp=int32#12,<lotmp=int32#14,<lou0=int32#2,LSR #6
# asm 2: eor >lotmp=r11,<lotmp=r14,<lou0=r1,LSR #6
eor r11,r14,r1,LSR #6
...
# asm 1: eor >hitmp=int32#13,<hitmp=int32#13,<hiu0=int32#3,LSR #6
# asm 2: eor >hitmp=r12,<hitmp=r12,<hiu0=r2,LSR #6
eor r12,r12,r2,LSR #6

# qhasm: hitmp ^= (lou0 unsigned>> 29)
# asm 1: eor >hitmp=int32#2,<hitmp=int32#13,<lou0=int32#2,LSR #29
# asm 2: eor >hitmp=r1,<hitmp=r12,<lou0=r1,LSR #29
eor r1,r12,r1,LSR #29
...
# qhasm: carry? lou4 += lotmp
# asm 1: adds >lou4=int32#3,<lou4=int32#10,<lotmp=int32#12
# asm 2: adds >lou4=r2,<lou4=r9,<lotmp=r11
adds r2,r9,r11
...
# qhasm: lou0 = lod11
# asm 1: vmov >lou0=int32#10,<lod11=float32#23
# asm 2: vmov >lou0=r9,<lod11=s22
# copy-collector input: vmov r9,s22
...
# qhasm: hitmp lotmp = hiu0 * twopower
# asm 1: umull >lotmp=int32#14,>hitmp=int32#13,<hiu0=int32#11,<twopower=int32#12
# asm 2: umull >lotmp=r14,>hitmp=r12,<hiu0=r10,<twopower=r11
umull r14,r12,r10,r11

# qhasm: lotmp hitmp += lou0 * twopower
# asm 1: umlal <hitmp=int32#13,<lotmp=int32#14,<lou0=int32#10,<twopower=int32#12
# asm 2: umlal <hitmp=r12,<lotmp=r14,<lou0=r9,<twopower=r11
umlal r12,r14,r9,r11

# qhasm: carry? lotmp ^= (lou0 unsigned>> 1)
# asm 1: eors >lotmp=int32#12,<lotmp=int32#14,<lou0=int32#10,LSR #1
# asm 2: eors >lotmp=r11,<lotmp=r14,<lou0=r9,LSR #1
eors r11,r14,r9,LSR #1

# qhasm: hitmp ^= (carry,hiu0 unsigned>> 1)
# asm 1: eors >hitmp=int32#13,<hitmp=int32#13,<hiu0=int32#11,RRX
# asm 2: eors >hitmp=r12,<hitmp=r12,<hiu0=r10,RRX
eors r12,r12,r10,RRX
...
# asm 1: eor >lotmp=int32#12,<lotmp=int32#12,<lou0=int32#10,LSR #7
# asm 2: eor >lotmp=r11,<lotmp=r11,<lou0=r9,LSR #7
eor r11,r11,r9,LSR #7
...
# qhasm: carry? lou4 += lotmp
# asm 1: adds >lou4=int32#3,<lou4=int32#3,<lotmp=int32#12
# asm 2: adds >lou4=r2,<lou4=r2,<lotmp=r11
adds r2,r2,r11
...
# qhasm: carry? lou4 += lou5
# asm 1: adds >lou4=int32#3,<lou4=int32#3,<lou5=int32#12
# asm 2: adds >lou4=r2,<lou4=r2,<lou5=r11
# copy-collector output starts
ldrd r11,r12,[sp,#100]
# copy-collector output ends
adds r2,r2,r11
...
# qhasm: lom10 = lou4
# asm 1: str <lou4=int32#3,>lom10=stack32#24
# asm 2: str <lou4=r2,>lom10=[sp,#92]
# copy-collector input: str r2,[sp,#92]
...
# qhasm: hitmp lotmp = hiu1 * twopower
# asm 1: umull >lotmp=int32#14,>hitmp=int32#13,<hiu1=int32#5,<twopower=int32#12
# asm 2: umull >lotmp=r14,>hitmp=r12,<hiu1=r4,<twopower=r11
umull r14,r12,r4,r11

# qhasm: lotmp hitmp += lou1 * twopower
# asm 1: umlal <hitmp=int32#13,<lotmp=int32#14,<lou1=int32#4,<twopower=int32#12
# asm 2: umlal <hitmp=r12,<lotmp=r14,<lou1=r3,<twopower=r11
umlal r12,r14,r3,r11

# qhasm: lotmp ^= (lou1 unsigned>> 6)
# asm 1: eor >lotmp=int32#12,<lotmp=int32#14,<lou1=int32#4,LSR #6
# asm 2: eor >lotmp=r11,<lotmp=r14,<lou1=r3,LSR #6
eor r11,r14,r3,LSR #6
...
# asm 1: eor >hitmp=int32#13,<hitmp=int32#13,<hiu1=int32#5,LSR #6
# asm 2: eor >hitmp=r12,<hitmp=r12,<hiu1=r4,LSR #6
eor r12,r12,r4,LSR #6

# qhasm: hitmp ^= (lou1 unsigned>> 29)
# asm 1: eor >hitmp=int32#4,<hitmp=int32#13,<lou1=int32#4,LSR #29
# asm 2: eor >hitmp=r3,<hitmp=r12,<lou1=r3,LSR #29
...
# qhasm: carry? lou0 += lotmp
# asm 1: adds >lou0=int32#5,<lou0=int32#10,<lotmp=int32#12
# asm 2: adds >lou0=r4,<lou0=r9,<lotmp=r11
adds r4,r9,r11
...
# qhasm: lou1 = lod12
# asm 1: vmov >lou1=int32#10,<lod12=float32#25
# asm 2: vmov >lou1=r9,<lod12=s24
# copy-collector input: vmov r9,s24
...
# qhasm: hitmp lotmp = hiu1 * twopower
# asm 1: umull >lotmp=int32#14,>hitmp=int32#13,<hiu1=int32#11,<twopower=int32#12
# asm 2: umull >lotmp=r14,>hitmp=r12,<hiu1=r10,<twopower=r11
umull r14,r12,r10,r11

# qhasm: lotmp hitmp += lou1 * twopower
# asm 1: umlal <hitmp=int32#13,<lotmp=int32#14,<lou1=int32#10,<twopower=int32#12
# asm 2: umlal <hitmp=r12,<lotmp=r14,<lou1=r9,<twopower=r11
umlal r12,r14,r9,r11

# qhasm: carry? lotmp ^= (lou1 unsigned>> 1)
# asm 1: eors >lotmp=int32#12,<lotmp=int32#14,<lou1=int32#10,LSR #1
# asm 2: eors >lotmp=r11,<lotmp=r14,<lou1=r9,LSR #1
eors r11,r14,r9,LSR #1

# qhasm: hitmp ^= (carry,hiu1 unsigned>> 1)
# asm 1: eors >hitmp=int32#13,<hitmp=int32#13,<hiu1=int32#11,RRX
# asm 2: eors >hitmp=r12,<hitmp=r12,<hiu1=r10,RRX
eors r12,r12,r10,RRX
...
# qhasm: lotmp ^= (lou1 unsigned>>7)
# asm 1: eor >lotmp=int32#12,<lotmp=int32#12,<lou1=int32#10,LSR #7
# asm 2: eor >lotmp=r11,<lotmp=r11,<lou1=r9,LSR #7
eor r11,r11,r9,LSR #7
...
# qhasm: carry? lou0 += lotmp
# asm 1: adds >lou0=int32#5,<lou0=int32#5,<lotmp=int32#12
# asm 2: adds >lou0=r4,<lou0=r4,<lotmp=r11
adds r4,r4,r11
...
# asm 1: adds >lou0=int32#5,<lou0=int32#5,<lou5=int32#12
# asm 2: adds >lou0=r4,<lou0=r4,<lou5=r11
# copy-collector output starts
ldrd r11,r12,[sp,#108]
# copy-collector output ends
adds r4,r4,r11
...
# qhasm: lom11 = lou0
# asm 1: str <lou0=int32#5,>lom11=stack32#26
# asm 2: str <lou0=r4,>lom11=[sp,#100]
# copy-collector input: str r4,[sp,#100]
...
# qhasm: hitmp lotmp = hiu4 * twopower
# asm 1: umull >lotmp=int32#14,>hitmp=int32#13,<hiu4=int32#2,<twopower=int32#12
# asm 2: umull >lotmp=r14,>hitmp=r12,<hiu4=r1,<twopower=r11
umull r14,r12,r1,r11

# qhasm: lotmp hitmp += lou4 * twopower
# asm 1: umlal <hitmp=int32#13,<lotmp=int32#14,<lou4=int32#3,<twopower=int32#12
# asm 2: umlal <hitmp=r12,<lotmp=r14,<lou4=r2,<twopower=r11
umlal r12,r14,r2,r11

# qhasm: lotmp ^= (lou4 unsigned>> 6)
# asm 1: eor >lotmp=int32#12,<lotmp=int32#14,<lou4=int32#3,LSR #6
# asm 2: eor >lotmp=r11,<lotmp=r14,<lou4=r2,LSR #6
eor r11,r14,r2,LSR #6
...
# qhasm: lotmp ^= (lou4 << 3)
# asm 1: eor >lotmp=int32#12,<lotmp=int32#12,<lou4=int32#3,LSL #3
# asm 2: eor >lotmp=r11,<lotmp=r11,<lou4=r2,LSL #3
eor r11,r11,r2,LSL #3

# qhasm: hitmp ^= (hiu4 unsigned>> 6)
# asm 1: eor >hitmp=int32#13,<hitmp=int32#13,<hiu4=int32#2,LSR #6
# asm 2: eor >hitmp=r12,<hitmp=r12,<hiu4=r1,LSR #6
eor r12,r12,r1,LSR #6

# qhasm: hitmp ^= (lou4 unsigned>> 29)
# asm 1: eor >hitmp=int32#3,<hitmp=int32#13,<lou4=int32#3,LSR #29
# asm 2: eor >hitmp=r2,<hitmp=r12,<lou4=r2,LSR #29
eor r2,r12,r2,LSR #29

# qhasm: hitmp ^= (hiu4 << 3)
# asm 1: eor >hitmp=int32#2,<hitmp=int32#3,<hiu4=int32#2,LSL #3
# asm 2: eor >hitmp=r1,<hitmp=r2,<hiu4=r1,LSL #3
eor r1,r2,r1,LSL #3

# qhasm: carry? lou1 += lotmp
# asm 1: adds >lou1=int32#3,<lou1=int32#10,<lotmp=int32#12
# asm 2: adds >lou1=r2,<lou1=r9,<lotmp=r11
adds r2,r9,r11
...
# qhasm: carry? lou1 += lotmp
# asm 1: adds >lou1=int32#3,<lou1=int32#3,<lotmp=int32#12
# asm 2: adds >lou1=r2,<lou1=r2,<lotmp=r11
adds r2,r2,r11
...
# qhasm: carry? lou1 += lou5
# asm 1: adds >lou1=int32#3,<lou1=int32#3,<lou5=int32#12
# asm 2: adds >lou1=r2,<lou1=r2,<lou5=r11
# copy-collector output starts
ldrd r11,r12,[sp,#116]
# copy-collector output ends
adds r2,r2,r11
...
# qhasm: lom12 = lou1
# asm 1: str <lou1=int32#3,>lom12=stack32#28
# asm 2: str <lou1=r2,>lom12=[sp,#108]
# copy-collector input: str r2,[sp,#108]
...
# qhasm: hitmp lotmp = hiu0 * twopower
# asm 1: umull >lotmp=int32#14,>hitmp=int32#13,<hiu0=int32#4,<twopower=int32#12
# asm 2: umull >lotmp=r14,>hitmp=r12,<hiu0=r3,<twopower=r11
umull r14,r12,r3,r11

# qhasm: lotmp hitmp += lou0 * twopower
# asm 1: umlal <hitmp=int32#13,<lotmp=int32#14,<lou0=int32#5,<twopower=int32#12
# asm 2: umlal <hitmp=r12,<lotmp=r14,<lou0=r4,<twopower=r11
umlal r12,r14,r4,r11

# qhasm: lotmp ^= (lou0 unsigned>> 6)
# asm 1: eor >lotmp=int32#12,<lotmp=int32#14,<lou0=int32#5,LSR #6
# asm 2: eor >lotmp=r11,<lotmp=r14,<lou0=r4,LSR #6
eor r11,r14,r4,LSR #6
...
# qhasm: lotmp ^= (lou0 << 3)
# asm 1: eor >lotmp=int32#12,<lotmp=int32#12,<lou0=int32#5,LSL #3
# asm 2: eor >lotmp=r11,<lotmp=r11,<lou0=r4,LSL #3
eor r11,r11,r4,LSL #3
...
# qhasm: hitmp ^= (lou0 unsigned>> 29)
# asm 1: eor >hitmp=int32#5,<hitmp=int32#13,<lou0=int32#5,LSR #29
# asm 2: eor >hitmp=r4,<hitmp=r12,<lou0=r4,LSR #29
eor r4,r12,r4,LSR #29

# qhasm: hitmp ^= (hiu0 << 3)
# asm 1: eor >hitmp=int32#4,<hitmp=int32#5,<hiu0=int32#4,LSL #3
# asm 2: eor >hitmp=r3,<hitmp=r4,<hiu0=r3,LSL #3
eor r3,r4,r3,LSL #3

# qhasm: carry? lou4 += lotmp
# asm 1: adds >lou4=int32#5,<lou4=int32#10,<lotmp=int32#12
# asm 2: adds >lou4=r4,<lou4=r9,<lotmp=r11
adds r4,r9,r11

# qhasm: hiu4 += hitmp + carry
# asm 1: adc >hiu4=int32#4,<hiu4=int32#11,<hitmp=int32#4
# asm 2: adc >hiu4=r3,<hiu4=r10,<hitmp=r3
adc r3,r10,r3

# qhasm: lou0 = lod14
# asm 1: vmov >lou0=int32#10,<lod14=float32#29
# asm 2: vmov >lou0=r9,<lod14=s28
# copy-collector input: vmov r9,s28
...
# qhasm: carry? lou4 += lotmp
# asm 1: adds >lou4=int32#5,<lou4=int32#5,<lotmp=int32#12
# asm 2: adds >lou4=r4,<lou4=r4,<lotmp=r11
adds r4,r4,r11

# qhasm: hiu4 += hitmp + carry
# asm 1: adc >hiu4=int32#4,<hiu4=int32#4,<hitmp=int32#13
# asm 2: adc >hiu4=r3,<hiu4=r3,<hitmp=r12
adc r3,r3,r12

# qhasm: carry? lou4 += lou2
# asm 1: adds >lou4=int32#5,<lou4=int32#5,<lou2=int32#6
# asm 2: adds >lou4=r4,<lou4=r4,<lou2=r5
adds.w r4,r4,r5

# qhasm: hiu4 += hiu2 + carry
# asm 1: adc >hiu4=int32#4,<hiu4=int32#4,<hiu2=int32#7
# asm 2: adc >hiu4=r3,<hiu4=r3,<hiu2=r6
adc r3,r3,r6

# qhasm: lom13 = lou4
# asm 1: str <lou4=int32#5,>lom13=stack32#30
# asm 2: str <lou4=r4,>lom13=[sp,#116]
# copy-collector input: str r4,[sp,#116]

# qhasm: him13 = hiu4
# asm 1: str <hiu4=int32#4,>him13=stack32#31
# asm 2: str <hiu4=r3,>him13=[sp,#120]
# copy-collector input: str r3,[sp,#120]

# qhasm: twopower = 0x2000 simple
# asm 1: mov >twopower=int32#6,0x2000
# asm 2: mov >twopower=r5,0x2000
# copy-collector output starts
strd r4,r3,[sp,#116]
# copy-collector output ends
mov r5,0x2000
...
# qhasm: hitmp lotmp = hiu1 * twopower
# asm 1: umull >lotmp=int32#12,>hitmp=int32#7,<hiu1=int32#2,<twopower=int32#6
# asm 2: umull >lotmp=r11,>hitmp=r6,<hiu1=r1,<twopower=r5
umull r11,r6,r1,r5

# qhasm: lotmp hitmp += lou1 * twopower
# asm 1: umlal <hitmp=int32#7,<lotmp=int32#12,<lou1=int32#3,<twopower=int32#6
# asm 2: umlal <hitmp=r6,<lotmp=r11,<lou1=r2,<twopower=r5
umlal r6,r11,r2,r5

# qhasm: lotmp ^= (lou1 unsigned>> 6)
# asm 1: eor >lotmp=int32#6,<lotmp=int32#12,<lou1=int32#3,LSR #6
# asm 2: eor >lotmp=r5,<lotmp=r11,<lou1=r2,LSR #6
eor r5,r11,r2,LSR #6

# qhasm: lotmp ^= (hiu1 << 26)
# asm 1: eor >lotmp=int32#6,<lotmp=int32#6,<hiu1=int32#2,LSL #26
# asm 2: eor >lotmp=r5,<lotmp=r5,<hiu1=r1,LSL #26
eor r5,r5,r1,LSL #26

# qhasm: lotmp ^= (hiu1 unsigned>> 29)
# asm 1: eor >lotmp=int32#6,<lotmp=int32#6,<hiu1=int32#2,LSR #29
# asm 2: eor >lotmp=r5,<lotmp=r5,<hiu1=r1,LSR #29
eor r5,r5,r1,LSR #29

# qhasm: lotmp ^= (lou1 << 3)
# asm 1: eor >lotmp=int32#6,<lotmp=int32#6,<lou1=int32#3,LSL #3
# asm 2: eor >lotmp=r5,<lotmp=r5,<lou1=r2,LSL #3
eor r5,r5,r2,LSL #3

# qhasm: hitmp ^= (hiu1 unsigned>> 6)
# asm 1: eor >hitmp=int32#7,<hitmp=int32#7,<hiu1=int32#2,LSR #6
# asm 2: eor >hitmp=r6,<hitmp=r6,<hiu1=r1,LSR #6
eor r6,r6,r1,LSR #6

# qhasm: hitmp ^= (lou1 unsigned>> 29)
# asm 1: eor >hitmp=int32#3,<hitmp=int32#7,<lou1=int32#3,LSR #29
# asm 2: eor >hitmp=r2,<hitmp=r6,<lou1=r2,LSR #29
eor r2,r6,r2,LSR #29

# qhasm: hitmp ^= (hiu1 << 3)
# asm 1: eor >hitmp=int32#2,<hitmp=int32#3,<hiu1=int32#2,LSL #3
# asm 2: eor >hitmp=r1,<hitmp=r2,<hiu1=r1,LSL #3
eor r1,r2,r1,LSL #3

# qhasm: carry? lou0 += lotmp
# asm 1: adds >lou0=int32#3,<lou0=int32#10,<lotmp=int32#6
# asm 2: adds >lou0=r2,<lou0=r9,<lotmp=r5
adds r2,r9,r5
...
# qhasm: lou1 = lod15
# asm 1: vmov >lou1=int32#6,<lod15=float32#31
# asm 2: vmov >lou1=r5,<lod15=s30
# copy-collector input: vmov r5,s30
...
# qhasm: hitmp lotmp = hiu1 * twopower
# asm 1: umull >lotmp=int32#12,>hitmp=int32#11,<hiu1=int32#7,<twopower=int32#10
# asm 2: umull >lotmp=r11,>hitmp=r10,<hiu1=r6,<twopower=r9
umull r11,r10,r6,r9

# qhasm: lotmp hitmp += lou1 * twopower
# asm 1: umlal <hitmp=int32#11,<lotmp=int32#12,<lou1=int32#6,<twopower=int32#10
# asm 2: umlal <hitmp=r10,<lotmp=r11,<lou1=r5,<twopower=r9
umlal r10,r11,r5,r9

# qhasm: carry? lotmp ^= (lou1 unsigned>> 1)
# asm 1: eors >lotmp=int32#10,<lotmp=int32#12,<lou1=int32#6,LSR #1
# asm 2: eors >lotmp=r9,<lotmp=r11,<lou1=r5,LSR #1
eors r9,r11,r5,LSR #1

# qhasm: hitmp ^= (carry,hiu1 unsigned>> 1)
# asm 1: eors >hitmp=int32#11,<hitmp=int32#11,<hiu1=int32#7,RRX
# asm 2: eors >hitmp=r10,<hitmp=r10,<hiu1=r6,RRX
eors r10,r10,r6,RRX
...
# qhasm: lotmp ^= (lou1 unsigned>>7)
# asm 1: eor >lotmp=int32#10,<lotmp=int32#10,<lou1=int32#6,LSR #7
# asm 2: eor >lotmp=r9,<lotmp=r9,<lou1=r5,LSR #7
eor r9,r9,r5,LSR #7
...
# qhasm: carry? lou0 += lotmp
# asm 1: adds >lou0=int32#3,<lou0=int32#3,<lotmp=int32#10
# asm 2: adds >lou0=r2,<lou0=r2,<lotmp=r9
adds r2,r2,r9
...
# qhasm: carry? lou0 += lou3
# asm 1: adds >lou0=int32#3,<lou0=int32#3,<lou3=int32#8
# asm 2: adds >lou0=r2,<lou0=r2,<lou3=r7
adds.w r2,r2,r7
...
# qhasm: lom14 = lou0
# asm 1: str <lou0=int32#3,>lom14=stack32#32
# asm 2: str <lou0=r2,>lom14=[sp,#124]
# copy-collector input: str r2,[sp,#124]
...
# qhasm: twopower = 0x2000 simple
# asm 1: mov >twopower=int32#2,0x2000
# asm 2: mov >twopower=r1,0x2000
# copy-collector output starts
strd r2,r1,[sp,#124]
# copy-collector output ends
mov r1,0x2000
...
# qhasm: hitmp lotmp = hiu4 * twopower
# asm 1: umull >lotmp=int32#8,>hitmp=int32#3,<hiu4=int32#4,<twopower=int32#2
# asm 2: umull >lotmp=r7,>hitmp=r2,<hiu4=r3,<twopower=r1
umull r7,r2,r3,r1

# qhasm: lotmp hitmp += lou4 * twopower
# asm 1: umlal <hitmp=int32#3,<lotmp=int32#8,<lou4=int32#5,<twopower=int32#2
# asm 2: umlal <hitmp=r2,<lotmp=r7,<lou4=r4,<twopower=r1
umlal r2,r7,r4,r1

# qhasm: lotmp ^= (lou4 unsigned>> 6)
# asm 1: eor >lotmp=int32#2,<lotmp=int32#8,<lou4=int32#5,LSR #6
# asm 2: eor >lotmp=r1,<lotmp=r7,<lou4=r4,LSR #6
eor r1,r7,r4,LSR #6

# qhasm: lotmp ^= (hiu4 << 26)
# asm 1: eor >lotmp=int32#2,<lotmp=int32#2,<hiu4=int32#4,LSL #26
# asm 2: eor >lotmp=r1,<lotmp=r1,<hiu4=r3,LSL #26
eor r1,r1,r3,LSL #26

# qhasm: lotmp ^= (hiu4 unsigned>> 29)
# asm 1: eor >lotmp=int32#2,<lotmp=int32#2,<hiu4=int32#4,LSR #29
# asm 2: eor >lotmp=r1,<lotmp=r1,<hiu4=r3,LSR #29
eor r1,r1,r3,LSR #29

# qhasm: lotmp ^= (lou4 << 3)
# asm 1: eor >lotmp=int32#2,<lotmp=int32#2,<lou4=int32#5,LSL #3
# asm 2: eor >lotmp=r1,<lotmp=r1,<lou4=r4,LSL #3
eor r1,r1,r4,LSL #3

# qhasm: hitmp ^= (hiu4 unsigned>> 6)
# asm 1: eor >hitmp=int32#3,<hitmp=int32#3,<hiu4=int32#4,LSR #6
# asm 2: eor >hitmp=r2,<hitmp=r2,<hiu4=r3,LSR #6
eor r2,r2,r3,LSR #6

# qhasm: hitmp ^= (lou4 unsigned>> 29)
# asm 1: eor >hitmp=int32#3,<hitmp=int32#3,<lou4=int32#5,LSR #29
# asm 2: eor >hitmp=r2,<hitmp=r2,<lou4=r4,LSR #29
eor r2,r2,r4,LSR #29

# qhasm: hitmp ^= (hiu4 << 3)
# asm 1: eor >hitmp=int32#3,<hitmp=int32#3,<hiu4=int32#4,LSL #3
# asm 2: eor >hitmp=r2,<hitmp=r2,<hiu4=r3,LSL #3
eor r2,r2,r3,LSL #3

# qhasm: carry? lou1 += lotmp
# asm 1: adds >lou1=int32#2,<lou1=int32#6,<lotmp=int32#2
# asm 2: adds >lou1=r1,<lou1=r5,<lotmp=r1
adds r1,r5,r1
...
# qhasm: twopower = 0x1000000 simple
# asm 1: mov >twopower=int32#8,0x1000000
# asm 2: mov >twopower=r7,0x1000000
# copy-collector output starts
ldr r3,[sp,#76]
ldr r4,[sp,#80]
ldr r5,[sp,#132]
...
# qhasm: hitmp lotmp = hiu0 * twopower
# asm 1: umull >lotmp=int32#10,>hitmp=int32#9,<hiu0=int32#5,<twopower=int32#8
# asm 2: umull >lotmp=r9,>hitmp=r8,<hiu0=r4,<twopower=r7
umull r9,r8,r4,r7

# qhasm: lotmp hitmp += lou0 * twopower
# asm 1: umlal <hitmp=int32#9,<lotmp=int32#10,<lou0=int32#4,<twopower=int32#8
# asm 2: umlal <hitmp=r8,<lotmp=r9,<lou0=r3,<twopower=r7
umlal r8,r9,r3,r7

# qhasm: carry? lotmp ^= (lou0 unsigned>> 1)
# asm 1: eors >lotmp=int32#8,<lotmp=int32#10,<lou0=int32#4,LSR #1
# asm 2: eors >lotmp=r7,<lotmp=r9,<lou0=r3,LSR #1
eors r7,r9,r3,LSR #1

# qhasm: hitmp ^= (carry,hiu0 unsigned>> 1)
# asm 1: eors >hitmp=int32#9,<hitmp=int32#9,<hiu0=int32#5,RRX
# asm 2: eors >hitmp=r8,<hitmp=r8,<hiu0=r4,RRX
eors r8,r8,r4,RRX
