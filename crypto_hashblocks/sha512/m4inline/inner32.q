...
hiu4 += hitmp + carry
# asm 1: lotmp = (hi<r4=int64#2 unsigned>> 9)
# asm 2: lotmp = (hi<r4=u1 unsigned>> 9)
lotmp = (hiu1 unsigned>> 9)
# asm 1: lotmp ^= (lo<r4=int64#2 << 23)
# asm 2: lotmp ^= (lo<r4=u1 << 23)
lotmp ^= (lou1 << 23)
...
# asm 2: carry? lo<r7=u4 += lotmp
carry? lou4 += lotmp
# asm 1: hitmp = (lo<r4=int64#2 unsigned>> 9)
# asm 2: hitmp = (lo<r4=u1 unsigned>> 9)
hitmp = (lou1 unsigned>> 9)
# asm 1: hitmp ^= (hi<r4=int64#2 << 23)
# asm 2: hitmp ^= (hi<r4=u1 << 23)
hitmp ^= (hiu1 << 23)
...
# asm 1: lotmp = (hi<r0=int64#2 unsigned>> 7)
# asm 2: lotmp = (hi<r0=u1 unsigned>> 7)
lotmp = (hiu1 unsigned>> 7)
# asm 1: lotmp ^= (lo<r0=int64#2 << 25)
# asm 2: lotmp ^= (lo<r0=u1 << 25)
lotmp ^= (lou1 << 25)
...
# asm 2: carry? lo<r7=u4 += lotmp
carry? lou4 += lotmp
# asm 1: hitmp = (lo<r0=int64#2 unsigned>> 7)
# asm 2: hitmp = (lo<r0=u1 unsigned>> 7)
hitmp = (lou1 unsigned>> 7)
# asm 1: hitmp ^= (hi<r0=int64#2 << 25)
# asm 2: hitmp ^= (hi<r0=u1 << 25)
hitmp ^= (hiu1 << 25)
...
hiu4 += hitmp + carry
# asm 1: lotmp = (hi<r3=int64#1 unsigned>> 9)
# asm 2: lotmp = (hi<r3=u0 unsigned>> 9)
lotmp = (hiu0 unsigned>> 9)
# asm 1: lotmp ^= (lo<r3=int64#1 << 23)
# asm 2: lotmp ^= (lo<r3=u0 << 23)
lotmp ^= (lou0 << 23)
...
# asm 2: carry? lo<r6=u4 += lotmp
carry? lou4 += lotmp
# asm 1: hitmp = (lo<r3=int64#1 unsigned>> 9)
# asm 2: hitmp = (lo<r3=u0 unsigned>> 9)
hitmp = (lou0 unsigned>> 9)
# asm 1: hitmp ^= (hi<r3=int64#1 << 23)
# asm 2: hitmp ^= (hi<r3=u0 << 23)
hitmp ^= (hiu0 << 23)
...
# asm 1: lotmp = (hi<r7=int64#1 unsigned>> 7)
# asm 2: lotmp = (hi<r7=u0 unsigned>> 7)
lotmp = (hiu0 unsigned>> 7)
# asm 1: lotmp ^= (lo<r7=int64#1 << 25)
# asm 2: lotmp ^= (lo<r7=u0 << 25)
lotmp ^= (lou0 << 25)
...
# asm 2: carry? lo<r6=u4 += lotmp
carry? lou4 += lotmp
# asm 1: hitmp = (lo<r7=int64#1 unsigned>> 7)
# asm 2: hitmp = (lo<r7=u0 unsigned>> 7)
hitmp = (lou0 unsigned>> 7)
# asm 1: hitmp ^= (hi<r7=int64#1 << 25)
# asm 2: hitmp ^= (hi<r7=u0 << 25)
hitmp ^= (hiu0 << 25)
...
hiu4 += hitmp + carry
# asm 1: lotmp = (hi<r2=int64#4 unsigned>> 9)
# asm 2: lotmp = (hi<r2=u3 unsigned>> 9)
lotmp = (hiu3 unsigned>> 9)
# asm 1: lotmp ^= (lo<r2=int64#4 << 23)
# asm 2: lotmp ^= (lo<r2=u3 << 23)
lotmp ^= (lou3 << 23)
...
# asm 2: carry? lo<r5=u4 += lotmp
carry? lou4 += lotmp
# asm 1: hitmp = (lo<r2=int64#4 unsigned>> 9)
# asm 2: hitmp = (lo<r2=u3 unsigned>> 9)
hitmp = (lou3 unsigned>> 9)
# asm 1: hitmp ^= (hi<r2=int64#4 << 23)
# asm 2: hitmp ^= (hi<r2=u3 << 23)
hitmp ^= (hiu3 << 23)
...
# asm 1: lotmp = (hi<r6=int64#1 unsigned>> 7)
# asm 2: lotmp = (hi<r6=u0 unsigned>> 7)
lotmp = (hiu0 unsigned>> 7)
# asm 1: lotmp ^= (lo<r6=int64#1 << 25)
# asm 2: lotmp ^= (lo<r6=u0 << 25)
lotmp ^= (lou0 << 25)
...
# asm 2: carry? lo<r5=u4 += lotmp
carry? lou4 += lotmp
# asm 1: hitmp = (lo<r6=int64#1 unsigned>> 7)
# asm 2: hitmp = (lo<r6=u0 unsigned>> 7)
hitmp = (lou0 unsigned>> 7)
# asm 1: hitmp ^= (hi<r6=int64#1 << 25)
# asm 2: hitmp ^= (hi<r6=u0 << 25)
hitmp ^= (hiu0 << 25)
...
hiu4 += hitmp + carry
# asm 1: lotmp = (hi<r1=int64#3 unsigned>> 9)
# asm 2: lotmp = (hi<r1=u2 unsigned>> 9)
lotmp = (hiu2 unsigned>> 9)
# asm 1: lotmp ^= (lo<r1=int64#3 << 23)
# asm 2: lotmp ^= (lo<r1=u2 << 23)
lotmp ^= (lou2 << 23)
...
# asm 2: carry? lo<r4=u4 += lotmp
carry? lou4 += lotmp
# asm 1: hitmp = (lo<r1=int64#3 unsigned>> 9)
# asm 2: hitmp = (lo<r1=u2 unsigned>> 9)
hitmp = (lou2 unsigned>> 9)
# asm 1: hitmp ^= (hi<r1=int64#3 << 23)
# asm 2: hitmp ^= (hi<r1=u2 << 23)
hitmp ^= (hiu2 << 23)
...
# asm 1: lotmp = (hi<r5=int64#1 unsigned>> 7)
# asm 2: lotmp = (hi<r5=u0 unsigned>> 7)
lotmp = (hiu0 unsigned>> 7)
# asm 1: lotmp ^= (lo<r5=int64#1 << 25)
# asm 2: lotmp ^= (lo<r5=u0 << 25)
lotmp ^= (lou0 << 25)
...
# asm 2: carry? lo<r4=u4 += lotmp
carry? lou4 += lotmp
# asm 1: hitmp = (lo<r5=int64#1 unsigned>> 7)
# asm 2: hitmp = (lo<r5=u0 unsigned>> 7)
hitmp = (lou0 unsigned>> 7)
# asm 1: hitmp ^= (hi<r5=int64#1 << 25)
# asm 2: hitmp ^= (hi<r5=u0 << 25)
hitmp ^= (hiu0 << 25)
...
hiu4 += hitmp + carry
# asm 1: lotmp = (hi<r0=int64#4 unsigned>> 9)
# asm 2: lotmp = (hi<r0=u3 unsigned>> 9)
lotmp = (hiu3 unsigned>> 9)
# asm 1: lotmp ^= (lo<r0=int64#4 << 23)
# asm 2: lotmp ^= (lo<r0=u3 << 23)
lotmp ^= (lou3 << 23)
...
# asm 2: carry? lo<r3=u4 += lotmp
carry? lou4 += lotmp
# asm 1: hitmp = (lo<r0=int64#4 unsigned>> 9)
# asm 2: hitmp = (lo<r0=u3 unsigned>> 9)
hitmp = (lou3 unsigned>> 9)
# asm 1: hitmp ^= (hi<r0=int64#4 << 23)
# asm 2: hitmp ^= (hi<r0=u3 << 23)
hitmp ^= (hiu3 << 23)
...
# asm 1: lotmp = (hi<r4=int64#1 unsigned>> 7)
# asm 2: lotmp = (hi<r4=u0 unsigned>> 7)
lotmp = (hiu0 unsigned>> 7)
# asm 1: lotmp ^= (lo<r4=int64#1 << 25)
# asm 2: lotmp ^= (lo<r4=u0 << 25)
lotmp ^= (lou0 << 25)
...
# asm 2: carry? lo<r3=u4 += lotmp
carry? lou4 += lotmp
# asm 1: hitmp = (lo<r4=int64#1 unsigned>> 7)
# asm 2: hitmp = (lo<r4=u0 unsigned>> 7)
hitmp = (lou0 unsigned>> 7)
# asm 1: hitmp ^= (hi<r4=int64#1 << 25)
# asm 2: hitmp ^= (hi<r4=u0 << 25)
hitmp ^= (hiu0 << 25)
...
hiu4 += hitmp + carry
# asm 1: lotmp = (hi<r7=int64#3 unsigned>> 9)
# asm 2: lotmp = (hi<r7=u2 unsigned>> 9)
lotmp = (hiu2 unsigned>> 9)
# asm 1: lotmp ^= (lo<r7=int64#3 << 23)
# asm 2: lotmp ^= (lo<r7=u2 << 23)
lotmp ^= (lou2 << 23)
...
# asm 2: carry? lo<r2=u4 += lotmp
carry? lou4 += lotmp
# asm 1: hitmp = (lo<r7=int64#3 unsigned>> 9)
# asm 2: hitmp = (lo<r7=u2 unsigned>> 9)
hitmp = (lou2 unsigned>> 9)
# asm 1: hitmp ^= (hi<r7=int64#3 << 23)
# asm 2: hitmp ^= (hi<r7=u2 << 23)
hitmp ^= (hiu2 << 23)
...
# asm 1: lotmp = (hi<r3=int64#1 unsigned>> 7)
# asm 2: lotmp = (hi<r3=u0 unsigned>> 7)
lotmp = (hiu0 unsigned>> 7)
# asm 1: lotmp ^= (lo<r3=int64#1 << 25)
# asm 2: lotmp ^= (lo<r3=u0 << 25)
lotmp ^= (lou0 << 25)
...
# asm 2: carry? lo<r2=u4 += lotmp
carry? lou4 += lotmp
# asm 1: hitmp = (lo<r3=int64#1 unsigned>> 7)
# asm 2: hitmp = (lo<r3=u0 unsigned>> 7)
hitmp = (lou0 unsigned>> 7)
# asm 1: hitmp ^= (hi<r3=int64#1 << 25)
# asm 2: hitmp ^= (hi<r3=u0 << 25)
hitmp ^= (hiu0 << 25)
...
hiu4 += hitmp + carry
# asm 1: lotmp = (hi<r6=int64#4 unsigned>> 9)
# asm 2: lotmp = (hi<r6=u3 unsigned>> 9)
lotmp = (hiu3 unsigned>> 9)
# asm 1: lotmp ^= (lo<r6=int64#4 << 23)
# asm 2: lotmp ^= (lo<r6=u3 << 23)
lotmp ^= (lou3 << 23)
...
# asm 2: carry? lo<r1=u4 += lotmp
carry? lou4 += lotmp
# asm 1: hitmp = (lo<r6=int64#4 unsigned>> 9)
# asm 2: hitmp = (lo<r6=u3 unsigned>> 9)
hitmp = (lou3 unsigned>> 9)
# asm 1: hitmp ^= (hi<r6=int64#4 << 23)
# asm 2: hitmp ^= (hi<r6=u3 << 23)
hitmp ^= (hiu3 << 23)
...
# asm 1: lotmp = (hi<r2=int64#1 unsigned>> 7)
# asm 2: lotmp = (hi<r2=u0 unsigned>> 7)
lotmp = (hiu0 unsigned>> 7)
# asm 1: lotmp ^= (lo<r2=int64#1 << 25)
# asm 2: lotmp ^= (lo<r2=u0 << 25)
lotmp ^= (lou0 << 25)
...
# asm 2: carry? lo<r1=u4 += lotmp
carry? lou4 += lotmp
# asm 1: hitmp = (lo<r2=int64#1 unsigned>> 7)
# asm 2: hitmp = (lo<r2=u0 unsigned>> 7)
hitmp = (lou0 unsigned>> 7)
# asm 1: hitmp ^= (hi<r2=int64#1 << 25)
# asm 2: hitmp ^= (hi<r2=u0 << 25)
hitmp ^= (hiu0 << 25)
...
hiu4 += hitmp + carry
# asm 1: lotmp = (hi<r5=int64#3 unsigned>> 9)
# asm 2: lotmp = (hi<r5=u2 unsigned>> 9)
lotmp = (hiu2 unsigned>> 9)
# asm 1: lotmp ^= (lo<r5=int64#3 << 23)
# asm 2: lotmp ^= (lo<r5=u2 << 23)
lotmp ^= (lou2 << 23)
...
# asm 2: carry? lo<r0=u4 += lotmp
carry? lou4 += lotmp
# asm 1: hitmp = (lo<r5=int64#3 unsigned>> 9)
# asm 2: hitmp = (lo<r5=u2 unsigned>> 9)
hitmp = (lou2 unsigned>> 9)
# asm 1: hitmp ^= (hi<r5=int64#3 << 23)
# asm 2: hitmp ^= (hi<r5=u2 << 23)
hitmp ^= (hiu2 << 23)
...
# asm 1: lotmp = (hi<r1=int64#1 unsigned>> 7)
# asm 2: lotmp = (hi<r1=u0 unsigned>> 7)
lotmp = (hiu0 unsigned>> 7)
# asm 1: lotmp ^= (lo<r1=int64#1 << 25)
# asm 2: lotmp ^= (lo<r1=u0 << 25)
lotmp ^= (lou0 << 25)
...
# asm 2: carry? lo<r0=u4 += lotmp
carry? lou4 += lotmp
# asm 1: hitmp = (lo<r1=int64#1 unsigned>> 7)
# asm 2: hitmp = (lo<r1=u0 unsigned>> 7)
hitmp = (lou0 unsigned>> 7)
# asm 1: hitmp ^= (hi<r1=int64#1 << 25)
# asm 2: hitmp ^= (hi<r1=u0 << 25)
hitmp ^= (hiu0 << 25)
...
lotmp ^= (hiu2 << 26)
# asm 1: lotmp ^= (lo<w6=int64#3 unsigned>> 19)
# asm 2: lotmp ^= (lo<w6=u2 unsigned>> 19)
lotmp ^= (lou2 unsigned>> 19)
# asm 1: lotmp ^= (hi<w6=int64#3 << 13)
# asm 2: lotmp ^= (hi<w6=u2 << 13)
lotmp ^= (hiu2 << 13)
...
# asm 1: hitmp ^= (hi<w6=int64#3 unsigned>> 19)
# asm 2: hitmp ^= (hi<w6=u2 unsigned>> 19)
hitmp ^= (hiu2 unsigned>> 19)
# asm 1: hitmp ^= (lo<w6=int64#3 << 13)
# asm 2: hitmp ^= (lo<w6=u2 << 13)
hitmp ^= (lou2 << 13)
...
# asm 1: lotmp ^= (lo<w9=int64#2 unsigned>>8)
# asm 2: lotmp ^= (lo<w9=u1 unsigned>>8)
lotmp ^= (lou1 unsigned>>8)
# asm 1: lotmp ^= (hi<w9=int64#2 << 24)
# asm 2: lotmp ^= (hi<w9=u1 << 24)
lotmp ^= (hiu1 << 24)
# asm 1: hitmp ^= (hi<w9=int64#2 unsigned>>8)
# asm 2: hitmp ^= (hi<w9=u1 unsigned>>8)
hitmp ^= (hiu1 unsigned>>8)
# asm 1: hitmp ^= (lo<w9=int64#2 << 24)
# asm 2: hitmp ^= (lo<w9=u1 << 24)
hitmp ^= (lou1 << 24)
# asm 1: carry? lo<w8=int64#1 += lotmp
# asm 2: carry? lo<w8=u0 += lotmp
carry? lou0 += lotmp
...
lotmp ^= (hiu3 << 26)
# asm 1: lotmp ^= (lo<w7=int64#4 unsigned>> 19)
# asm 2: lotmp ^= (lo<w7=u3 unsigned>> 19)
lotmp ^= (lou3 unsigned>> 19)
# asm 1: lotmp ^= (hi<w7=int64#4 << 13)
# asm 2: lotmp ^= (hi<w7=u3 << 13)
lotmp ^= (hiu3 << 13)
...
# asm 1: hitmp ^= (hi<w7=int64#4 unsigned>> 19)
# asm 2: hitmp ^= (hi<w7=u3 unsigned>> 19)
hitmp ^= (hiu3 unsigned>> 19)
# asm 1: hitmp ^= (lo<w7=int64#4 << 13)
# asm 2: hitmp ^= (lo<w7=u3 << 13)
hitmp ^= (lou3 << 13)
...
# asm 1: lotmp ^= (lo<w10=int64#5 unsigned>>8)
# asm 2: lotmp ^= (lo<w10=u4 unsigned>>8)
lotmp ^= (lou4 unsigned>>8)
# asm 1: lotmp ^= (hi<w10=int64#5 << 24)
# asm 2: lotmp ^= (hi<w10=u4 << 24)
lotmp ^= (hiu4 << 24)
# asm 1: hitmp ^= (hi<w10=int64#5 unsigned>>8)
# asm 2: hitmp ^= (hi<w10=u4 unsigned>>8)
hitmp ^= (hiu4 unsigned>>8)
# asm 1: hitmp ^= (lo<w10=int64#5 << 24)
# asm 2: hitmp ^= (lo<w10=u4 << 24)
hitmp ^= (lou4 << 24)
# asm 1: carry? lo<w9=int64#2 += lotmp
# asm 2: carry? lo<w9=u1 += lotmp
carry? lou1 += lotmp
...
lotmp ^= (hiu0 << 26)
# asm 1: lotmp ^= (lo<w8=int64#1 unsigned>> 19)
# asm 2: lotmp ^= (lo<w8=u0 unsigned>> 19)
lotmp ^= (lou0 unsigned>> 19)
# asm 1: lotmp ^= (hi<w8=int64#1 << 13)
# asm 2: lotmp ^= (hi<w8=u0 << 13)
lotmp ^= (hiu0 << 13)
...
# asm 1: hitmp ^= (hi<w8=int64#1 unsigned>> 19)
# asm 2: hitmp ^= (hi<w8=u0 unsigned>> 19)
hitmp ^= (hiu0 unsigned>> 19)
# asm 1: hitmp ^= (lo<w8=int64#1 << 13)
# asm 2: hitmp ^= (lo<w8=u0 << 13)
hitmp ^= (lou0 << 13)
...
# asm 1: lotmp ^= (lo<w11=int64#1 unsigned>>8)
# asm 2: lotmp ^= (lo<w11=u0 unsigned>>8)
lotmp ^= (lou0 unsigned>>8)
# asm 1: lotmp ^= (hi<w11=int64#1 << 24)
# asm 2: lotmp ^= (hi<w11=u0 << 24)
lotmp ^= (hiu0 << 24)
# asm 1: hitmp ^= (hi<w11=int64#1 unsigned>>8)
# asm 2: hitmp ^= (hi<w11=u0 unsigned>>8)
hitmp ^= (hiu0 unsigned>>8)
# asm 1: hitmp ^= (lo<w11=int64#1 << 24)
# asm 2: hitmp ^= (lo<w11=u0 << 24)
hitmp ^= (lou0 << 24)
# asm 1: carry? lo<w10=int64#5 += lotmp
# asm 2: carry? lo<w10=u4 += lotmp
carry? lou4 += lotmp
...
lotmp ^= (hiu1 << 26)
# asm 1: lotmp ^= (lo<w9=int64#2 unsigned>> 19)
# asm 2: lotmp ^= (lo<w9=u1 unsigned>> 19)
lotmp ^= (lou1 unsigned>> 19)
# asm 1: lotmp ^= (hi<w9=int64#2 << 13)
# asm 2: lotmp ^= (hi<w9=u1 << 13)
lotmp ^= (hiu1 << 13)
...
# asm 1: hitmp ^= (hi<w9=int64#2 unsigned>> 19)
# asm 2: hitmp ^= (hi<w9=u1 unsigned>> 19)
hitmp ^= (hiu1 unsigned>> 19)
# asm 1: hitmp ^= (lo<w9=int64#2 << 13)
# asm 2: hitmp ^= (lo<w9=u1 << 13)
hitmp ^= (lou1 << 13)
...
hitmp ^= (hiu1 unsigned>>7)
# asm 1: lotmp ^= (lo<w12=int64#2 unsigned>>8)
# asm 2: lotmp ^= (lo<w12=u1 unsigned>>8)
lotmp ^= (lou1 unsigned>>8)
# asm 1: lotmp ^= (hi<w12=int64#2 << 24)
# asm 2: lotmp ^= (hi<w12=u1 << 24)
lotmp ^= (hiu1 << 24)
# asm 1: hitmp ^= (hi<w12=int64#2 unsigned>>8)
# asm 2: hitmp ^= (hi<w12=u1 unsigned>>8)
hitmp ^= (hiu1 unsigned>>8)
# asm 1: hitmp ^= (lo<w12=int64#2 << 24)
# asm 2: hitmp ^= (lo<w12=u1 << 24)
hitmp ^= (lou1 << 24)
# asm 1: carry? lo<w11=int64#1 += lotmp
# asm 2: carry? lo<w11=u0 += lotmp
carry? lou0 += lotmp
...
lotmp ^= (hiu4 << 26)
# asm 1: lotmp ^= (lo<w10=int64#5 unsigned>> 19)
# asm 2: lotmp ^= (lo<w10=u4 unsigned>> 19)
lotmp ^= (lou4 unsigned>> 19)
# asm 1: lotmp ^= (hi<w10=int64#5 << 13)
# asm 2: lotmp ^= (hi<w10=u4 << 13)
lotmp ^= (hiu4 << 13)
...
# asm 1: hitmp ^= (hi<w10=int64#5 unsigned>> 19)
# asm 2: hitmp ^= (hi<w10=u4 unsigned>> 19)
hitmp ^= (hiu4 unsigned>> 19)
# asm 1: hitmp ^= (lo<w10=int64#5 << 13)
# asm 2: hitmp ^= (lo<w10=u4 << 13)
hitmp ^= (lou4 << 13)
...
hitmp ^= (hiu4 unsigned>>7)
# asm 1: lotmp ^= (lo<w13=int64#5 unsigned>>8)
# asm 2: lotmp ^= (lo<w13=u4 unsigned>>8)
lotmp ^= (lou4 unsigned>>8)
# asm 1: lotmp ^= (hi<w13=int64#5 << 24)
# asm 2: lotmp ^= (hi<w13=u4 << 24)
lotmp ^= (hiu4 << 24)
# asm 1: hitmp ^= (hi<w13=int64#5 unsigned>>8)
# asm 2: hitmp ^= (hi<w13=u4 unsigned>>8)
hitmp ^= (hiu4 unsigned>>8)
# asm 1: hitmp ^= (lo<w13=int64#5 << 24)
# asm 2: hitmp ^= (lo<w13=u4 << 24)
hitmp ^= (lou4 << 24)
# asm 1: carry? lo<w12=int64#2 += lotmp
# asm 2: carry? lo<w12=u1 += lotmp
carry? lou1 += lotmp
...
lotmp ^= (hiu0 << 26)
# asm 1: lotmp ^= (lo<w11=int64#1 unsigned>> 19)
# asm 2: lotmp ^= (lo<w11=u0 unsigned>> 19)
lotmp ^= (lou0 unsigned>> 19)
# asm 1: lotmp ^= (hi<w11=int64#1 << 13)
# asm 2: lotmp ^= (hi<w11=u0 << 13)
lotmp ^= (hiu0 << 13)
...
hitmp = (hiu0 unsigned>> 6)
# asm 1: hitmp ^= (hi<w11=int64#1 unsigned>> 19)
# asm 2: hitmp ^= (hi<w11=u0 unsigned>> 19)
hitmp ^= (hiu0 unsigned>> 19)
# asm 1: hitmp ^= (lo<w11=int64#1 << 13)
# asm 2: hitmp ^= (lo<w11=u0 << 13)
hitmp ^= (lou0 << 13)
...
hitmp ^= (hiu0 unsigned>>7)
# asm 1: lotmp ^= (lo<w14=int64#1 unsigned>>8)
# asm 2: lotmp ^= (lo<w14=u0 unsigned>>8)
lotmp ^= (lou0 unsigned>>8)
# asm 1: lotmp ^= (hi<w14=int64#1 << 24)
# asm 2: lotmp ^= (hi<w14=u0 << 24)
lotmp ^= (hiu0 << 24)
# asm 1: hitmp ^= (hi<w14=int64#1 unsigned>>8)
# asm 2: hitmp ^= (hi<w14=u0 unsigned>>8)
hitmp ^= (hiu0 unsigned>>8)
# asm 1: hitmp ^= (lo<w14=int64#1 << 24)
# asm 2: hitmp ^= (lo<w14=u0 << 24)
hitmp ^= (lou0 << 24)
# asm 1: carry? lo<w13=int64#5 += lotmp
# asm 2: carry? lo<w13=u4 += lotmp
carry? lou4 += lotmp
...
lotmp ^= (hiu1 << 26)
# asm 1: lotmp ^= (lo<w12=int64#2 unsigned>> 19)
# asm 2: lotmp ^= (lo<w12=u1 unsigned>> 19)
lotmp ^= (lou1 unsigned>> 19)
# asm 1: lotmp ^= (hi<w12=int64#2 << 13)
# asm 2: lotmp ^= (hi<w12=u1 << 13)
lotmp ^= (hiu1 << 13)
...
hitmp = (hiu1 unsigned>> 6)
# asm 1: hitmp ^= (hi<w12=int64#2 unsigned>> 19)
# asm 2: hitmp ^= (hi<w12=u1 unsigned>> 19)
hitmp ^= (hiu1 unsigned>> 19)
# asm 1: hitmp ^= (lo<w12=int64#2 << 13)
# asm 2: hitmp ^= (lo<w12=u1 << 13)
hitmp ^= (lou1 << 13)
...
hitmp ^= (hiu1 unsigned>>7)
# asm 1: lotmp ^= (lo<w15=int64#2 unsigned>>8)
# asm 2: lotmp ^= (lo<w15=u1 unsigned>>8)
lotmp ^= (lou1 unsigned>>8)
# asm 1: lotmp ^= (hi<w15=int64#2 << 24)
# asm 2: lotmp ^= (hi<w15=u1 << 24)
lotmp ^= (hiu1 << 24)
# asm 1: hitmp ^= (hi<w15=int64#2 unsigned>>8)
# asm 2: hitmp ^= (hi<w15=u1 unsigned>>8)
hitmp ^= (hiu1 unsigned>>8)
# asm 1: hitmp ^= (lo<w15=int64#2 << 24)
# asm 2: hitmp ^= (lo<w15=u1 << 24)
hitmp ^= (lou1 << 24)
# asm 1: carry? lo<w14=int64#1 += lotmp
# asm 2: carry? lo<w14=u0 += lotmp
carry? lou0 += lotmp
...
lotmp ^= (hiu4 << 26)
# asm 1: lotmp ^= (lo<w13=int64#5 unsigned>> 19)
# asm 2: lotmp ^= (lo<w13=u4 unsigned>> 19)
lotmp ^= (lou4 unsigned>> 19)
# asm 1: lotmp ^= (hi<w13=int64#5 << 13)
# asm 2: lotmp ^= (hi<w13=u4 << 13)
lotmp ^= (hiu4 << 13)
...
hitmp = (hiu4 unsigned>> 6)
# asm 1: hitmp ^= (hi<w13=int64#5 unsigned>> 19)
# asm 2: hitmp ^= (hi<w13=u4 unsigned>> 19)
hitmp ^= (hiu4 unsigned>> 19)
# asm 1: hitmp ^= (lo<w13=int64#5 << 13)
# asm 2: hitmp ^= (lo<w13=u4 << 13)
hitmp ^= (lou4 << 13)
...
hitmp ^= (hiu0 unsigned>>7)
# asm 1: lotmp ^= (lo<w0=int64#1 unsigned>>8)
# asm 2: lotmp ^= (lo<w0=u0 unsigned>>8)
lotmp ^= (lou0 unsigned>>8)
# asm 1: lotmp ^= (hi<w0=int64#1 << 24)
# asm 2: lotmp ^= (hi<w0=u0 << 24)
lotmp ^= (hiu0 << 24)
# asm 1: hitmp ^= (hi<w0=int64#1 unsigned>>8)
# asm 2: hitmp ^= (hi<w0=u0 unsigned>>8)
hitmp ^= (hiu0 unsigned>>8)
# asm 1: hitmp ^= (lo<w0=int64#1 << 24)
# asm 2: hitmp ^= (lo<w0=u0 << 24)
hitmp ^= (lou0 << 24)
# asm 1: carry? lo<w15=int64#2 += lotmp
# asm 2: carry? lo<w15=u1 += lotmp
carry? lou1 += lotmp
