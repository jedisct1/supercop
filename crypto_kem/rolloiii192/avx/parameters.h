...
#define PARAM_N 59 /**< Parameter n of the scheme (code length) */
...
#define PARAM_DFR 36 /**< Decryption Failure Rate (2^-30) */
...
#define FFI_VEC_R_BYTES 107 //Number of bytes to store R elements of GF2^m
#define FFI_VEC_N_BYTES 790 //Number of bytes to store N elements of GF2^m
