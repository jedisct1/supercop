...
subq $6656, %rsp
mov $4, %ecx
karatsuba_loop_732db625b54edabc96c3436679039f3d:
mov %rsp, %r9
mov %rsp, %r10
subq $32, %rsp
vmovdqa 0(%rax), %ymm0
...
addq $32, %rsp
innerloop_732db625b54edabc96c3436679039f3d:
vmovdqa 0(%r9), %ymm0
...
neg %ecx
jns done_732db625b54edabc96c3436679039f3d
add $512, %r9
add $1024, %r10
jmp innerloop_732db625b54edabc96c3436679039f3d
done_732db625b54edabc96c3436679039f3d:
sub $512, %r9
sub $1024, %r10
vmovdqa 0(%r9), %ymm0
...
add $2048, %r12
dec %ecx
jnz karatsuba_loop_732db625b54edabc96c3436679039f3d
sub $8192, %r12
add $6656, %rsp
subq $2400, %rsp
