 ...
 **/
lima_params_t lima_sp_1018 = { LIMA_SP, &mod12521473, 1018, 11,  1561269,   8501297, 9597006, 10910567, &lima_fft_sp_1018 };
lima_params_t lima_sp_1306 = { LIMA_SP, &mod48181249, 1306, 12, 30019814,  39013233, 5599915, 28280508, &lima_fft_sp_1306 };
lima_params_t lima_sp_1822 = { LIMA_SP, &mod44802049, 1822, 12, 43213195,  19941338, 8284672,  1121361, &lima_fft_sp_1822 };
lima_params_t lima_sp_2062 = { LIMA_SP, &mod16900097, 2062, 13, 12381941,  15641966,  213248,  7202243, &lima_fft_sp_2062 };
