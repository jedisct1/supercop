	...
	.text
	.p2align 4
	.globl	crypto_kem_sntrup857_avx_crypto_encode_857x5167
	.type	crypto_kem_sntrup857_avx_crypto_encode_857x5167, @function
crypto_kem_sntrup857_avx_crypto_encode_857x5167:
.LFB5279:
	.cfi_startproc
	pushq	%rbp
...
.L31:
	...
	movl	$10, %eax
.L18:
	vmovdqu	-20(%r9,%rax,2), %ymm5
	leaq	(%rdx,%rax), %rdi
	vpsrld	$16, %ymm5, %ymm0
	vmovdqu	12(%r9,%rax,2), %ymm5
	vpmulld	%ymm6, %ymm0, %ymm0
	vpsrld	$16, %ymm5, %ymm1
	vpand	-20(%r9,%rax,2), %ymm3, %ymm5
	vpmulld	%ymm6, %ymm1, %ymm1
	vpaddd	%ymm5, %ymm0, %ymm0
	vpand	12(%r9,%rax,2), %ymm3, %ymm5
	vpshufb	%ymm2, %ymm0, %ymm0
	...
	movl	$33, %eax
.L19:
	vmovdqu	-132(%r9,%rax,4), %ymm5
	leaq	(%rdi,%rax), %rsi
	vpand	-132(%r9,%rax,4), %ymm3, %ymm1
	vpsrld	$16, %ymm5, %ymm0
	vpmulld	%ymm2, %ymm0, %ymm0
	vpaddd	%ymm1, %ymm0, %ymm0
	vpshufb	%ymm4, %ymm0, %ymm0
	vpermq	$216, %ymm0, %ymm0
	vmovups	%xmm0, -66(%r9,%rax,2)
	vextracti128	$0x1, %ymm0, %xmm0
	vmovd	%xmm0, (%rdi,%rax)
...
.L21:
	...
	.cfi_endproc
.LFE5279:
	.size	crypto_kem_sntrup857_avx_crypto_encode_857x5167, .-crypto_kem_sntrup857_avx_crypto_encode_857x5167
