#define update_asm crypto_kem_mceliece6960119f_sse_update_asm
#define _update_asm _crypto_kem_mceliece6960119f_sse_update_asm
#define vec_reduce_asm crypto_kem_mceliece6960119f_sse_vec_reduce_asm
#define _vec_reduce_asm _crypto_kem_mceliece6960119f_sse_vec_reduce_asm
/*
...
static inline void get_coefs(gf *out, vec128 *in)
{
	...
	for (i = 13; i < 16; i++) buf[i] = vec128_setzero();
