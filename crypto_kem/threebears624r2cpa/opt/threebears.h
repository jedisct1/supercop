...
void pqcrypto_kem_threebears624r2cpa_impl_priv_get_pubkey (
    uint8_t *pk, // pk[PQCRYPTO_KEM_THREEBEARS624R2CPA_IMPL_PRIV_PUBLIC_KEY_BYTES],
    const uint8_t *seed // seed[PQCRYPTO_KEM_THREEBEARS624R2CPA_IMPL_PRIV_PRIVATE_KEY_BYTES]
);
...
static inline void pqcrypto_kem_threebears624r2cpa_impl_priv_keygen (
    uint8_t *pk, // pk[PQCRYPTO_KEM_THREEBEARS624R2CPA_IMPL_PRIV_PUBLIC_KEY_BYTES],
    uint8_t *sk, // sk[PQCRYPTO_KEM_THREEBEARS624R2CPA_IMPL_PRIV_PRIVATE_KEY_BYTES],
    const uint8_t *seed // seed[PQCRYPTO_KEM_THREEBEARS624R2CPA_IMPL_PRIV_KEYGEN_SEED_BYTES]
) {
...
void pqcrypto_kem_threebears624r2cpa_impl_priv_encapsulate (
    uint8_t *shared_secret, // shared_secret[PQCRYPTO_KEM_THREEBEARS624R2CPA_IMPL_PRIV_SHARED_SECRET_BYTES],
    uint8_t *capsule, // capsule[PQCRYPTO_KEM_THREEBEARS624R2CPA_IMPL_PRIV_CAPSULE_BYTES],
    const uint8_t *pk, // pk[PQCRYPTO_KEM_THREEBEARS624R2CPA_IMPL_PRIV_PUBLIC_KEY_BYTES],
    const uint8_t *seed // seed[PQCRYPTO_KEM_THREEBEARS624R2CPA_IMPL_PRIV_ENC_SEED_AND_IV_BYTES]
);
...
void pqcrypto_kem_threebears624r2cpa_impl_priv_decapsulate ( 
    uint8_t *shared_secret, // shared_secret[PQCRYPTO_KEM_THREEBEARS624R2CPA_IMPL_PRIV_SHARED_SECRET_BYTES],
    const uint8_t *capsule, // capsule[PQCRYPTO_KEM_THREEBEARS624R2CPA_IMPL_PRIV_CAPSULE_BYTES],
    const uint8_t *sk // sk[PQCRYPTO_KEM_THREEBEARS624R2CPA_IMPL_PRIV_PRIVATE_KEY_BYTES]
);
