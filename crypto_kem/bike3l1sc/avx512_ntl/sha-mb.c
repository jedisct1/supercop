                           ...
                           IN const uint32_t len)
{
    ...
    {
        digest[i].qw[0] = bswap_64(ctx->A[i]);
        digest[i].qw[1] = bswap_64(ctx->B[i]);
        digest[i].qw[2] = bswap_64(ctx->C[i]);
        digest[i].qw[3] = bswap_64(ctx->D[i]);
        digest[i].qw[4] = bswap_64(ctx->E[i]);
        digest[i].qw[5] = bswap_64(ctx->F[i]);
#ifndef SHA384
        digest[i].qw[6] = bswap_64(ctx->G[i]);
        digest[i].qw[7] = bswap_64(ctx->H[i]);
#endif
    }
}
