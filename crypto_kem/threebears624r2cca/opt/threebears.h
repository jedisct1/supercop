#include "namespace.h"
/** Public header */
#ifndef __THREE_BEARS_THREEBEARS624R2CCA_H__
#define __THREE_BEARS_THREEBEARS624R2CCA_H__

#include <stdint.h>
#include <stddef.h> /* for size_t */
#include <string.h> /* for memcpy */

#define PQCRYPTO_KEM_THREEBEARS624R2CCA_IMPL_PRIV_KEYGEN_SEED_BYTES 40
#define PQCRYPTO_KEM_THREEBEARS624R2CCA_IMPL_PRIV_PRIVATE_KEY_BYTES PQCRYPTO_KEM_THREEBEARS624R2CCA_IMPL_PRIV_KEYGEN_SEED_BYTES
#define PQCRYPTO_KEM_THREEBEARS624R2CCA_IMPL_PRIV_SHARED_SECRET_BYTES 32
#define PQCRYPTO_KEM_THREEBEARS624R2CCA_IMPL_PRIV_ENC_SEED_AND_IV_BYTES 32
#define PQCRYPTO_KEM_THREEBEARS624R2CCA_IMPL_PRIV_PUBLIC_KEY_BYTES 804
#define PQCRYPTO_KEM_THREEBEARS624R2CCA_IMPL_PRIV_CAPSULE_BYTES 917
...
#endif /*__THREE_BEARS_THREEBEARS624R2CCA_H__*/
