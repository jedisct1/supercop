...
#define PARAM_N 151 /**< Parameter n of the scheme (code length) */
...
#define FFI_VEC_R_BYTES 81 //Number of bytes to store R elements of GF2^m
#define FFI_VEC_N_BYTES 2020 //Number of bytes to store N elements of GF2^m
