...
#define encapsulate pqcrypto_kem_BabyBearEphem_impl_priv_encapsulate
#define decapsulate pqcrypto_kem_BabyBearEphem_impl_priv_decapsulate
#define get_pubkey  pqcrypto_kem_BabyBearEphem_impl_priv_get_pubkey
