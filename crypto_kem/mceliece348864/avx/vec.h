#ifndef VEC_H
#define VEC_H
#define vec_GF_mul crypto_kem_mceliece348864_avx_vec_GF_mul
#define vec_mul_asm crypto_kem_mceliece348864_avx_vec_mul_asm
#define vec_mul_sp_asm crypto_kem_mceliece348864_avx_vec_mul_sp_asm
