...
#define SECRET_KEY_BYTES                    	crypto_kem_SECRETKEYBYTES
#define PUBLIC_KEY_BYTES                    	crypto_kem_PUBLICKEYBYTES
#define SHARED_SECRET_BYTES                 	crypto_kem_BYTES
#define CIPHERTEXT_BYTES                    	crypto_kem_CIPHERTEXTBYTES
