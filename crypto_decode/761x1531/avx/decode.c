...
void crypto_decode(void *v,const unsigned char *s)
{
  ...
  a1 += *--s; /* -1738...1992 */
  a1 += 3475&crypto_int16_negative_mask(a1); /* 0...3474 */
  R10[0] = a1;
  ...
  a0 += s[1*i+0]; /* -297...566 */
  a0 += 593&crypto_int16_negative_mask(a0); /* 0...592 */
  a1 = (a2<<8)+s[i]-a0;
  a1 = mullo(a1,-31055);

  /* invalid inputs might need reduction mod 1500 */
  a1 -= 1500;
  a1 += 1500&crypto_int16_negative_mask(a1);
  ...
  for (i = 0;i >= 0;--i) {
    ...
    a0 += 6232&crypto_int16_negative_mask(a0); /* 0...6231 */
    a1 = (a2<<13)+(s[2*i+1]<<5)+((s[2*i]-a0)>>3);
    a1 = mullo(a1,12451);

    /* invalid inputs might need reduction mod 6232 */
    a1 -= 6232;
    a1 += 6232&crypto_int16_negative_mask(a1);
  ...
  a0 += s[1*i+0]; /* -751...886 */
  a0 += 1263&crypto_int16_negative_mask(a0); /* 0...1262 */
  a1 = (a2<<8)+s[i]-a0;
  a1 = mullo(a1,-22001);

  /* invalid inputs might need reduction mod 304 */
  a1 -= 304;
  a1 += 304&crypto_int16_negative_mask(a1);
  ...
  for (i = 1;i >= 0;--i) {
    ...
    a1 -= 1263;
    a1 += 1263&crypto_int16_negative_mask(a1);
  ...
  a0 += 9097&crypto_int16_negative_mask(a0); /* 0...9096 */
  a1 = (s[2*i+1]<<8)+s[2*i]-a0;
  a1 = mullo(a1,17081);

  /* invalid inputs might need reduction mod 2188 */
  a1 -= 2188;
  a1 += 2188&crypto_int16_negative_mask(a1);
  ...
  for (i = 4;i >= 0;--i) {
    ...
    a1 -= 9097;
    a1 += 9097&crypto_int16_negative_mask(a1);
  ...
  a0 += s[1*i+0]; /* -763...1111 */
  a0 += 1526&crypto_int16_negative_mask(a0); /* 0...1525 */
  a1 = (a2<<7)+((s[i]-a0)>>1);
  a1 = mullo(a1,-18381);

  /* invalid inputs might need reduction mod 367 */
  a1 -= 367;
  a1 += 367&crypto_int16_negative_mask(a1);
  ...
  for (i = 10;i >= 0;--i) {
    ...
    a1 -= 1526;
    a1 += 1526&crypto_int16_negative_mask(a1);
  ...
  a0 += s[1*i+0]; /* -384...567 */
  a0 += 625&crypto_int16_negative_mask(a0); /* 0...624 */
  a1 = (a2<<8)+s[i]-a0;
  a1 = mullo(a1,32401);

  /* invalid inputs might need reduction mod 150 */
  a1 -= 150;
  a1 += 150&crypto_int16_negative_mask(a1);
  ...
  a0 += 6400&crypto_int16_negative_mask(a0); /* 0...6399 */
  a1 = (a2<<8)+s[2*i+1]+((s[2*i]-a0)>>8);
  a1 = mullo(a1,23593);

  /* invalid inputs might need reduction mod 1531 */
  a1 -= 1531;
  a1 += 1531&crypto_int16_negative_mask(a1);
