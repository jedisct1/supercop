...
void crypto_decode(void *v,const unsigned char *s)
{
  ...
  a1 += *--s; /* 0...255 */
  a1 -= 160; /* -160...95 */
  a1 += 160&crypto_int16_negative_mask(a1); /* 0...159 */
  R10[0] = a1;
  ...
  a0 += s[2*i+0]; /* -374...629 */
  a0 += 743&crypto_int16_negative_mask(a0); /* 0...742 */
  a1 = (s[2*i+1]<<8)+s[2*i]-a0;
  a1 = mullo(a1,-3881);

  /* invalid inputs might need reduction mod 14044 */
  a1 -= 14044;
  a1 += 14044&crypto_int16_negative_mask(a1);
  ...
  a0 += s[1*i+0]; /* -234...473 */
  a0 -= 436; /* -670..>37 */
  a0 += 436&crypto_int16_negative_mask(a0); /* -234...435 */
  a0 += 436&crypto_int16_negative_mask(a0); /* 0...435 */
  a1 = (a2<<6)+((s[i]-a0)>>2);
  a1 = mullo(a1,2405);

  /* invalid inputs might need reduction mod 8246 */
  a1 -= 8246;
  a1 += 8246&crypto_int16_negative_mask(a1);
  ...
  for (i = 0;i >= 0;--i) {
    ...
    a1 -= 436;
    a1 += 436&crypto_int16_negative_mask(a1);
  ...
  for (i = 2;i >= 0;--i) {
    ...
    a0 += s[1*i+0]; /* -167...437 */
    a0 -= 334; /* -501..>103 */
    a0 += 334&crypto_int16_negative_mask(a0); /* -167...333 */
    a0 += 334&crypto_int16_negative_mask(a0); /* 0...333 */
    a1 = (a2<<7)+((s[i]-a0)>>1);
    a1 = mullo(a1,-22761);

    /* invalid inputs might need reduction mod 334 */
    a1 -= 334;
    a1 += 334&crypto_int16_negative_mask(a1);
  ...
  a0 += s[1*i+0]; /* -146...417 */
  a0 -= 292; /* -438..>125 */
  a0 += 292&crypto_int16_negative_mask(a0); /* -146...291 */
  a0 += 292&crypto_int16_negative_mask(a0); /* 0...291 */
  a1 = (a2<<6)+((s[i]-a0)>>2);
  a1 = mullo(a1,-3591);

  /* invalid inputs might need reduction mod 7229 */
  a1 -= 7229;
  a1 += 7229&crypto_int16_negative_mask(a1);
  ...
  for (i = 5;i >= 0;--i) {
    ...
    a1 -= 292;
    a1 += 292&crypto_int16_negative_mask(a1);
  ...
  for (i = 12;i >= 0;--i) {
    ...
    a0 += s[1*i+0]; /* -137...391 */
    a0 -= 273; /* -410..>118 */
    a0 += 273&crypto_int16_negative_mask(a0); /* -137...272 */
    a0 += 273&crypto_int16_negative_mask(a0); /* 0...272 */
    a1 = (a2<<8)+s[i]-a0;
    a1 = mullo(a1,4081);

    /* invalid inputs might need reduction mod 273 */
    a1 -= 273;
    a1 += 273&crypto_int16_negative_mask(a1);
  ...
  a0 += 4225&crypto_int16_negative_mask(a0); /* 0...4224 */
  a1 = (a2<<8)+s[i]-a0;
  a1 = mullo(a1,12161);

  /* invalid inputs might need reduction mod 438 */
  a1 -= 438;
  a1 += 438&crypto_int16_negative_mask(a1);
  ...
  a0 += 65&crypto_int16_negative_mask(a0); /* 0...64 */
  a1 = (a2<<8)+s[i]-a0;
  a1 = mullo(a1,4033);

  /* invalid inputs might need reduction mod 1723 */
  a1 -= 1723;
  a1 += 1723&crypto_int16_negative_mask(a1);
