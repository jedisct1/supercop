...
void crypto_decode(void *v,const unsigned char *s)
{
  ...
  a1 -= 86; /* -86...169 */
  a1 -= 86; /* -172...83 */
  a1 += 86&crypto_int16_negative_mask(a1); /* -86...85 */
  a1 += 86&crypto_int16_negative_mask(a1); /* 0...85 */
  R10[0] = a1;
  ...
  a0 += s[2*i+0]; /* -421...677 */
  a0 += 835&crypto_int16_negative_mask(a0); /* 0...834 */
  a1 = (s[2*i+1]<<8)+s[2*i]-a0;
  a1 = mullo(a1,8555);

  /* invalid inputs might need reduction mod 6708 */
  a1 -= 6708;
  a1 += 6708&crypto_int16_negative_mask(a1);
  ...
  for (i = 0;i >= 0;--i) {
    ...
    a0 += 7396&crypto_int16_negative_mask(a0); /* 0...7395 */
    a1 = (a2<<14)+(s[2*i+1]<<6)+((s[2*i]-a0)>>2);
    a1 = mullo(a1,-18679);

    /* invalid inputs might need reduction mod 7396 */
    a1 -= 7396;
    a1 += 7396&crypto_int16_negative_mask(a1);
  ...
  a0 += 86&crypto_int16_negative_mask(a0); /* 0...85 */
  a1 = (a2-a0)>>1;
  a1 = mullo(a1,-16765);

  /* invalid inputs might need reduction mod 78 */
  a1 -= 78;
  a1 += 78&crypto_int16_negative_mask(a1);
  ...
  for (i = 1;i >= 0;--i) {
    ...
    a1 -= 86;
    a1 += 86&crypto_int16_negative_mask(a1);
  ...
  for (i = 4;i >= 0;--i) {
    ...
    a0 += 2370&crypto_int16_negative_mask(a0); /* 0...2369 */
    a1 = (a2<<15)+(s[2*i+1]<<7)+((s[2*i]-a0)>>1);
    a1 = mullo(a1,-8351);

    /* invalid inputs might need reduction mod 2370 */
    a1 -= 2370;
    a1 += 2370&crypto_int16_negative_mask(a1);
  ...
  for (i = 9;i >= 0;--i) {
    ...
    a0 += 12461&crypto_int16_negative_mask(a0); /* 0...12460 */
    a1 = (s[2*i+1]<<8)+s[2*i]-a0;
    a1 = mullo(a1,-19675);

    /* invalid inputs might need reduction mod 12461 */
    a1 -= 12461;
    a1 += 12461&crypto_int16_negative_mask(a1);
  ...
  a0 += s[2*i+0]; /* -340...595 */
  a0 += 676&crypto_int16_negative_mask(a0); /* 0...675 */
  a1 = (a2<<14)+(s[2*i+1]<<6)+((s[2*i]-a0)>>2);
  a1 = mullo(a1,-23655);

  /* invalid inputs might need reduction mod 7510 */
  a1 -= 7510;
  a1 += 7510&crypto_int16_negative_mask(a1);
  ...
  a0 += s[1*i+0]; /* -224...463 */
  a0 -= 416; /* -640..>47 */
  a0 += 416&crypto_int16_negative_mask(a0); /* -224...415 */
  a0 += 416&crypto_int16_negative_mask(a0); /* 0...415 */
  a1 = (a2<<3)+((s[i]-a0)>>5);
  a1 = mullo(a1,20165);

  /* invalid inputs might need reduction mod 4621 */
  a1 -= 4621;
  a1 += 4621&crypto_int16_negative_mask(a1);
