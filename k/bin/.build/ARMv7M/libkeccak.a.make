all: ARMv7M/libkeccak.a
ARMv7M/libkeccak.a: bin/ARMv7M/libkeccak.a
ARMv7M/libkeccak.a.pack: bin/ARMv7M_libkeccak.a.tar.gz

BINDIR = bin/.build/ARMv7M/libkeccak.a
$(BINDIR):
	mkdir -p $(BINDIR)
...
HEADERS := $(HEADERS) Ketje/Ket/OptimizedAsmARM/Ket-common.h
SOURCES := $(SOURCES) Ketje/Ket/OptimizedAsmARM/Ket-common.h
CFLAGS := $(CFLAGS) -IKetje/Ket/OptimizedAsmARM/

HEADERS := $(HEADERS) Ketje/Ket/OptimizedAsmARM/KetJr.h
SOURCES := $(SOURCES) Ketje/Ket/OptimizedAsmARM/KetJr.h
CFLAGS := $(CFLAGS) -IKetje/Ket/OptimizedAsmARM/

HEADERS := $(HEADERS) Ketje/Ket/OptimizedAsmARM/KetSr.h
SOURCES := $(SOURCES) Ketje/Ket/OptimizedAsmARM/KetSr.h
CFLAGS := $(CFLAGS) -IKetje/Ket/OptimizedAsmARM/
...
SOURCES := $(SOURCES) SnP/KeccakP-200/OptimizedAsmARM/KeccakP-200-armv7m-le-gcc.s
$(BINDIR)/KeccakP-200-armv7m-le-gcc.o: SnP/KeccakP-200/OptimizedAsmARM/KeccakP-200-armv7m-le-gcc.s $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KeccakP-200-armv7m-le-gcc.o

SOURCES := $(SOURCES) SnP/KeccakP-400/OptimizedAsmARM/KeccakP-400-armv7m-le-gcc.s
$(BINDIR)/KeccakP-400-armv7m-le-gcc.o: SnP/KeccakP-400/OptimizedAsmARM/KeccakP-400-armv7m-le-gcc.s $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KeccakP-400-armv7m-le-gcc.o
...
SOURCES := $(SOURCES) SnP/KeccakP-1600/Optimized32biAsmARM/KeccakP-1600-inplace-32bi-armv7m-le-gcc.s
$(BINDIR)/KeccakP-1600-inplace-32bi-armv7m-le-gcc.o: SnP/KeccakP-1600/Optimized32biAsmARM/KeccakP-1600-inplace-32bi-armv7m-le-gcc.s $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KeccakP-1600-inplace-32bi-armv7m-le-gcc.o
...
SOURCES := $(SOURCES) Ketje/Ket/OptimizedAsmARM/KetjeJr-armv7m-le-gcc.s
$(BINDIR)/KetjeJr-armv7m-le-gcc.o: Ketje/Ket/OptimizedAsmARM/KetjeJr-armv7m-le-gcc.s $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KetjeJr-armv7m-le-gcc.o

SOURCES := $(SOURCES) Ketje/Ket/OptimizedAsmARM/KetjeSr-armv7m-le-gcc.s
$(BINDIR)/KetjeSr-armv7m-le-gcc.o: Ketje/Ket/OptimizedAsmARM/KetjeSr-armv7m-le-gcc.s $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KetjeSr-armv7m-le-gcc.o
...
bin/ARMv7M/libkeccak.a: $(BINDIR) $(OBJECTS)
	mkdir -p $(dir $@)
	mkdir -p $@.headers
	cp -f $(HEADERS) $@.headers/
	$(AR) rcsv $@ $(OBJECTS)
bin/ARMv7M_libkeccak.a.tar.gz: $(SOURCES)
	mkdir -p bin/.pack/ARMv7M/libkeccak.a
	rm -rf bin/.pack/ARMv7M/libkeccak.a/*
	cp $(SOURCES) bin/.pack/ARMv7M/libkeccak.a/
	cd bin/.pack/ ; tar -czf ../../bin/ARMv7M_libkeccak.a.tar.gz ARMv7M/libkeccak.a/*
