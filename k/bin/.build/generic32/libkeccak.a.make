all: generic32/libkeccak.a
generic32/libkeccak.a: bin/generic32/libkeccak.a
generic32/libkeccak.a.pack: bin/generic32_libkeccak.a.tar.gz

BINDIR = bin/.build/generic32/libkeccak.a
$(BINDIR):
	mkdir -p $(BINDIR)
...
HEADERS := $(HEADERS) SnP/KeccakP-800/Optimized32/u2/KeccakP-800-opt32-config.h
SOURCES := $(SOURCES) SnP/KeccakP-800/Optimized32/u2/KeccakP-800-opt32-config.h
CFLAGS := $(CFLAGS) -ISnP/KeccakP-800/Optimized32/u2/
...
bin/generic32/libkeccak.a: $(BINDIR) $(OBJECTS)
	mkdir -p $(dir $@)
	mkdir -p $@.headers
	cp -f $(HEADERS) $@.headers/
	$(AR) rcsv $@ $(OBJECTS)
bin/generic32_libkeccak.a.tar.gz: $(SOURCES)
	mkdir -p bin/.pack/generic32/libkeccak.a
	rm -rf bin/.pack/generic32/libkeccak.a/*
	cp $(SOURCES) bin/.pack/generic32/libkeccak.a/
	cd bin/.pack/ ; tar -czf ../../bin/generic32_libkeccak.a.tar.gz generic32/libkeccak.a/*
