all: reference32bits/libkeccak.a
reference32bits/libkeccak.a: bin/reference32bits/libkeccak.a
reference32bits/libkeccak.a.pack: bin/reference32bits_libkeccak.a.tar.gz

BINDIR = bin/.build/reference32bits/libkeccak.a
$(BINDIR):
	mkdir -p $(BINDIR)
...
CFLAGS := $(CFLAGS) -DKeccakReference32BI
...
HEADERS := $(HEADERS) SnP/KeccakP-800/Reference/KeccakP-800-reference.h
SOURCES := $(SOURCES) SnP/KeccakP-800/Reference/KeccakP-800-reference.h
CFLAGS := $(CFLAGS) -ISnP/KeccakP-800/Reference/

HEADERS := $(HEADERS) SnP/KeccakP-800/Reference/KeccakP-800-SnP.h
SOURCES := $(SOURCES) SnP/KeccakP-800/Reference/KeccakP-800-SnP.h
CFLAGS := $(CFLAGS) -ISnP/KeccakP-800/Reference/

HEADERS := $(HEADERS) SnP/KeccakP-1600/Reference32BI/KeccakP-1600-reference.h
SOURCES := $(SOURCES) SnP/KeccakP-1600/Reference32BI/KeccakP-1600-reference.h
CFLAGS := $(CFLAGS) -ISnP/KeccakP-1600/Reference32BI/

HEADERS := $(HEADERS) SnP/KeccakP-1600/Reference32BI/KeccakP-1600-SnP.h
SOURCES := $(SOURCES) SnP/KeccakP-1600/Reference32BI/KeccakP-1600-SnP.h
CFLAGS := $(CFLAGS) -ISnP/KeccakP-1600/Reference32BI/
...
SOURCES := $(SOURCES) SnP/KeccakP-800/Reference/KeccakP-800-reference.c
$(BINDIR)/KeccakP-800-reference.o: SnP/KeccakP-800/Reference/KeccakP-800-reference.c $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KeccakP-800-reference.o

SOURCES := $(SOURCES) SnP/KeccakP-1600/Reference32BI/KeccakP-1600-reference32BI.c
$(BINDIR)/KeccakP-1600-reference32BI.o: SnP/KeccakP-1600/Reference32BI/KeccakP-1600-reference32BI.c $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KeccakP-1600-reference32BI.o
...
bin/reference32bits/libkeccak.a: $(BINDIR) $(OBJECTS)
	mkdir -p $(dir $@)
	mkdir -p $@.headers
	cp -f $(HEADERS) $@.headers/
	$(AR) rcsv $@ $(OBJECTS)
bin/reference32bits_libkeccak.a.tar.gz: $(SOURCES)
	mkdir -p bin/.pack/reference32bits/libkeccak.a
	rm -rf bin/.pack/reference32bits/libkeccak.a/*
	cp $(SOURCES) bin/.pack/reference32bits/libkeccak.a/
	cd bin/.pack/ ; tar -czf ../../bin/reference32bits_libkeccak.a.tar.gz reference32bits/libkeccak.a/*
