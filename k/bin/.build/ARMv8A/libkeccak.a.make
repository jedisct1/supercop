all: ARMv8A/libkeccak.a
ARMv8A/libkeccak.a: bin/ARMv8A/libkeccak.a
ARMv8A/libkeccak.a.pack: bin/ARMv8A_libkeccak.a.tar.gz

BINDIR = bin/.build/ARMv8A/libkeccak.a
$(BINDIR):
	mkdir -p $(BINDIR)
...
HEADERS := $(HEADERS) SnP/KeccakP-800/Optimized64AsmARM/KeccakP-800-SnP.h
SOURCES := $(SOURCES) SnP/KeccakP-800/Optimized64AsmARM/KeccakP-800-SnP.h
CFLAGS := $(CFLAGS) -ISnP/KeccakP-800/Optimized64AsmARM/

HEADERS := $(HEADERS) SnP/KeccakP-1600/Optimized64AsmARM/KeccakP-1600-SnP.h
SOURCES := $(SOURCES) SnP/KeccakP-1600/Optimized64AsmARM/KeccakP-1600-SnP.h
CFLAGS := $(CFLAGS) -ISnP/KeccakP-1600/Optimized64AsmARM/
...
SOURCES := $(SOURCES) SnP/KeccakP-800/Optimized64AsmARM/KeccakP-800-armv8a-neon.s
$(BINDIR)/KeccakP-800-armv8a-neon.o: SnP/KeccakP-800/Optimized64AsmARM/KeccakP-800-armv8a-neon.s $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KeccakP-800-armv8a-neon.o

SOURCES := $(SOURCES) SnP/KeccakP-1600/Optimized64AsmARM/KeccakP-1600-armv8a-neon.s
$(BINDIR)/KeccakP-1600-armv8a-neon.o: SnP/KeccakP-1600/Optimized64AsmARM/KeccakP-1600-armv8a-neon.s $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KeccakP-1600-armv8a-neon.o
...
bin/ARMv8A/libkeccak.a: $(BINDIR) $(OBJECTS)
	mkdir -p $(dir $@)
	mkdir -p $@.headers
	cp -f $(HEADERS) $@.headers/
	$(AR) rcsv $@ $(OBJECTS)
bin/ARMv8A_libkeccak.a.tar.gz: $(SOURCES)
	mkdir -p bin/.pack/ARMv8A/libkeccak.a
	rm -rf bin/.pack/ARMv8A/libkeccak.a/*
	cp $(SOURCES) bin/.pack/ARMv8A/libkeccak.a/
	cd bin/.pack/ ; tar -czf ../../bin/ARMv8A_libkeccak.a.tar.gz ARMv8A/libkeccak.a/*
