all: SandyBridge/libkeccak.a
SandyBridge/libkeccak.a: bin/SandyBridge/libkeccak.a
SandyBridge/libkeccak.a.pack: bin/SandyBridge_libkeccak.a.tar.gz

BINDIR = bin/.build/SandyBridge/libkeccak.a
$(BINDIR):
	mkdir -p $(BINDIR)
...
HEADERS := $(HEADERS) SnP/KeccakP-1600/Optimized64/LCufullshld/KeccakP-1600-opt64-config.h
SOURCES := $(SOURCES) SnP/KeccakP-1600/Optimized64/LCufullshld/KeccakP-1600-opt64-config.h
CFLAGS := $(CFLAGS) -ISnP/KeccakP-1600/Optimized64/LCufullshld/
...
HEADERS := $(HEADERS) PlSnP/KeccakP-1600-times2/SIMD128/SSE2ufull/SIMD128-config.h
SOURCES := $(SOURCES) PlSnP/KeccakP-1600-times2/SIMD128/SSE2ufull/SIMD128-config.h
CFLAGS := $(CFLAGS) -IPlSnP/KeccakP-1600-times2/SIMD128/SSE2ufull/
...
bin/SandyBridge/libkeccak.a: $(BINDIR) $(OBJECTS)
	mkdir -p $(dir $@)
	mkdir -p $@.headers
	cp -f $(HEADERS) $@.headers/
	$(AR) rcsv $@ $(OBJECTS)
bin/SandyBridge_libkeccak.a.tar.gz: $(SOURCES)
	mkdir -p bin/.pack/SandyBridge/libkeccak.a
	rm -rf bin/.pack/SandyBridge/libkeccak.a/*
	cp $(SOURCES) bin/.pack/SandyBridge/libkeccak.a/
	cd bin/.pack/ ; tar -czf ../../bin/SandyBridge_libkeccak.a.tar.gz SandyBridge/libkeccak.a/*
