all: generic32lc/libkeccak.a
generic32lc/libkeccak.a: bin/generic32lc/libkeccak.a
generic32lc/libkeccak.a.pack: bin/generic32lc_libkeccak.a.tar.gz

BINDIR = bin/.build/generic32lc/libkeccak.a
$(BINDIR):
	mkdir -p $(BINDIR)
...
bin/generic32lc/libkeccak.a: $(BINDIR) $(OBJECTS)
	mkdir -p $(dir $@)
	mkdir -p $@.headers
	cp -f $(HEADERS) $@.headers/
	$(AR) rcsv $@ $(OBJECTS)
bin/generic32lc_libkeccak.a.tar.gz: $(SOURCES)
	mkdir -p bin/.pack/generic32lc/libkeccak.a
	rm -rf bin/.pack/generic32lc/libkeccak.a/*
	cp $(SOURCES) bin/.pack/generic32lc/libkeccak.a/
	cd bin/.pack/ ; tar -czf ../../bin/generic32lc_libkeccak.a.tar.gz generic32lc/libkeccak.a/*
