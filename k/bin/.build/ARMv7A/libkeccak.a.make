all: ARMv7A/libkeccak.a
ARMv7A/libkeccak.a: bin/ARMv7A/libkeccak.a
ARMv7A/libkeccak.a.pack: bin/ARMv7A_libkeccak.a.tar.gz

BINDIR = bin/.build/ARMv7A/libkeccak.a
$(BINDIR):
	mkdir -p $(BINDIR)
...
HEADERS := $(HEADERS) SnP/KeccakP-1600/OptimizedAsmARM/KeccakP-1600-SnP.h
SOURCES := $(SOURCES) SnP/KeccakP-1600/OptimizedAsmARM/KeccakP-1600-SnP.h
CFLAGS := $(CFLAGS) -ISnP/KeccakP-1600/OptimizedAsmARM/
...
HEADERS := $(HEADERS) PlSnP/KeccakP-1600-times2/arm/KeccakP-1600-times2-SnP.h
SOURCES := $(SOURCES) PlSnP/KeccakP-1600-times2/arm/KeccakP-1600-times2-SnP.h
CFLAGS := $(CFLAGS) -IPlSnP/KeccakP-1600-times2/arm/

HEADERS := $(HEADERS) PlSnP/KeccakP-1600-times4/FallbackOn2/KeccakP-1600-times4-SnP.h
SOURCES := $(SOURCES) PlSnP/KeccakP-1600-times4/FallbackOn2/KeccakP-1600-times4-SnP.h
CFLAGS := $(CFLAGS) -IPlSnP/KeccakP-1600-times4/FallbackOn2/

HEADERS := $(HEADERS) PlSnP/Fallback/PlSnP-Fallback.inc
SOURCES := $(SOURCES) PlSnP/Fallback/PlSnP-Fallback.inc
CFLAGS := $(CFLAGS) -IPlSnP/Fallback/

HEADERS := $(HEADERS) PlSnP/KeccakP-1600-times8/FallbackOn2/KeccakP-1600-times8-SnP.h
SOURCES := $(SOURCES) PlSnP/KeccakP-1600-times8/FallbackOn2/KeccakP-1600-times8-SnP.h
CFLAGS := $(CFLAGS) -IPlSnP/KeccakP-1600-times8/FallbackOn2/
...
SOURCES := $(SOURCES) SnP/KeccakP-800/OptimizedAsmARM/KeccakP-800-u2-armv7a-le-gcc.s
$(BINDIR)/KeccakP-800-u2-armv7a-le-gcc.o: SnP/KeccakP-800/OptimizedAsmARM/KeccakP-800-u2-armv7a-le-gcc.s $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KeccakP-800-u2-armv7a-le-gcc.o

SOURCES := $(SOURCES) SnP/KeccakP-1600/OptimizedAsmARM/KeccakP-1600-armv7a-le-neon-gcc.s
$(BINDIR)/KeccakP-1600-armv7a-le-neon-gcc.o: SnP/KeccakP-1600/OptimizedAsmARM/KeccakP-1600-armv7a-le-neon-gcc.s $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KeccakP-1600-armv7a-le-neon-gcc.o
...
SOURCES := $(SOURCES) PlSnP/KeccakP-1600-times2/arm/KeccakP-1600-inplace-pl2-armv7a-neon-le-gcc.s
$(BINDIR)/KeccakP-1600-inplace-pl2-armv7a-neon-le-gcc.o: PlSnP/KeccakP-1600-times2/arm/KeccakP-1600-inplace-pl2-armv7a-neon-le-gcc.s $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KeccakP-1600-inplace-pl2-armv7a-neon-le-gcc.o

SOURCES := $(SOURCES) PlSnP/KeccakP-1600-times4/FallbackOn2/KeccakP-1600-times4-on2.c
$(BINDIR)/KeccakP-1600-times4-on2.o: PlSnP/KeccakP-1600-times4/FallbackOn2/KeccakP-1600-times4-on2.c $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KeccakP-1600-times4-on2.o

SOURCES := $(SOURCES) PlSnP/KeccakP-1600-times8/FallbackOn2/KeccakP-1600-times8-on2.c
$(BINDIR)/KeccakP-1600-times8-on2.o: PlSnP/KeccakP-1600-times8/FallbackOn2/KeccakP-1600-times8-on2.c $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KeccakP-1600-times8-on2.o
...
bin/ARMv7A/libkeccak.a: $(BINDIR) $(OBJECTS)
	mkdir -p $(dir $@)
	mkdir -p $@.headers
	cp -f $(HEADERS) $@.headers/
	$(AR) rcsv $@ $(OBJECTS)
bin/ARMv7A_libkeccak.a.tar.gz: $(SOURCES)
	mkdir -p bin/.pack/ARMv7A/libkeccak.a
	rm -rf bin/.pack/ARMv7A/libkeccak.a/*
	cp $(SOURCES) bin/.pack/ARMv7A/libkeccak.a/
	cd bin/.pack/ ; tar -czf ../../bin/ARMv7A_libkeccak.a.tar.gz ARMv7A/libkeccak.a/*
