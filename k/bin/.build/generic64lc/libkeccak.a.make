all: generic64lc/libkeccak.a
generic64lc/libkeccak.a: bin/generic64lc/libkeccak.a
generic64lc/libkeccak.a.pack: bin/generic64lc_libkeccak.a.tar.gz

BINDIR = bin/.build/generic64lc/libkeccak.a
$(BINDIR):
	mkdir -p $(BINDIR)
...
HEADERS := $(HEADERS) SnP/KeccakP-1600/Optimized64/LCufull/KeccakP-1600-opt64-config.h
SOURCES := $(SOURCES) SnP/KeccakP-1600/Optimized64/LCufull/KeccakP-1600-opt64-config.h
CFLAGS := $(CFLAGS) -ISnP/KeccakP-1600/Optimized64/LCufull/
...
bin/generic64lc/libkeccak.a: $(BINDIR) $(OBJECTS)
	mkdir -p $(dir $@)
	mkdir -p $@.headers
	cp -f $(HEADERS) $@.headers/
	$(AR) rcsv $@ $(OBJECTS)
bin/generic64lc_libkeccak.a.tar.gz: $(SOURCES)
	mkdir -p bin/.pack/generic64lc/libkeccak.a
	rm -rf bin/.pack/generic64lc/libkeccak.a/*
	cp $(SOURCES) bin/.pack/generic64lc/libkeccak.a/
	cd bin/.pack/ ; tar -czf ../../bin/generic64lc_libkeccak.a.tar.gz generic64lc/libkeccak.a/*
