all: compact/libkeccak.a
compact/libkeccak.a: bin/compact/libkeccak.a
compact/libkeccak.a.pack: bin/compact_libkeccak.a.tar.gz

BINDIR = bin/.build/compact/libkeccak.a
$(BINDIR):
	mkdir -p $(BINDIR)
...
HEADERS := $(HEADERS) SnP/KeccakP-1600/Compact64/KeccakP-1600-SnP.h
SOURCES := $(SOURCES) SnP/KeccakP-1600/Compact64/KeccakP-1600-SnP.h
CFLAGS := $(CFLAGS) -ISnP/KeccakP-1600/Compact64/
...
SOURCES := $(SOURCES) SnP/KeccakP-1600/Compact64/KeccakP-1600-compact64.c
$(BINDIR)/KeccakP-1600-compact64.o: SnP/KeccakP-1600/Compact64/KeccakP-1600-compact64.c $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KeccakP-1600-compact64.o
...
bin/compact/libkeccak.a: $(BINDIR) $(OBJECTS)
	mkdir -p $(dir $@)
	mkdir -p $@.headers
	cp -f $(HEADERS) $@.headers/
	$(AR) rcsv $@ $(OBJECTS)
bin/compact_libkeccak.a.tar.gz: $(SOURCES)
	mkdir -p bin/.pack/compact/libkeccak.a
	rm -rf bin/.pack/compact/libkeccak.a/*
	cp $(SOURCES) bin/.pack/compact/libkeccak.a/
	cd bin/.pack/ ; tar -czf ../../bin/compact_libkeccak.a.tar.gz compact/libkeccak.a/*
