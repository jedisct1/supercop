all: asmX86-64shld/libkeccak.a
asmX86-64shld/libkeccak.a: bin/asmX86-64shld/libkeccak.a
asmX86-64shld/libkeccak.a.pack: bin/asmX86-64shld_libkeccak.a.tar.gz

BINDIR = bin/.build/asmX86-64shld/libkeccak.a
$(BINDIR):
	mkdir -p $(BINDIR)
...
HEADERS := $(HEADERS) SnP/KeccakP-1600/OptimizedAsmX86-64/KeccakP-1600-SnP.h
SOURCES := $(SOURCES) SnP/KeccakP-1600/OptimizedAsmX86-64/KeccakP-1600-SnP.h
CFLAGS := $(CFLAGS) -ISnP/KeccakP-1600/OptimizedAsmX86-64/
...
SOURCES := $(SOURCES) SnP/KeccakP-1600/OptimizedAsmX86-64/KeccakP-1600-x86-64-shld-gas.s
$(BINDIR)/KeccakP-1600-x86-64-shld-gas.o: SnP/KeccakP-1600/OptimizedAsmX86-64/KeccakP-1600-x86-64-shld-gas.s $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KeccakP-1600-x86-64-shld-gas.o
...
bin/asmX86-64shld/libkeccak.a: $(BINDIR) $(OBJECTS)
	mkdir -p $(dir $@)
	mkdir -p $@.headers
	cp -f $(HEADERS) $@.headers/
	$(AR) rcsv $@ $(OBJECTS)
bin/asmX86-64shld_libkeccak.a.tar.gz: $(SOURCES)
	mkdir -p bin/.pack/asmX86-64shld/libkeccak.a
	rm -rf bin/.pack/asmX86-64shld/libkeccak.a/*
	cp $(SOURCES) bin/.pack/asmX86-64shld/libkeccak.a/
	cd bin/.pack/ ; tar -czf ../../bin/asmX86-64shld_libkeccak.a.tar.gz asmX86-64shld/libkeccak.a/*
