all: Bulldozer/libkeccak.a
Bulldozer/libkeccak.a: bin/Bulldozer/libkeccak.a
Bulldozer/libkeccak.a.pack: bin/Bulldozer_libkeccak.a.tar.gz

BINDIR = bin/.build/Bulldozer/libkeccak.a
$(BINDIR):
	mkdir -p $(BINDIR)
...
HEADERS := $(HEADERS) SnP/KeccakP-1600/OptimizedXOP/KeccakP-1600-SnP.h
SOURCES := $(SOURCES) SnP/KeccakP-1600/OptimizedXOP/KeccakP-1600-SnP.h
CFLAGS := $(CFLAGS) -ISnP/KeccakP-1600/OptimizedXOP/
...
HEADERS := $(HEADERS) SnP/KeccakP-1600/OptimizedXOP/ufull/KeccakP-1600-XOP-config.h
SOURCES := $(SOURCES) SnP/KeccakP-1600/OptimizedXOP/ufull/KeccakP-1600-XOP-config.h
CFLAGS := $(CFLAGS) -ISnP/KeccakP-1600/OptimizedXOP/ufull/
...
HEADERS := $(HEADERS) PlSnP/KeccakP-1600-times2/SIMD128/XOPufull/SIMD128-config.h
SOURCES := $(SOURCES) PlSnP/KeccakP-1600-times2/SIMD128/XOPufull/SIMD128-config.h
CFLAGS := $(CFLAGS) -IPlSnP/KeccakP-1600-times2/SIMD128/XOPufull/
...
SOURCES := $(SOURCES) SnP/KeccakP-1600/OptimizedXOP/KeccakP-1600-XOP.c
$(BINDIR)/KeccakP-1600-XOP.o: SnP/KeccakP-1600/OptimizedXOP/KeccakP-1600-XOP.c $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KeccakP-1600-XOP.o
...
bin/Bulldozer/libkeccak.a: $(BINDIR) $(OBJECTS)
	mkdir -p $(dir $@)
	mkdir -p $@.headers
	cp -f $(HEADERS) $@.headers/
	$(AR) rcsv $@ $(OBJECTS)
bin/Bulldozer_libkeccak.a.tar.gz: $(SOURCES)
	mkdir -p bin/.pack/Bulldozer/libkeccak.a
	rm -rf bin/.pack/Bulldozer/libkeccak.a/*
	cp $(SOURCES) bin/.pack/Bulldozer/libkeccak.a/
	cd bin/.pack/ ; tar -czf ../../bin/Bulldozer_libkeccak.a.tar.gz Bulldozer/libkeccak.a/*
