all: reference/libkeccak.a
reference/libkeccak.a: bin/reference/libkeccak.a
reference/libkeccak.a.pack: bin/reference_libkeccak.a.tar.gz

BINDIR = bin/.build/reference/libkeccak.a
$(BINDIR):
	mkdir -p $(BINDIR)
...
HEADERS := $(HEADERS) SnP/KeccakP-1600/Reference/KeccakP-1600-reference.h
SOURCES := $(SOURCES) SnP/KeccakP-1600/Reference/KeccakP-1600-reference.h
CFLAGS := $(CFLAGS) -ISnP/KeccakP-1600/Reference/

HEADERS := $(HEADERS) SnP/KeccakP-1600/Reference/KeccakP-1600-SnP.h
SOURCES := $(SOURCES) SnP/KeccakP-1600/Reference/KeccakP-1600-SnP.h
CFLAGS := $(CFLAGS) -ISnP/KeccakP-1600/Reference/
...
SOURCES := $(SOURCES) SnP/KeccakP-1600/Reference/KeccakP-1600-reference.c
$(BINDIR)/KeccakP-1600-reference.o: SnP/KeccakP-1600/Reference/KeccakP-1600-reference.c $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KeccakP-1600-reference.o
...
bin/reference/libkeccak.a: $(BINDIR) $(OBJECTS)
	mkdir -p $(dir $@)
	mkdir -p $@.headers
	cp -f $(HEADERS) $@.headers/
	$(AR) rcsv $@ $(OBJECTS)
bin/reference_libkeccak.a.tar.gz: $(SOURCES)
	mkdir -p bin/.pack/reference/libkeccak.a
	rm -rf bin/.pack/reference/libkeccak.a/*
	cp $(SOURCES) bin/.pack/reference/libkeccak.a/
	cd bin/.pack/ ; tar -czf ../../bin/reference_libkeccak.a.tar.gz reference/libkeccak.a/*
