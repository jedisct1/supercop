all: Nehalem/libkeccak.a
Nehalem/libkeccak.a: bin/Nehalem/libkeccak.a
Nehalem/libkeccak.a.pack: bin/Nehalem_libkeccak.a.tar.gz

BINDIR = bin/.build/Nehalem/libkeccak.a
$(BINDIR):
	mkdir -p $(BINDIR)
...
bin/Nehalem/libkeccak.a: $(BINDIR) $(OBJECTS)
	mkdir -p $(dir $@)
	mkdir -p $@.headers
	cp -f $(HEADERS) $@.headers/
	$(AR) rcsv $@ $(OBJECTS)
bin/Nehalem_libkeccak.a.tar.gz: $(SOURCES)
	mkdir -p bin/.pack/Nehalem/libkeccak.a
	rm -rf bin/.pack/Nehalem/libkeccak.a/*
	cp $(SOURCES) bin/.pack/Nehalem/libkeccak.a/
	cd bin/.pack/ ; tar -czf ../../bin/Nehalem_libkeccak.a.tar.gz Nehalem/libkeccak.a/*
