all: AVR8/libkeccak.a
AVR8/libkeccak.a: bin/AVR8/libkeccak.a
AVR8/libkeccak.a.pack: bin/AVR8_libkeccak.a.tar.gz

BINDIR = bin/.build/AVR8/libkeccak.a
$(BINDIR):
	mkdir -p $(BINDIR)
...
HEADERS := $(HEADERS) SnP/KeccakP-400/OptimizedAsmAVR8/KeccakP-400-SnP.h
SOURCES := $(SOURCES) SnP/KeccakP-400/OptimizedAsmAVR8/KeccakP-400-SnP.h
CFLAGS := $(CFLAGS) -ISnP/KeccakP-400/OptimizedAsmAVR8/

HEADERS := $(HEADERS) SnP/KeccakP-800/OptimizedAsmAVR8/KeccakP-800-SnP.h
SOURCES := $(SOURCES) SnP/KeccakP-800/OptimizedAsmAVR8/KeccakP-800-SnP.h
CFLAGS := $(CFLAGS) -ISnP/KeccakP-800/OptimizedAsmAVR8/

HEADERS := $(HEADERS) SnP/KeccakP-1600/OptimizedAsmAVR8/KeccakP-1600-SnP.h
SOURCES := $(SOURCES) SnP/KeccakP-1600/OptimizedAsmAVR8/KeccakP-1600-SnP.h
CFLAGS := $(CFLAGS) -ISnP/KeccakP-1600/OptimizedAsmAVR8/
...
SOURCES := $(SOURCES) SnP/KeccakP-400/OptimizedAsmAVR8/KeccakP-400-avr8-fast.s
$(BINDIR)/KeccakP-400-avr8-fast.o: SnP/KeccakP-400/OptimizedAsmAVR8/KeccakP-400-avr8-fast.s $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KeccakP-400-avr8-fast.o

SOURCES := $(SOURCES) SnP/KeccakP-800/OptimizedAsmAVR8/KeccakP-800-avr8-fast.s
$(BINDIR)/KeccakP-800-avr8-fast.o: SnP/KeccakP-800/OptimizedAsmAVR8/KeccakP-800-avr8-fast.s $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KeccakP-800-avr8-fast.o

SOURCES := $(SOURCES) SnP/KeccakP-1600/OptimizedAsmAVR8/KeccakP-1600-avr8-fast.s
$(BINDIR)/KeccakP-1600-avr8-fast.o: SnP/KeccakP-1600/OptimizedAsmAVR8/KeccakP-1600-avr8-fast.s $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KeccakP-1600-avr8-fast.o
...
bin/AVR8/libkeccak.a: $(BINDIR) $(OBJECTS)
	mkdir -p $(dir $@)
	mkdir -p $@.headers
	cp -f $(HEADERS) $@.headers/
	$(AR) rcsv $@ $(OBJECTS)
bin/AVR8_libkeccak.a.tar.gz: $(SOURCES)
	mkdir -p bin/.pack/AVR8/libkeccak.a
	rm -rf bin/.pack/AVR8/libkeccak.a/*
	cp $(SOURCES) bin/.pack/AVR8/libkeccak.a/
	cd bin/.pack/ ; tar -czf ../../bin/AVR8_libkeccak.a.tar.gz AVR8/libkeccak.a/*
