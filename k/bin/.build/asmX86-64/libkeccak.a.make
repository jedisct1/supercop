all: asmX86-64/libkeccak.a
asmX86-64/libkeccak.a: bin/asmX86-64/libkeccak.a
asmX86-64/libkeccak.a.pack: bin/asmX86-64_libkeccak.a.tar.gz

BINDIR = bin/.build/asmX86-64/libkeccak.a
$(BINDIR):
	mkdir -p $(BINDIR)
...
SOURCES := $(SOURCES) SnP/KeccakP-1600/OptimizedAsmX86-64/KeccakP-1600-x86-64-gas.s
$(BINDIR)/KeccakP-1600-x86-64-gas.o: SnP/KeccakP-1600/OptimizedAsmX86-64/KeccakP-1600-x86-64-gas.s $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KeccakP-1600-x86-64-gas.o
...
bin/asmX86-64/libkeccak.a: $(BINDIR) $(OBJECTS)
	mkdir -p $(dir $@)
	mkdir -p $@.headers
	cp -f $(HEADERS) $@.headers/
	$(AR) rcsv $@ $(OBJECTS)
bin/asmX86-64_libkeccak.a.tar.gz: $(SOURCES)
	mkdir -p bin/.pack/asmX86-64/libkeccak.a
	rm -rf bin/.pack/asmX86-64/libkeccak.a/*
	cp $(SOURCES) bin/.pack/asmX86-64/libkeccak.a/
	cd bin/.pack/ ; tar -czf ../../bin/asmX86-64_libkeccak.a.tar.gz asmX86-64/libkeccak.a/*
