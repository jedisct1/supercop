all: ARMv6M/libkeccak.a
ARMv6M/libkeccak.a: bin/ARMv6M/libkeccak.a
ARMv6M/libkeccak.a.pack: bin/ARMv6M_libkeccak.a.tar.gz

BINDIR = bin/.build/ARMv6M/libkeccak.a
$(BINDIR):
	mkdir -p $(BINDIR)
...
HEADERS := $(HEADERS) SnP/KeccakP-200/OptimizedAsmARM/KeccakP-200-SnP.h
SOURCES := $(SOURCES) SnP/KeccakP-200/OptimizedAsmARM/KeccakP-200-SnP.h
CFLAGS := $(CFLAGS) -ISnP/KeccakP-200/OptimizedAsmARM/

HEADERS := $(HEADERS) SnP/KeccakP-400/OptimizedAsmARM/KeccakP-400-SnP.h
SOURCES := $(SOURCES) SnP/KeccakP-400/OptimizedAsmARM/KeccakP-400-SnP.h
CFLAGS := $(CFLAGS) -ISnP/KeccakP-400/OptimizedAsmARM/
...
HEADERS := $(HEADERS) SnP/KeccakP-1600/Optimized32biAsmARM/KeccakP-1600-SnP.h
SOURCES := $(SOURCES) SnP/KeccakP-1600/Optimized32biAsmARM/KeccakP-1600-SnP.h
CFLAGS := $(CFLAGS) -ISnP/KeccakP-1600/Optimized32biAsmARM/
...
HEADERS := $(HEADERS) PlSnP/KeccakP-1600-times2/FallbackOn1/KeccakP-1600-times2-SnP.h
SOURCES := $(SOURCES) PlSnP/KeccakP-1600-times2/FallbackOn1/KeccakP-1600-times2-SnP.h
CFLAGS := $(CFLAGS) -IPlSnP/KeccakP-1600-times2/FallbackOn1/

HEADERS := $(HEADERS) PlSnP/Fallback/PlSnP-Fallback.inc
SOURCES := $(SOURCES) PlSnP/Fallback/PlSnP-Fallback.inc
CFLAGS := $(CFLAGS) -IPlSnP/Fallback/

HEADERS := $(HEADERS) PlSnP/KeccakP-1600-times4/FallbackOn1/KeccakP-1600-times4-SnP.h
SOURCES := $(SOURCES) PlSnP/KeccakP-1600-times4/FallbackOn1/KeccakP-1600-times4-SnP.h
CFLAGS := $(CFLAGS) -IPlSnP/KeccakP-1600-times4/FallbackOn1/

HEADERS := $(HEADERS) PlSnP/Fallback/PlSnP-Fallback.inc
SOURCES := $(SOURCES) PlSnP/Fallback/PlSnP-Fallback.inc
CFLAGS := $(CFLAGS) -IPlSnP/Fallback/

HEADERS := $(HEADERS) PlSnP/KeccakP-1600-times8/FallbackOn1/KeccakP-1600-times8-SnP.h
SOURCES := $(SOURCES) PlSnP/KeccakP-1600-times8/FallbackOn1/KeccakP-1600-times8-SnP.h
CFLAGS := $(CFLAGS) -IPlSnP/KeccakP-1600-times8/FallbackOn1/

HEADERS := $(HEADERS) PlSnP/Fallback/PlSnP-Fallback.inc
SOURCES := $(SOURCES) PlSnP/Fallback/PlSnP-Fallback.inc
CFLAGS := $(CFLAGS) -IPlSnP/Fallback/

HEADERS := $(HEADERS) Ketje/Ket/OptimizedLE/Ket.inc
SOURCES := $(SOURCES) Ketje/Ket/OptimizedLE/Ket.inc
CFLAGS := $(CFLAGS) -IKetje/Ket/OptimizedLE/

HEADERS := $(HEADERS) Ketje/Ket/OptimizedLE/Ket-common.h
SOURCES := $(SOURCES) Ketje/Ket/OptimizedLE/Ket-common.h
CFLAGS := $(CFLAGS) -IKetje/Ket/OptimizedLE/

HEADERS := $(HEADERS) Ketje/Ket/OptimizedLE/KetJr.h
SOURCES := $(SOURCES) Ketje/Ket/OptimizedLE/KetJr.h
CFLAGS := $(CFLAGS) -IKetje/Ket/OptimizedLE/

HEADERS := $(HEADERS) Ketje/Ket/OptimizedLE/KetSr.h
SOURCES := $(SOURCES) Ketje/Ket/OptimizedLE/KetSr.h
CFLAGS := $(CFLAGS) -IKetje/Ket/OptimizedLE/

HEADERS := $(HEADERS) Ketje/Ket/OptimizedLE/KetMn.h
SOURCES := $(SOURCES) Ketje/Ket/OptimizedLE/KetMn.h
CFLAGS := $(CFLAGS) -IKetje/Ket/OptimizedLE/

HEADERS := $(HEADERS) Ketje/Ket/OptimizedLE/KetMj.h
SOURCES := $(SOURCES) Ketje/Ket/OptimizedLE/KetMj.h
CFLAGS := $(CFLAGS) -IKetje/Ket/OptimizedLE/
...
SOURCES := $(SOURCES) SnP/KeccakP-200/OptimizedAsmARM/KeccakP-200-armv6m-le-gcc.s
$(BINDIR)/KeccakP-200-armv6m-le-gcc.o: SnP/KeccakP-200/OptimizedAsmARM/KeccakP-200-armv6m-le-gcc.s $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KeccakP-200-armv6m-le-gcc.o

SOURCES := $(SOURCES) SnP/KeccakP-400/OptimizedAsmARM/KeccakP-400-armv6m-le-gcc.s
$(BINDIR)/KeccakP-400-armv6m-le-gcc.o: SnP/KeccakP-400/OptimizedAsmARM/KeccakP-400-armv6m-le-gcc.s $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KeccakP-400-armv6m-le-gcc.o

SOURCES := $(SOURCES) SnP/KeccakP-800/OptimizedAsmARM/KeccakP-800-u2-armv6m-le-gcc.s
$(BINDIR)/KeccakP-800-u2-armv6m-le-gcc.o: SnP/KeccakP-800/OptimizedAsmARM/KeccakP-800-u2-armv6m-le-gcc.s $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KeccakP-800-u2-armv6m-le-gcc.o

SOURCES := $(SOURCES) SnP/KeccakP-1600/Optimized32biAsmARM/KeccakP-1600-u2-32bi-armv6m-le-gcc.s
$(BINDIR)/KeccakP-1600-u2-32bi-armv6m-le-gcc.o: SnP/KeccakP-1600/Optimized32biAsmARM/KeccakP-1600-u2-32bi-armv6m-le-gcc.s $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KeccakP-1600-u2-32bi-armv6m-le-gcc.o
...
SOURCES := $(SOURCES) PlSnP/KeccakP-1600-times2/FallbackOn1/KeccakP-1600-times2-on1.c
$(BINDIR)/KeccakP-1600-times2-on1.o: PlSnP/KeccakP-1600-times2/FallbackOn1/KeccakP-1600-times2-on1.c $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KeccakP-1600-times2-on1.o

SOURCES := $(SOURCES) PlSnP/KeccakP-1600-times4/FallbackOn1/KeccakP-1600-times4-on1.c
$(BINDIR)/KeccakP-1600-times4-on1.o: PlSnP/KeccakP-1600-times4/FallbackOn1/KeccakP-1600-times4-on1.c $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KeccakP-1600-times4-on1.o

SOURCES := $(SOURCES) PlSnP/KeccakP-1600-times8/FallbackOn1/KeccakP-1600-times8-on1.c
$(BINDIR)/KeccakP-1600-times8-on1.o: PlSnP/KeccakP-1600-times8/FallbackOn1/KeccakP-1600-times8-on1.c $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KeccakP-1600-times8-on1.o

SOURCES := $(SOURCES) Ketje/Ket/OptimizedLE/KetJr.c
$(BINDIR)/KetJr.o: Ketje/Ket/OptimizedLE/KetJr.c $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KetJr.o

SOURCES := $(SOURCES) Ketje/Ket/OptimizedLE/KetSr.c
$(BINDIR)/KetSr.o: Ketje/Ket/OptimizedLE/KetSr.c $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KetSr.o

SOURCES := $(SOURCES) Ketje/Ket/OptimizedLE/KetMn.c
$(BINDIR)/KetMn.o: Ketje/Ket/OptimizedLE/KetMn.c $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
OBJECTS := $(OBJECTS) $(BINDIR)/KetMn.o

SOURCES := $(SOURCES) Ketje/Ket/OptimizedLE/KetMj.c
$(BINDIR)/KetMj.o: Ketje/Ket/OptimizedLE/KetMj.c $(HEADERS)
	$(CC) $(INCLUDES) $(CFLAGS) -c $< -o $@
...
bin/ARMv6M/libkeccak.a: $(BINDIR) $(OBJECTS)
	mkdir -p $(dir $@)
	mkdir -p $@.headers
	cp -f $(HEADERS) $@.headers/
	$(AR) rcsv $@ $(OBJECTS)
bin/ARMv6M_libkeccak.a.tar.gz: $(SOURCES)
	mkdir -p bin/.pack/ARMv6M/libkeccak.a
	rm -rf bin/.pack/ARMv6M/libkeccak.a/*
	cp $(SOURCES) bin/.pack/ARMv6M/libkeccak.a/
	cd bin/.pack/ ; tar -czf ../../bin/ARMv6M_libkeccak.a.tar.gz ARMv6M/libkeccak.a/*
