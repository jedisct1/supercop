...
.text
.globl hec_fp_add_2e127m1_g2i_jac_x8664_asm
hec_fp_add_2e127m1_g2i_jac_x8664_asm:
	pushq %r12
	pushq %rbp
	movq %rsi, %rbp
	movq 64(%rdi), %rax
	...
	btrq $63, %rsi
	adcq $0, %r12
	movq %r12, 8*0+8*72(%rdi)
	adcq $0, %rsi
	movq %rsi, 8*1+8*72(%rdi)
	...
	btrq $63, %rsi
	adcq $0, %r12
	movq %r12, 8*0+8*74(%rdi)
	adcq $0, %rsi
	movq %rsi, 8*1+8*74(%rdi)
	...
	btrq $63, %rsi
	adcq $0, %r12
	movq %r12, 8*0+8*76(%rdi)
	adcq $0, %rsi
	movq %rsi, 8*1+8*76(%rdi)
	...
	btrq $63, %rsi
	adcq $0, %r12
	movq %r12, 8*0+8*78(%rdi)
	adcq $0, %rsi
	movq %rsi, 8*1+8*78(%rdi)
	...
	btrq $63, %rsi
	adcq $0, %r12
	movq %r12, 8*0+8*82(%rdi)
	adcq $0, %rsi
	movq %rsi, 8*1+8*82(%rdi)
	movq 80(%rdi), %rax
	mulq 88(%rbp)
	movq %rdx, %r10
	movq %rax, %rsi
	...
	btrq $63, %rsi
	adcq $0, %r12
	movq %r12, 8*0+8*80(%rdi)
	adcq $0, %rsi
	movq %rsi, 8*1+8*80(%rdi)
	movq 8*0+8*32(%rdi), %rax
	mulq 8*1+8*64(%rdi)
	movq %rdx, %r10
	movq %rax, %rsi
	...
	adcq $0, %rsi
	movq %rsi, 8*1+8*44(%rdi)
	movq 8*0+8*72(%rdi), %rax
	mulq 8*1+8*32(%rdi)
	movq %rdx, %r10
	movq %rax, %rsi
	movq 8*1+8*72(%rdi), %rax
	mulq 8*0+8*32(%rdi)
	addq %rax, %rsi
	adcq %rdx, %r10
	movq 8*0+8*32(%rdi), %rax
	...
	adcq $0, %rsi
	movq %rsi, 8*1+8*46(%rdi)
	movq 8*0+8*74(%rdi), %rax
	mulq 8*1+8*36(%rdi)
	movq %rdx, %r10
	movq %rax, %rsi
	movq 8*1+8*74(%rdi), %rax
	mulq 8*0+8*36(%rdi)
	addq %rax, %rsi
	adcq %rdx, %r10
	movq 8*0+8*36(%rdi), %rax
	...
	adcq $0, %rsi
	movq %rsi, 8*1+8*48(%rdi)
	movq 8*0+8*76(%rdi), %rax
	mulq 8*1+8*40(%rdi)
	movq %rdx, %r10
	movq %rax, %rsi
	movq 8*1+8*76(%rdi), %rax
	mulq 8*0+8*40(%rdi)
	addq %rax, %rsi
	adcq %rdx, %r10
	movq 8*0+8*40(%rdi), %rax
	...
	adcq $0, %rsi
	movq %rsi, 8*1+8*52(%rdi)
	movq 8*0+8*78(%rdi), %rax
	mulq 8*1+8*32(%rdi)
	movq %rdx, %r10
	movq %rax, %rsi
	movq 8*1+8*78(%rdi), %rax
	mulq 8*0+8*32(%rdi)
	addq %rax, %rsi
	adcq %rdx, %r10
	movq 8*0+8*32(%rdi), %rax
	...
	adcq $0, %rsi
	movq %rsi, 8*1+8*54(%rdi)
	movq 8*0+8*80(%rdi), %rax
	mulq 8*1+8*62(%rdi)
	movq %rdx, %r10
	movq %rax, %rsi
	movq 8*1+8*80(%rdi), %rax
	mulq 8*0+8*62(%rdi)
	addq %rax, %rsi
	adcq %rdx, %r10
	movq 8*0+8*62(%rdi), %rax
	...
	adcq $0, %rsi
	movq %rsi, 8*1+8*70(%rdi)
	movq 8*0+8*82(%rdi), %rax
	mulq 8*1+8*50(%rdi)
	movq %rdx, %r10
	movq %rax, %rsi
	movq 8*1+8*82(%rdi), %rax
	mulq 8*0+8*50(%rdi)
	addq %rax, %rsi
	adcq %rdx, %r10
	movq 8*0+8*50(%rdi), %rax
