...
int crypto_dh_keypair(unsigned char* pk, unsigned char *sk)
{
	...
	fp_mul_2e127m1_x8664_asm(t1->W, NULL, NULL, t1->Z, t1->W);
	fp_sqr_2e127m1_x8664_asm(t1->Z, NULL, NULL, t1->Z);
	fp_mul_2e127m1_x8664_asm(t1->S, NULL, NULL, t1->S, t1->Z);
	fp_mul_2e127m1_x8664_asm(t1->R, NULL, NULL, t1->R, t1->W);
	fp_mul_2e127m1_x8664_asm(t1->W, NULL, NULL, t1->Z, t1->W);
	fp_mul_2e127m1_x8664_asm(t1->Q, NULL, NULL, t1->Q, t1->W);
	fp_mul_2e127m1_x8664_asm(t1->Z, NULL, NULL, t1->Z, t1->W);
...
int crypto_dh(unsigned char *s, const unsigned char* pk, const unsigned char *sk){
	...
	/*Convert to homogeneous projective coordinates representation.*/
	fp_cpy_2e127m1_x8664_asm(t1->Q, NULL, NULL, tpk->Q);
	fp_cpy_2e127m1_x8664_asm(t1->R, NULL, NULL, tpk->R);
	fp_cpy_2e127m1_x8664_asm(t1->S, NULL, NULL, tpk->S);
	fp_cpy_2e127m1_x8664_asm(t1->T, NULL, NULL, tpk->T);
	fp_st1_2e127m1_x8664_asm(t1->Z, NULL, NULL, 1);
	fp_st1_2e127m1_x8664_asm(t1->W, NULL, NULL, 1);
	fp_st1_2e127m1_x8664_asm(t1->V, NULL, NULL, 1);
