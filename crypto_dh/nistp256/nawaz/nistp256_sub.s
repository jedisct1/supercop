...
# qhasm: 				h0 = f0 - g0
# asm 1: fsubd <f0=float64#1,<g0=float64#2,>h0=float64#1
# asm 2: fsubd <f0=%f0,<g0=%f2,>h0=%f0
fsubd %f0,%f2,%f0
...
# qhasm: 				h22 = f22 - g22
# asm 1: fsubd <f22=float64#3,<g22=float64#4,>h22=float64#3
# asm 2: fsubd <f22=%f4,<g22=%f6,>h22=%f4
fsubd %f4,%f6,%f4
...
# qhasm: 				h43 = f43 - g43
# asm 1: fsubd <f43=float64#2,<g43=float64#5,>h43=float64#2
# asm 2: fsubd <f43=%f2,<g43=%f8,>h43=%f2
fsubd %f2,%f8,%f2
...
# qhasm: 				h64 = f64 - g64
# asm 1: fsubd <f64=float64#4,<g64=float64#6,>h64=float64#4
# asm 2: fsubd <f64=%f6,<g64=%f10,>h64=%f6
fsubd %f6,%f10,%f6
...
# qhasm: 				h86 = f86 - g86
# asm 1: fsubd <f86=float64#1,<g86=float64#5,>h86=float64#1
# asm 2: fsubd <f86=%f0,<g86=%f8,>h86=%f0
fsubd %f0,%f8,%f0
...
# asm 1: fsubd <f107=float64#3,<g107=float64#6,>h107=float64#3
# asm 2: fsubd <f107=%f4,<g107=%f10,>h107=%f4
fsubd %f4,%f10,%f4
...
# asm 1: fsubd <f128=float64#2,<g128=float64#5,>h128=float64#2
# asm 2: fsubd <f128=%f2,<g128=%f8,>h128=%f2
fsubd %f2,%f8,%f2
...
# asm 1: fsubd <f150=float64#4,<g150=float64#6,>h150=float64#4
# asm 2: fsubd <f150=%f6,<g150=%f10,>h150=%f6
fsubd %f6,%f10,%f6
...
# asm 1: fsubd <f171=float64#1,<g171=float64#5,>h171=float64#1
# asm 2: fsubd <f171=%f0,<g171=%f8,>h171=%f0
fsubd %f0,%f8,%f0
...
# asm 1: fsubd <f192=float64#3,<g192=float64#6,>h192=float64#3
# asm 2: fsubd <f192=%f4,<g192=%f10,>h192=%f4
fsubd %f4,%f10,%f4
...
# asm 1: fsubd <f214=float64#2,<g214=float64#5,>h214=float64#2
# asm 2: fsubd <f214=%f2,<g214=%f8,>h214=%f2
fsubd %f2,%f8,%f2
...
# asm 1: fsubd <f235=float64#4,<g235=float64#6,>h235=float64#1
# asm 2: fsubd <f235=%f6,<g235=%f10,>h235=%f0
fsubd %f6,%f10,%f0
