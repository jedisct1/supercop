...
int crypto_dh_keypair(unsigned char* pk, unsigned char *sk)
{
	...
	hec_fp_smul_2e128mc_bk_glv4(t1, (uni)sk, t1, tcn);
...
int crypto_dh_keypair(unsigned char* pk, unsigned char *sk)
{
	...
	/*Perform the scalar multiplication.*/
	hec_fp_smulcached_2e128mc_g2i_a2a3is0(t1, (uni)sk, (unsigned char *)D2, (CNS_hec_fp_2e128mc)cn, SLICE, WINDOW, CSIZE);
...
int crypto_dh(unsigned char *s, const unsigned char* pk, const unsigned char *sk){
	...
	/*Convert to homogeneous projective coordinates representation.*/
	fp_cpy_2e128mc_x8664_asm(t2->Q, tcn->prm, NULL, tpk->Q);
	fp_cpy_2e128mc_x8664_asm(t2->R, tcn->prm, NULL, tpk->R);
	fp_cpy_2e128mc_x8664_asm(t2->S, tcn->prm, NULL, tpk->S);
	fp_cpy_2e128mc_x8664_asm(t2->T, tcn->prm, NULL, tpk->T);
	fp_st1_2e128mc_x8664_asm(t2->Z, tcn->prm, NULL, 1);
