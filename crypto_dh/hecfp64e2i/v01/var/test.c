...
int crypto_dh_keypair(unsigned char* pk, unsigned char *sk)
{
	...
	sk[SECRETKEY_BYTES-1] = (sk[SECRETKEY_BYTES-1] & 0x03) | 0x08;
	...
	hec_fp_smul_2e064mce2_g2i(t1, (uni)sk, t2, tcn);
...
int crypto_dh_keypair(unsigned char* pk, unsigned char *sk)
{
	...
	hec_fp_smulcached_2e064mce2_g2i(t1, (uni)sk, (unsigned char *)D2, (CNS_hec_fp_2e064mce2)tcn, SLICE, WINDOW, CSIZE);
