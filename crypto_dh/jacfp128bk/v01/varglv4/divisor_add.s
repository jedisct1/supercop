...
.text
.globl hec_fp_add_2e128mc_g2i_jac_x8664_asm
hec_fp_add_2e128mc_g2i_jac_x8664_asm:
	pushq %r12
	pushq %r13
	pushq %rbx
	pushq %rbp
	...
	cmovc %rsi, %r13
	addq %r13, %r10
	movq %r10, 8*0+8*72(%rdi)
	adcq $0, %r11
	movq %r11, 8*1+8*72(%rdi)
	movq $0, %rdx
	...
	cmovc %rsi, %r13
	addq %r13, %r10
	movq %r10, 8*0+8*74(%rdi)
	adcq $0, %r11
	movq %r11, 8*1+8*74(%rdi)
	movq $0, %rdx
	...
	cmovc %rsi, %r13
	addq %r13, %r10
	movq %r10, 8*0+8*76(%rdi)
	adcq $0, %r11
	movq %r11, 8*1+8*76(%rdi)
	movq $0, %rdx
	...
	cmovc %rsi, %r13
	addq %r13, %r10
	movq %r10, 8*0+8*78(%rdi)
	adcq $0, %r11
	movq %r11, 8*1+8*78(%rdi)
	movq $0, %rdx
	...
	cmovc %rsi, %r13
	addq %r13, %r10
	movq %r10, 8*0+8*82(%rdi)
	adcq $0, %r11
	movq %r11, 8*1+8*82(%rdi)
	movq 80(%rdi), %rax
	mulq 80(%rbp)
	movq %rax, %r10
	movq %rdx, %r11
	...
	cmovc %rsi, %r13
	addq %r13, %r10
	movq %r10, 8*0+8*80(%rdi)
	adcq $0, %r11
	movq %r11, 8*1+8*80(%rdi)
	movq 8*0+8*32(%rdi), %rax
	mulq 8*0+8*64(%rdi)
	movq %rax, %r10
	movq %rdx, %r11
