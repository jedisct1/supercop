...
.text
.globl hec_fp_dbl_2e128mc_g2i_jac_x8664_asm
hec_fp_dbl_2e128mc_g2i_jac_x8664_asm:
	pushq %r12
	pushq %r13
	pushq %rbx
	movq 8*84(%rdi), %rsi
	...
	adcq $0, %r11
	movq $0, %rdx
	addq 8*0+8*54(%rdi), %r10
	adcq 8*1+8*54(%rdi), %r11
	cmovnc %rsi, %rdx
	subq %rdx, %r10
	movq %r10, 8*0+8*56(%rdi)
	sbbq $0, %r11
	...
	adcq $0, %r11
	movq $0, %rdx
	addq 8*0+8*52(%rdi), %r10
	adcq 8*1+8*52(%rdi), %r11
	cmovnc %rsi, %rdx
	subq %rdx, %r10
	movq %r10, (%rdi)
	sbbq $0, %r11
	...
	adcq $0, %r11
	movq $0, %rdx
	addq 8*0+8*60(%rdi), %r10
	adcq 8*1+8*60(%rdi), %r11
	cmovnc %rsi, %rdx
	subq %rdx, %r10
	movq %r10, 8*0+8*32(%rdi)
	sbbq $0, %r11
	...
	adcq $0, %r11
	movq $0, %rdx
	addq 8*0+8*58(%rdi), %r10
	adcq 8*1+8*58(%rdi), %r11
	cmovnc %rsi, %rdx
	subq %rdx, %r10
	movq %r10, 8*0+8*36(%rdi)
	sbbq $0, %r11
	...
	adcq $0, %r11
	movq $0, %rdx
	addq 8*0+8*50(%rdi), %r10
	adcq 8*1+8*50(%rdi), %r11
	cmovnc %rsi, %rdx
	subq %rdx, %r10
	movq %r10, 8*0+8*42(%rdi)
	sbbq $0, %r11
