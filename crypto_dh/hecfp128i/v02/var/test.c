...
int crypto_dh_keypair(unsigned char* pk, unsigned char *sk)
{
	...
	hec_fp_smul_2e128mc_g2i(t1, (uni)sk, t2, tcn);
...
int crypto_dh_keypair(unsigned char* pk, unsigned char *sk)
{
	...
	hec_fp_smulcached_2e128mc_g2i(t1, (uni)sk, (unsigned char *)D2, tcn, SLICE, WINDOW, CSIZE);
